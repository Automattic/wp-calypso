...
import { getCommentsUrl, getModerateCommentsLink, getReferenceId } from '../panel/helpers/notes';
...
const PendingApprovalBadge = ( { note }: PendingApprovalBadgeProps ): JSX.Element => {
	...
	const commentsUrl =
		getModerateCommentsLink( note ) ?? getCommentsUrl( getReferenceId( note, 'site' ) );

		...
		switch ( gridiconClass ) {
			...
			case 'gridicons-reader-following':
				return (
					...
					<svg { ...sharedProps } xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
						<title>{ __( 'Reader Following' ) }</title>
						<path
							fillRule="evenodd"
							clipRule="evenodd"
			...
			case 'gridicons-cog':
				return (
					<svg { ...sharedProps } xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
						<title>{ __( 'Open notification settings' ) }</title>
						<g>

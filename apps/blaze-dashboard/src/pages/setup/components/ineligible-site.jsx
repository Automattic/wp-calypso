			...
			<div className="empty-promotion-list__container promote-post-i2__setup-container">
				<div className="promote-post-i2__inner-container">
					...
					<h3 className="setup-pages__title wp-brand-font">
						{ translate( 'Your site is not eligible to Advertise with Blaze Ads' ) }
					</h3>
					<p className="setup-pages__body">
						{ translate(
							"Unfortunately, your site doesn't qualify for advertising using Blaze Ads. If you have any questions or need assistance, please contact our {{a}}support team{{/a}}.",
							{
								components: {
									a: (
										<a

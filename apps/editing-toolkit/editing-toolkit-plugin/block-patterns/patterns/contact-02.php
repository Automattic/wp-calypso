...
<div class="wp-block-jetpack-layout-grid-column wp-block-jetpack-layout-grid__padding-none"><!-- wp:heading {"level":6,"style":{"color":{"text":"#000000"}}} -->
<h6 class="has-text-color">%1$s</h6>
<!-- /wp:heading --></div>
<!-- /wp:jetpack/layout-grid-column -->

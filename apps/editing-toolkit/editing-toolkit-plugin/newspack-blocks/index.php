...
define( 'NEWSPACK_BLOCKS__VERSION', 'v1.21.0' );
...
function newspack_blocks_block_args( $args, $name ) {
	...
	$plugin_locator = NEWSPACK_BLOCKS__BLOCKS_DIRECTORY . 'blog-posts-block-editor.js';
	wp_register_script(
		$block_prefix . 'editor',
		plugins_url( $block_prefix . 'editor.js', $plugin_locator ),
	...
	// Editor style.
	$editor_style = plugins_url( $block_prefix . 'editor.css', $plugin_locator );
	...
	wp_register_script(
		$block_prefix . 'view',
		plugins_url( $block_prefix . 'view.js', $plugin_locator ),
		$script_data['dependencies'],
		$script_data['version'],
		true
	);
	...
	// View style.
	$editor_style = plugins_url( $block_prefix . 'view.css', $plugin_locator );

...
define( 'NEWSPACK_BLOCKS__BLOCKS_DIRECTORY', dirname( __DIR__ ) . '/dist/' );
define( 'NEWSPACK_BLOCKS__PLUGIN_DIR', plugin_dir_path( __FILE__ ) );

// Autogenerated by apps/editing-toolkit/bin/sync-newspack-blocks.sh.
define( 'NEWSPACK_BLOCKS__VERSION', 'v1.17.1' );
...
function newspack_blocks_block_args( $args, $name ) {
	...
	wp_register_script(
		$block_prefix . 'editor',
		plugins_url( $block_prefix . 'editor.js', NEWSPACK_BLOCKS__BLOCKS_DIRECTORY ),
	...
	// Editor style.
	$editor_style = plugins_url( $block_prefix . 'editor.css', NEWSPACK_BLOCKS__BLOCKS_DIRECTORY );
	...
	wp_register_script(
		$block_prefix . 'view',
		plugins_url( $block_prefix . 'view.js', NEWSPACK_BLOCKS__BLOCKS_DIRECTORY ),
		$script_data['dependencies'],
		$script_data['version'],
		true
	);
	...
	// View style.
	$editor_style = plugins_url( $block_prefix . 'view.css', NEWSPACK_BLOCKS__BLOCKS_DIRECTORY );

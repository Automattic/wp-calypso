...
<form id="<?php echo esc_attr( $form_id ); ?>" class="<?php echo esc_attr( $form_class ); ?>" role="search" method="get" action="">
	<div class="input-wrapper" dir="auto">
		<?php if ( $enable_odie_answers ) : ?>
			<input id="<?php echo esc_attr( $input_id ); ?>" type="input" name="odie-query"<?php echo $input_class ? ' class="' . esc_attr( $input_class ) . '"' : ''; ?> placeholder="<?php echo esc_attr( __( 'Ask us anything', 'happy-blocks' ) ); ?>"/>

...
Refer to instructions in the top-level [WordPress.com Editing Experience](https://github.com/automattic/wp-calypso/tree/master/apps/wpcom-editing-experience) directory.

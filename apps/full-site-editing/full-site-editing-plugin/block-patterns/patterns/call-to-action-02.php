   ...
   <div class="wp-block-cover__inner-container">
      ...
      <div class="wp-block-jetpack-layout-grid alignfull column1-desktop-grid__span-10 column1-desktop-grid__start-2 column1-desktop-grid__row-1 column1-tablet-grid__span-8 column1-tablet-grid__row-1 column1-mobile-grid__span-4 column1-mobile-grid__row-1 wp-block-jetpack-layout-gutter__nowrap">
         ...
         <div class="wp-block-jetpack-layout-grid-column wp-block-jetpack-layout-grid__padding-none">
            ...
            <p style="color:#ffffff;font-size:80px" class="has-text-color has-text-align-center margin-bottom-none"><strong>%2$s</strong></p>
            <!-- /wp:paragraph -->
            <!-- wp:paragraph {"align":"center","customTextColor":"#ffffff","className":"margin-top-none"} -->
            <p style="color:#ffffff" class="has-text-color has-text-align-center margin-top-none">%3$s</p>
            <!-- /wp:paragraph -->
            <!-- wp:buttons {"align":"center"} -->
            <div class="wp-block-buttons aligncenter">
               <!-- wp:button {"customBackgroundColor":"#a5150f","customTextColor":"#ffffff"} -->
               <div class="wp-block-button"><a class="wp-block-button__link has-text-color has-background" style="background-color:#a5150f;color:#ffffff">%4$s</a></div>
               <!-- /wp:button -->
            </div>
            <!-- /wp:buttons -->
         </div>

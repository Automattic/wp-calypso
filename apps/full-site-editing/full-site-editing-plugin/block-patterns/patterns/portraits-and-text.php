...
<!-- wp:image {"id":485,"sizeSlug":"full"} -->
<figure class="wp-block-image size-full"><img src="https://dotcompatterns.files.wordpress.com/2020/04/rachel-mcdermott-0fn7fxv1ewa-unsplash-portrait-1.jpg" alt="" class="wp-image-485"/></figure>
<!-- /wp:image -->
...
<!-- wp:jetpack/layout-grid-column -->
<div class="wp-block-jetpack-layout-grid-column wp-block-jetpack-layout-grid__padding-none"><!-- wp:image {"id":486,"sizeSlug":"full"} -->
<figure class="wp-block-image size-full"><img src="https://dotcompatterns.files.wordpress.com/2020/04/petr-sevcovic-hzdf-rxlsem-unsplash-bw.jpg" alt="" class="wp-image-486"/></figure>
<!-- /wp:image -->

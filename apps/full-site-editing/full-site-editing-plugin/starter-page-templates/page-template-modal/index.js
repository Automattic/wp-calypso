...
class PageTemplateModal extends Component {
	...
	getTitlesByTemplateSlugs = memoize((templates) => mapValues(keyBy(templates, 'slug'), 'title'));
					...
					{isLoading ? (
						...
						<>
							<form className="page-template-modal__form">
								...
								{this.renderTemplatesList(aboutTemplates, __('About Pages', 'full-site-editing'))}

								{this.renderTemplatesList(blogTemplates, __('Blog Pages', 'full-site-editing'))}
								...
								{this.renderTemplatesList(eventTemplates, __('Event Pages', 'full-site-editing'))}

								{this.renderTemplatesList(menuTemplates, __('Menu Pages', 'full-site-editing'))}
								...
								{this.renderTemplatesList(teamTemplates, __('Team Pages', 'full-site-editing'))}

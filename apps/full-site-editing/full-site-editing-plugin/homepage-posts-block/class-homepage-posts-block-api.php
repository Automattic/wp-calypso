...
/**
 * `Homepage_Posts_Block_API` is a wrapper for `register_rest_fields()`
 */
class Homepage_Posts_Block_API {
	...
	public static function register_rest_fields() {
		register_rest_field(
			...
			array(
				'get_callback'    => array( 'Homepage_Posts_Block_API', 'newspack_blocks_get_image_src' ),
		...
		register_rest_field(
			...
			array(
				'get_callback'    => array( 'Homepage_Posts_Block_API', 'newspack_blocks_get_image_caption' ),
				'update_callback' => null,
				'schema'          => null,
			)
		);
		...
		register_rest_field(
			...
			array(
				'get_callback'    => array( 'Homepage_Posts_Block_API', 'newspack_blocks_get_author_info' ),
				'update_callback' => null,
				'schema'          => null,
			)
		);
		...
		register_rest_field(
			...
			array(
				'get_callback'    => array( 'Homepage_Posts_Block_API', 'newspack_blocks_get_primary_category' ),
				'update_callback' => null,
				'schema'          => null,
			)
		);
	...
	public static function newspack_blocks_get_image_src( $object ) {
		...
		// Landscape image.
		$landscape_size = \A8C\FSE\Homepage_Posts::image_size_for_orientation( 'landscape' );
		...
		// Portrait image.
		$portrait_size = \A8C\FSE\Homepage_Posts::image_size_for_orientation( 'portrait' );
		...
		// Square image.
		$square_size = \A8C\FSE\Homepage_Posts::image_size_for_orientation( 'square' );
...
add_action( 'rest_api_init', array( 'Homepage_Posts_Block_API', 'register_rest_fields' ) );

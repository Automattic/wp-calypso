	...
	overrides: [
		...
		},
		{
			files: [
				...
				'client/state/help/**/*',
				'client/state/jetpack-checkout/**/*',
				'client/state/jetpack-connect/**/*',
				'client/state/jetpack-product-install/**/*',
				'client/state/jetpack-remote-install/**/*',
				'client/state/jetpack-review-prompt/**/*',
				'client/state/jetpack-scan/**/*',
				'client/state/jetpack-sync/**/*',
				'client/state/jetpack/**/*',
				'client/support/**/*',
				'client/test-helpers/**/*',
				'client/types.ts',

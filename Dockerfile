...
# Workspace manifests are generated into .docker-workspace-manifests/ before docker build.
# Run: yarn run sync:docker-workspace-manifests
COPY ./.docker-workspace-manifests/ /calypso/

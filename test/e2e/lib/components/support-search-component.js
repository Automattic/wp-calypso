...
class SupportSearchComponent extends AsyncBaseContainer {
	...
	async waitForDefaultResultsNotToBePresent() {
		return driverHelper.waitUntilElementNotLocated( this.driver, defaultResultsSelectors );
	}
	...
	async waitForErrorResultsNotToBePresent() {
		return driverHelper.waitUntilElementNotLocated( this.driver, errorResultsSelectors );
	}
	...
	async waitForSearchResultsNotToBePresent() {
		return driverHelper.waitUntilElementNotLocated( this.driver, searchResultsSelectors );
	}
	...
	async waitForAdminResultsNotToBePresent() {
		return driverHelper.waitUntilElementNotLocated( this.driver, adminSearchResultsSelectors );
	}

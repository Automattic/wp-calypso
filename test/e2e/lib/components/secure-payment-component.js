...
export default class SecurePaymentComponent extends AsyncBaseContainer {
	...
	async removeCoupon() {
		// Desktop
		if (currentScreenSize() !== 'mobile') {
			await driverHelper.clickWhenClickable(this.driver, By.css('.cart-body .cart__remove-link'));
	...
	async removeFromCart() {
		return await driverHelper.clickWhenClickable(this.driver, By.css('button.cart__remove-item'));
	}

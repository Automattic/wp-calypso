...
export default class NotificationsComponent extends AsyncBaseContainer {
	...
	async selectComments() {
		await driverHelper.clickWhenClickable(this.driver, by.css('li[data-filter-name="comments"]'));
		return await driverHelper.waitTillPresentAndDisplayed(this.driver, by.css('li.wpnc__comment'));
	}

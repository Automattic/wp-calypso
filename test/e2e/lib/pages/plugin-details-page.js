...
export default class PluginDetailsPage extends AsyncBaseContainer {
	...
	async waitForPlugin() {
		return await driverHelper.waitTillPresentAndDisplayed(this.driver, this.activatePluginSelector);
	}

	async waitForSuccessNotice() {
		return await driverHelper.waitTillPresentAndDisplayed(this.driver, this.successNoticeSelector);
	}

...
export default class CloseAccountPage extends AsyncBaseContainer {
	...
	async enterAccountNameAndClose(accountName) {
		...
		await driverHelper.waitTillNotPresent(this.driver, by.css('.dialog button.is-scary[disabled]'));
		return await driverHelper.clickWhenClickable(this.driver, by.css('.dialog button.is-scary'));
	}

...
export default class ThemeDetailPage extends AsyncBaseContainer {
	...
	async openLiveDemo() {
		return await driverHelper.clickWhenClickable(this.driver, By.css('.theme__sheet-screenshot'));
	}

	async goBackToAllThemes() {
		return await driverHelper.clickWhenClickable(this.driver, By.css('.button.header-cake__back'));
	}

...
export default class EditorPage extends AsyncBaseContainer {
	...
	async dismissMediaModal() {
		await driverHelper.clickWhenClickable(this.driver, by.css('button[data-e2e-button="cancel"]'));
		return await driverHelper.waitTillNotPresent(
			this.driver,
	...
	async waitForTitle() {
		return await driverHelper.waitTillNotPresent(this.driver, by.css('.editor-title.is-loading'));
	}

...
test.describe(
	...
	() => {
		...
		test( '"wpcom_block_editor_create_template_part" event fires', async ( { page } ) => {
		...
		test( '"wpcom_block_editor_convert_to_template_part" and "detach_blocks" events fire correctly', async ( {
			page,
		} ) => {
			let testAccount: TestAccount;
			let fullSiteEditorPage: FullSiteEditorPage;

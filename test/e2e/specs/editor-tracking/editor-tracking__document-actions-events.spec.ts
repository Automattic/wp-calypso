...
test.describe(
	...
	() => {
		...
		test.fixme(
			'"wpcom_site_editor_document_actions_template_area_click" event fires for header',
			async ( { page } ) => {
				const accountName = getTestAccountByFeature( { ...features, variant: 'siteEditor' } );
				let testAccount: TestAccount;
				let fullSiteEditorPage: FullSiteEditorPage;
		...
		test.fixme(
			'"wpcom_site_editor_document_actions_revert_click" event fires',
			async ( { page } ) => {
				const accountName = getTestAccountByFeature( { ...features, variant: 'siteEditor' } );
				let testAccount: TestAccount;
				let fullSiteEditorPage: FullSiteEditorPage;
		...
		test.fixme(
			'"wpcom_site_editor_document_actions_show_all_click" event fires',
			async ( { page } ) => {
				const accountName = getTestAccountByFeature( { ...features, variant: 'siteEditor' } );
				let testAccount: TestAccount;
				let fullSiteEditorPage: FullSiteEditorPage;

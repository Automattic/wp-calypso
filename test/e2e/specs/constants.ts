...
export const TEST_IMAGE_PATH = path.join( TEST_FILES_FOLDER_PATH, 'test-image-01.webp' );
export const ALT_TEST_IMAGE_PATH = path.join( TEST_FILES_FOLDER_PATH, 'test-image-02.webp' );

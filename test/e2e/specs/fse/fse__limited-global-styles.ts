...
import { DataHelper, TestAccount, FullSiteEditorPage, envVariables } from '@automattic/calypso-e2e';
...
skipDescribeIf( envVariables.COBLOCKS_EDGE )(
	DataHelper.createSuiteTitle( 'Site Editor: Limited Global Styles' ),
	function () {
		let page: Page;

...
test.describe( 'Themes', () => {
	...
	test( 'Preview (Environment Specified Account)', async ( {
		page,
		...
		const testAccountSiteDomain = accountGivenByEnvironment.getSiteURL( { protocol: false } );

		// This test will use partial matching names to cycle between available themes.
		const themeName = 'Twenty Twen';

		await test.step( `Authenticate as '${ accountGivenByEnvironment.accountName }'`, async function () {

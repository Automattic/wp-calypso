...
1. Required [`wsl`](https://learn.microsoft.com/en-us/windows/wsl/install), [`nvm`](https://github.com/nvm-sh/nvm)
2. Clone Repository in WSL instance
3. Execute `nvm` from root directory of reporistory
4. Execute `export NODE_OPTIONS="--max-old-space-size=8192"`
5. Execute `Yarn`
6. Execute `Yarn start`

Windows detailed installing instructions. [Windows Instructions]((./docs/install.md))

...
https
	...
	.on( 'error', ( error ) => {
		...
		console.error(
			`Failed to download ${ LANGUAGES_META_URL }. Pre-defined languages data will be used as a fall back.`
		);
		fs.writeFileSync( FILE_PATH, JSON.stringify( LANGUAGES_FALLBACK_DATA ) );
	} );

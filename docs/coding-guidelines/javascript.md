...
- Object: [`isPlainObject( value )`](./packages/is-plain-object). Note that in most cases, `typeof value === 'object' && value.constructor === Object` should do the job for plain objects.

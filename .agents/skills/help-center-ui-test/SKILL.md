...
Performs a systematic browser-based UI review of the Help Center using Chrome automation (Codex in Chrome extension).

## Prerequisites

- The **Codex in Chrome** browser extension must be installed and connected. Run `/chrome` in Codex if not connected.

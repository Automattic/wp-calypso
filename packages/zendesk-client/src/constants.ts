...
export const SMOOCH_SCRIPT_ID = 'smooch-sdk-script';
export const SMOOCH_VERSION = '5.7.17';
export const SMOOCH_CDN_URL = `https://cdn.smooch.io/smooch.${ SMOOCH_VERSION }.min.js`;

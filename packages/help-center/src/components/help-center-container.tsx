...
import { useState, useRef, useEffect, useCallback, FC, forwardRef } from 'react';
...
const HelpCenterContainer: React.FC< Container > = forwardRef(
	( { handleClose, hidden, currentRoute, lastClickEvent }, nodeRef ) => {

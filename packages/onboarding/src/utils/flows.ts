...
export const ONBOARDING_AFF_PM_FLOW = 'onboarding-aff-pm';
...
export const isOnboardingAffPmFlow = ( flowName: string | null ) => {
	return Boolean( flowName && [ ONBOARDING_AFF_PM_FLOW ].includes( flowName ) );
};

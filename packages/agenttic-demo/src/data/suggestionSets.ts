...
export type SuggestionContext = 'button' | 'heading' | 'image' | 'pattern' | 'none';
...
export const contextSuggestionSets: Record< SuggestionContext, Suggestion[] > = {
	...
	image: [
		...
		},
		{
			...
			prompt:
				'Add a new gallery pattern to the page with three images, right below the currently selected pattern.',
		},
	],
	pattern: [
		{
		...
		},
		{
			...
			prompt:
				'Give me alternative layout variations for this pattern, keeping all content and copy exactly the same.',
		},
	],
	none: [],
};

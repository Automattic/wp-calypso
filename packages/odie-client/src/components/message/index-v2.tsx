...
export type MessageIndicatorsV2 = {
...
const ChatMessageV2 = ( props: ChatMessagesProps & MessageIndicatorsV2 ) => {
	...
	const messageHeader = () => {
		...
		return <div className="message-header bot">{ messageAvatarHeader }</div>;
	};

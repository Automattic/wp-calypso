 ...
 * @returns {string[]} - The allowed block types
 */
 ...
 * @returns {string[]} - The disallowed block types
 */
 ...
 * @param {IsoSettings} isoSettings - Isolated Block Editor specific settings
 * @param {object[]} allBlockTypes - All available blocks
 * @param {boolean} hasFixedToolbar - Do we need a fixed toolbar?
 * @returns {EditorSettings} - Settings
 */

...
const FilterText = ( { activeElements, filterInView, filter }: FilterTextProps ) => {
...
function OperatorSelector( { filter, view, onChangeView }: OperatorSelectorProps ) {
		...
		<Dropdown
			...
			renderToggle={ ( { isOpen, onToggle } ) => (
				<div className="dataviews-filters__summary-chip-container">
					...
					{ canResetOrRemove && (
						<Tooltip text={ isPrimary ? __( 'Reset' ) : __( 'Remove' ) } placement="top">
							<button

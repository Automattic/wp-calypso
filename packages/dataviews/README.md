...
| `inThePast`          | Date           | `IN THE PAST`. The item's field is in the past given a unit and a value.                             | Date is in the past 7 days                         |
| `over`               | Date           | `OVER`. The item's field is over a given unit and a value before now.                                | Date is over 7 days ago                            |

...
export declare function prepareDomainContactDetails(details: ManagedContactDetails): DomainContactDetails;
export declare type ManagedContactDetailsUpdaters = {
    updateDomainFields: (ManagedContactDetails: any, DomainContactDetails: any) => ManagedContactDetails;
    ...
    setErrorMessages: (ManagedContactDetails: any, ManagedContactDetailsErrors: any) => ManagedContactDetails;
};

...
export const GooglePlayIconSvg = () => (
	...
	>
		<defs>
			<path
				id="lp-mobile-badge-path-1"
				d="M31.28 24.77 6.05 39.07A4.05 4.05 0 0 1 0 35.55V6.95a4.05 4.05 0 0 1 6.05-3.52l25.23 14.3a4.05 4.05 0 0 1 0 7.04Z"
			/>
		</defs>
		<g transform="translate(0 -2.25)">
			<mask id="lp-mobile-badge-path-2" fill="#fff">
				<use xlinkHref="#lp-mobile-badge-path-1" />
			</mask>
			<use fill="#34a853" xlinkHref="#lp-mobile-badge-path-1" />
			<path fill="#ea4335" mask="url(#lp-mobile-badge-path-2)" d="M-4 21.25h40v20H-4z" />
			<path fill="#fbbc04" mask="url(#lp-mobile-badge-path-2)" d="M35 2v38.5L15.62 21.25z" />
			<path fill="#4285f4" mask="url(#lp-mobile-badge-path-2)" d="m-4 1.75 19.62 19.5L-4 40.75z" />
		</g>
	</svg>
);

export const FacebookIconSvg = ( { redesigned = false }: { redesigned?: boolean } ) => (
	<svg
		className="lp-icon"
		xmlns="http://www.w3.org/2000/svg"
		viewBox="0 0 24 24"
	...
	>
		<path
			d={
				redesigned
					? 'M13.69 20.8v-7.6h2.51l.49-3.14h-3V8.03c0-.86.41-1.7 1.76-1.7h1.36V3.66s-1.24-.22-2.42-.22c-2.47 0-4.08 1.51-4.08 4.23v2.39H7.57v3.14h2.74v7.6z'
					: 'M12 0a12 12 0 1 1 0 24 12 12 0 0 1 0-24Zm0 1.2C6.03 1.2 1.2 6.06 1.2 12.06c0 5.43 3.95 9.92 9.11 10.74v-7.6H7.57v-3.14h2.74V9.67c0-2.72 1.61-4.23 4.08-4.23 1.18 0 2.42.22 2.42.22v2.67h-1.36c-1.35 0-1.76.84-1.76 1.7v2.03h3l-.49 3.15h-2.5v7.59a10.85 10.85 0 0 0 9.1-10.74c0-6-4.83-10.86-10.8-10.86Z'
			}
		/>
	</svg>
);

export const XIconSvg = ( { redesigned = false }: { redesigned?: boolean } ) => (
	<svg
		className="lp-icon"
		xmlns="http://www.w3.org/2000/svg"
		viewBox="0 0 24 24"
	...
	>
		<path
			d={
				redesigned
					? 'M10.03 6l2.9 4.23L16.58 6h1l-4.2 4.87 4.56 6.63h-3.35l-3.07-4.47-3.84 4.47h-.99l4.4-5.1L6.67 6h3.35Zm-.47.75H8.03l3.54 5.06.45.64 3.03 4.34h1.52l-3.71-5.32-.45-.63-2.85-4.1Z'
					: 'M12 0a12 12 0 1 1 0 24 12 12 0 0 1 0-24Zm0 1.2a10.8 10.8 0 1 0 0 21.6 10.8 10.8 0 0 0 0-21.6ZM10.03 6l2.9 4.23L16.58 6h1l-4.2 4.87 4.56 6.63h-3.35l-3.07-4.47-3.84 4.47h-.99l4.4-5.1L6.67 6h3.35Zm-.47.75H8.03l3.54 5.06.45.64 3.03 4.34h1.52l-3.71-5.32-.45-.63-2.85-4.1Z'
			}
		/>
	</svg>
);

export const InstagramIconSvg = ( { redesigned = false }: { redesigned?: boolean } ) => (
	<svg
		className="lp-icon"
		xmlns="http://www.w3.org/2000/svg"
		viewBox="0 0 24 24"
...
export const AppDownloadQrCodeSvg = () => (
	...
	>
		<path
			fill="currentColor"
			d="M0 0h7v1h-7zM9 0h3v1h-3zM16 0h4v1h-4zM22 0h7v1h-7zM0 1h1v1h-1zM6 1h1v1h-1zM8 1h2v1h-2zM12 1h1v1h-1zM15 1h1v1h-1zM17 1h1v1h-1zM20 1h1v1h-1zM22 1h1v1h-1zM28 1h1v1h-1zM0 2h1v1h-1zM2 2h3v1h-3zM6 2h1v1h-1zM9 2h1v1h-1zM12 2h1v1h-1zM14 2h2v1h-2zM18 2h2v1h-2zM22 2h1v1h-1zM24 2h3v1h-3zM28 2h1v1h-1zM0 3h1v1h-1zM2 3h3v1h-3zM6 3h1v1h-1zM8 3h1v1h-1zM10 3h1v1h-1zM13 3h5v1h-5zM20 3h1v1h-1zM22 3h1v1h-1zM24 3h3v1h-3zM28 3h1v1h-1zM0 4h1v1h-1zM2 4h3v1h-3zM6 4h1v1h-1zM9 4h3v1h-3zM13 4h1v1h-1zM16 4h1v1h-1zM18 4h3v1h-3zM22 4h1v1h-1zM24 4h3v1h-3zM28 4h1v1h-1zM0 5h1v1h-1zM6 5h1v1h-1zM8 5h1v1h-1zM15 5h4v1h-4zM20 5h1v1h-1zM22 5h1v1h-1zM28 5h1v1h-1zM0 6h7v1h-7zM8 6h1v1h-1zM10 6h1v1h-1zM12 6h1v1h-1zM14 6h1v1h-1zM16 6h1v1h-1zM18 6h1v1h-1zM20 6h1v1h-1zM22 6h7v1h-7zM9 7h2v1h-2zM12 7h1v1h-1zM14 7h3v1h-3zM19 7h1v1h-1zM0 8h5v1h-5zM6 8h4v1h-4zM12 8h3v1h-3zM17 8h1v1h-1zM20 8h2v1h-2zM23 8h1v1h-1zM25 8h1v1h-1zM27 8h1v1h-1zM0 9h2v1h-2zM5 9h1v1h-1zM7 9h1v1h-1zM11 9h1v1h-1zM16 9h7v1h-7zM24 9h1v1h-1zM28 9h1v1h-1zM0 10h3v1h-3zM6 10h1v1h-1zM10 10h1v1h-1zM13 10h5v1h-5zM20 10h1v1h-1zM22 10h2v1h-2zM0 11h6v1h-6zM8 11h1v1h-1zM14 11h2v1h-2zM20 11h3v1h-3zM24 11h2v1h-2zM27 11h1v1h-1zM1 12h3v1h-3zM6 12h10v1h-10zM17 12h1v1h-1zM23 12h1v1h-1zM25 12h2v1h-2zM0 13h1v1h-1zM3 13h1v1h-1zM5 13h1v1h-1zM9 13h1v1h-1zM11 13h3v1h-3zM16 13h5v1h-5zM22 13h3v1h-3zM28 13h1v1h-1zM0 14h2v1h-2zM4 14h1v1h-1zM6 14h5v1h-5zM13 14h4v1h-4zM24 14h3v1h-3zM0 15h1v1h-1zM2 15h2v1h-2zM5 15h1v1h-1zM7 15h1v1h-1zM19 15h1v1h-1zM22 15h1v1h-1zM24 15h1v1h-1zM27 15h1v1h-1zM0 16h2v1h-2zM6 16h2v1h-2zM12 16h2v1h-2zM15 16h1v1h-1zM17 16h2v1h-2zM20 16h1v1h-1zM23 16h1v1h-1zM25 16h2v1h-2zM0 17h1v1h-1zM5 17h1v1h-1zM7 17h1v1h-1zM11 17h1v1h-1zM13 17h2v1h-2zM16 17h9v1h-9zM26 17h1v1h-1zM28 17h1v1h-1zM0 18h1v1h-1zM2 18h2v1h-2zM6 18h1v1h-1zM9 18h1v1h-1zM12 18h1v1h-1zM14 18h4v1h-4zM22 18h1v1h-1zM24 18h1v1h-1zM26 18h1v1h-1zM0 19h1v1h-1zM7 19h2v1h-2zM14 19h1v1h-1zM16 19h1v1h-1zM22 19h1v1h-1zM24 19h1v1h-1zM27 19h1v1h-1zM0 20h1v1h-1zM2 20h1v1h-1zM5 20h2v1h-2zM12 20h3v1h-3zM16 20h2v1h-2zM20 20h5v1h-5zM26 20h3v1h-3zM8 21h2v1h-2zM11 21h1v1h-1zM14 21h1v1h-1zM18 21h3v1h-3zM24 21h5v1h-5zM0 22h7v1h-7zM8 22h2v1h-2zM15 22h3v1h-3zM19 22h2v1h-2zM22 22h1v1h-1zM24 22h3v1h-3zM0 23h1v1h-1zM6 23h1v1h-1zM10 23h2v1h-2zM14 23h1v1h-1zM16 23h1v1h-1zM19 23h2v1h-2zM24 23h1v1h-1zM27 23h1v1h-1zM0 24h1v1h-1zM2 24h3v1h-3zM6 24h1v1h-1zM8 24h1v1h-1zM10 24h5v1h-5zM17 24h1v1h-1zM20 24h5v1h-5zM26 24h1v1h-1zM0 25h1v1h-1zM2 25h3v1h-3zM6 25h1v1h-1zM8 25h4v1h-4zM14 25h1v1h-1zM18 25h1v1h-1zM23 25h1v1h-1zM25 25h2v1h-2zM28 25h1v1h-1zM0 26h1v1h-1zM2 26h3v1h-3zM6 26h1v1h-1zM8 26h3v1h-3zM13 26h1v1h-1zM15 26h1v1h-1zM19 26h1v1h-1zM22 26h6v1h-6zM0 27h1v1h-1zM6 27h1v1h-1zM8 27h5v1h-5zM15 27h2v1h-2zM20 27h2v1h-2zM23 27h3v1h-3zM27 27h1v1h-1zM0 28h7v1h-7zM8 28h1v1h-1zM10 28h1v1h-1zM12 28h6v1h-6zM19 28h1v1h-1zM21 28h2v1h-2zM24 28h1v1h-1zM26 28h1v1h-1z"
		/>
	</svg>
);

export const YoutubeIconSvg = ( { redesigned = false }: { redesigned?: boolean } ) => (
	<svg
		className="lp-icon"
		xmlns="http://www.w3.org/2000/svg"
		viewBox="0 0 24 24"
	...
	>
		<path
			d={
				redesigned
					? 'M17.61 6.93c.62.18 1.11.7 1.28 1.36.27 1.07.3 3.15.31 3.62v.19c0 .46-.03 2.55-.3 3.61a1.88 1.88 0 0 1-1.28 1.37c-1.02.3-4.83.32-5.51.32h-.21c-.69 0-4.5-.03-5.52-.32-.62-.18-1.1-.7-1.27-1.37-.27-1.07-.3-3.15-.3-3.61v-.19c0-.47.03-2.55.29-3.6.16-.67.65-1.2 1.27-1.37 1.05-.3 5.09-.34 5.57-.34h.16c.68 0 4.5.03 5.51.33Zm-7.05 2.76v4.63L14.29 12l-3.73-2.3Z'

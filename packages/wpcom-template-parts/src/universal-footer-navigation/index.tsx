...
export const PureUniversalNavbarFooter = ( {
	...
	automatticBranding = {
		prefix: __( 'An', __i18n_text_domain__ ),
		suffix: __( 'thingamajig', __i18n_text_domain__ ),
	},
	locale,
...
const UniversalNavbarFooter = ( {
	...
	const [ automatticBranding, setAutomatticBranding ] = useState( { prefix: '', suffix: '' } );

										...
										>
											...
											>
												<path
													...
													fill={ logoColor ?? 'var(--studio-blue-50)' }
												/>
												<path
												...
												>
													<ul>
														...
														<ClickableItem
															...
															urlValue={ localizeUrl( '//wordpress.com/ai-website-builder/' ) }
															type="dropdown"
															target="_self"
														/>
														<ClickableItem
														...
														<ClickableItem
															...
															urlValue={ localizeUrl( '//wordpress.com/newsletter/' ) }
															type="dropdown"
															target="_self"
														/>
														<ClickableItem
											...
											<li className="x-nav-item x-nav-item__wide" role="none">
												...
												>
													...
													<ul>
														...
														<ClickableItem
															titleValue=""
															content={ __( 'WordPress AI Features', __i18n_text_domain__ ) }
															urlValue={ localizeUrl( '//wordpress.com/ai/' ) }
															type="dropdown"
															target="_self"
														/>
														<ClickableItem
											...
											<li className="x-nav-item x-nav-item__wide" role="none">
												...
												>
													<ul>
														<ClickableItem
															titleValue=""
															content={ __( 'Support Center', __i18n_text_domain__ ) }
								...
								<>
									...
									<div className="x-menu-list" aria-hidden={ ! isMobileMenuOpen }>
										...
										<ul className="x-menu-grid">
											...
											<ClickableItem
												titleValue=""
												content={ __( 'WordPressNews', __i18n_text_domain__ ) }
												urlValue={ localizeUrl( '//wordpress.com/blog/' ) }
												type="menu"
												tabIndex={ mobileMenuTabIndex }
											/>

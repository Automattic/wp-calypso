...
export const PRODUCT_WOOCOMMERCE_COOL_EXTENSION = 'woocommerce_cool_extension_yearly';
...
export const JETPACK_PRODUCT_RECCOMENDATION_MAP: Record< string, string[] > = {
	...
	[ PRODUCT_WOOCOMMERCE_COOL_EXTENSION ]: [ JETPACK_TAG_FOR_WOOCOMMERCE_STORES ],
};

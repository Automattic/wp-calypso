...
export const PLAN_JETPACK_SECURITY_T0_YEARLY = 'jetpack_security_t0_yearly';
export const PLAN_JETPACK_SECURITY_T0_MONTHLY = 'jetpack_security_t0_monthly';
...
export const JETPACK_SECURITY_T0_PLANS = < const >[
	PLAN_JETPACK_SECURITY_T0_MONTHLY,
	PLAN_JETPACK_SECURITY_T0_YEARLY,
];
...
export const JETPACK_PLAN_UPGRADE_MAP: Record< string, string[] > = {
	...
	[ PLAN_JETPACK_SECURITY_T0_YEARLY ]: [ PLAN_JETPACK_STARTER_YEARLY ],
...
export const JETPACK_STARTER_UPGRADE_MAP: Record< string, string > = {
	[ PLAN_JETPACK_STARTER_YEARLY ]: PLAN_JETPACK_SECURITY_T0_YEARLY,
	[ PLAN_JETPACK_STARTER_MONTHLY ]: PLAN_JETPACK_SECURITY_T0_MONTHLY,
};

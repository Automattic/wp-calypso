...
export const PRODUCT_WOOCOMMERCE_AUTHORIZENET = 'woocommerce_authorizenet_yearly';
...
export const PRODUCT_WOOCOMMERCE_MASTERCARD = 'woocommerce_mastercard_yearly';
...
export const JETPACK_PRODUCT_RECCOMENDATION_MAP: Record< string, string[] > = {
	...
	[ PRODUCT_WOOCOMMERCE_AUTHORIZENET ]: [ JETPACK_TAG_FOR_WOOCOMMERCE_STORES ],
	...
	[ PRODUCT_WOOCOMMERCE_MASTERCARD ]: [ JETPACK_TAG_FOR_WOOCOMMERCE_STORES ],

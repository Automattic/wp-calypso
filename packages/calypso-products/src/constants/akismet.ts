export const AKISMET_FREE = 'ak_free_yearly';
export const AKISMET_PERSONAL_MONTHLY = 'ak_personal_monthly';
export const AKISMET_PERSONAL_YEARLY = 'ak_personal_yearly';
...
export const AKISMET_PERSONAL_PRODUCTS = <const>[
	AKISMET_PERSONAL_MONTHLY,
	AKISMET_PERSONAL_YEARLY,
];

...
export const FEATURE_JETPACK_STATS_MONTHLY = PRODUCT_JETPACK_STATS_MONTHLY;
export const FEATURE_JETPACK_STATS_PWYW_YEARLY = PRODUCT_JETPACK_STATS_PWYW_YEARLY;
export const FEATURE_JETPACK_STATS_FREE_YEARLY = PRODUCT_JETPACK_STATS_FREE_YEARLY;

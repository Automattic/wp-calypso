...
export const FEATURE_SOCIAL_ADVANCED = PRODUCT_JETPACK_SOCIAL_ADVANCED;
export const FEATURE_SOCIAL_ADVANCED_MONTHLY = PRODUCT_JETPACK_SOCIAL_ADVANCED_MONTHLY;

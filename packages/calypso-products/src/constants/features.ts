...
export const FEATURE_JETPACK_VIDEOPRESS_T1 = PRODUCT_JETPACK_VIDEOPRESS_T1_YEARLY;
export const FEATURE_JETPACK_VIDEOPRESS_T2 = PRODUCT_JETPACK_VIDEOPRESS_T2_YEARLY;

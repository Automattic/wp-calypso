	...
	return useCallback(
		( productSlug ) =>
			( {
				...
				[ PRODUCT_JETPACK_BACKUP_ADDON_STORAGE_10GB_YEARLY ]: TEN_GIGABYTES,
				[ PRODUCT_JETPACK_BACKUP_ADDON_STORAGE_100GB_MONTHLY ]: HUNDRED_GIGABYTES,
				[ PRODUCT_JETPACK_BACKUP_ADDON_STORAGE_100GB_YEARLY ]: HUNDRED_GIGABYTES,
				[ PRODUCT_JETPACK_BACKUP_ADDON_STORAGE_1TB_MONTHLY ]: ONE_TERABYTE,
				[ PRODUCT_JETPACK_BACKUP_ADDON_STORAGE_1TB_YEARLY ]: ONE_TERABYTE,
				[ PRODUCT_JETPACK_BACKUP_ADDON_STORAGE_3TB_MONTHLY ]: THREE_TERABYTE,
				[ PRODUCT_JETPACK_BACKUP_ADDON_STORAGE_3TB_YEARLY ]: THREE_TERABYTE,
				[ PRODUCT_JETPACK_BACKUP_ADDON_STORAGE_5TB_MONTHLY ]: FIVE_TERABYTE,
				[ PRODUCT_JETPACK_BACKUP_ADDON_STORAGE_5TB_YEARLY ]: FIVE_TERABYTE,

...
FEATURES_LIST[ FEATURE_PRE_INSTALLED_ECOMMERCE_PLUGINS ] = {
	...FEATURES_LIST[ FEATURE_PRE_INSTALLED_ECOMMERCE_PLUGINS ],
	getSubFeatures: () => ( {
		[ FEATURE_UNLIMITED_PRODUCTS ]: FEATURES_LIST[ FEATURE_UNLIMITED_PRODUCTS ],
		[ FEATURE_MIN_MAX_ORDER_QUANTITY ]: FEATURES_LIST[ FEATURE_MIN_MAX_ORDER_QUANTITY ],
		[ FEATURE_BULK_DISCOUNTS ]: FEATURES_LIST[ FEATURE_BULK_DISCOUNTS ],
		[ FEATURE_INVENTORY ]: FEATURES_LIST[ FEATURE_INVENTORY ],
		[ FEATURE_DYNAMIC_PRODUCT_UPSELLS ]: FEATURES_LIST[ FEATURE_DYNAMIC_PRODUCT_UPSELLS ],
	} ),
};

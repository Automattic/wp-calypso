...
import { isTrailMapCopyVariant, isTrailMapStructureVariant } from './experiments';
	...
	[ FEATURE_GROUP_DEVELOPER_TOOLS ]: {
		...
		getFeatures: () =>
			isTrailMapCopyVariant()
				...
				: [ FEATURE_DEV_TOOLS, FEATURE_SITE_STAGING_SITES, FEATURE_MULTI_SITE, FEATURE_WP_UPDATES ],
	},
	[ FEATURE_GROUP_SECURITY_AND_SAFETY ]: {

...
export const WOOCOMMERCE_EXTENSIONS_PRODUCTS: Record< WooCommerceProductSlug, Product > = {
	...
	[ PRODUCT_WOOCOMMERCE_COOL_EXTENSION ]: {
		product_name: translate( 'WooCommerce Cool Extension' ),
		product_slug: PRODUCT_WOOCOMMERCE_COOL_EXTENSION,
		type: PRODUCT_WOOCOMMERCE_COOL_EXTENSION,
		term: TERM_ANNUALLY,
		bill_period: PLAN_ANNUAL_PERIOD,
		categories: [],
		getFeatures: () => [],
		getProductId: () => 2746,
		getStoreSlug: () => PRODUCT_WOOCOMMERCE_COOL_EXTENSION,
	},
};

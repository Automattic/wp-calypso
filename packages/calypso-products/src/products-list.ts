...
> = {
	...
	[ PRODUCT_JETPACK_VIDEOPRESS_T1_YEARLY ]: {
		...
		product_slug: PRODUCT_JETPACK_VIDEOPRESS_T1_YEARLY,
		type: PRODUCT_JETPACK_VIDEOPRESS_T1_YEARLY,
		term: TERM_ANNUALLY,
		bill_period: PLAN_ANNUAL_PERIOD,
		getFeatures: () => [ FEATURE_JETPACK_VIDEOPRESS_T1 ],
	},
	[ PRODUCT_JETPACK_VIDEOPRESS_T1_MONTHLY ]: {
		product_name: translate( 'VideoPress' ),
		product_slug: PRODUCT_JETPACK_VIDEOPRESS_T1_MONTHLY,
		type: PRODUCT_JETPACK_VIDEOPRESS_T1_MONTHLY,
		term: TERM_MONTHLY,
		bill_period: PLAN_MONTHLY_PERIOD,
		getFeatures: () => [ FEATURE_JETPACK_VIDEOPRESS_T1 ],
	},
	[ PRODUCT_JETPACK_VIDEOPRESS_T2_YEARLY ]: {
		product_name: translate( 'VideoPress Pro' ),
		product_slug: PRODUCT_JETPACK_VIDEOPRESS_T2_YEARLY,
		type: PRODUCT_JETPACK_VIDEOPRESS_T2_YEARLY,
		term: TERM_ANNUALLY,
		bill_period: PLAN_ANNUAL_PERIOD,
		getFeatures: () => [ FEATURE_JETPACK_VIDEOPRESS_T2 ],
	},
	[ PRODUCT_JETPACK_VIDEOPRESS_T2_MONTHLY ]: {
		product_name: translate( 'VideoPress Pro' ),
		product_slug: PRODUCT_JETPACK_VIDEOPRESS_T2_MONTHLY,
		type: PRODUCT_JETPACK_VIDEOPRESS_T2_MONTHLY,
		term: TERM_MONTHLY,
		bill_period: PLAN_MONTHLY_PERIOD,
		getFeatures: () => [ FEATURE_JETPACK_VIDEOPRESS_T2 ],
	},

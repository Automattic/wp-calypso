...
import {
	...
	PRODUCT_A4A_JETPACK_SOCIAL_V1_YEARLY,
	PRODUCT_A4A_JETPACK_SOCIAL_V1_MONTHLY,
...
> = {
	...
	[ PRODUCT_A4A_JETPACK_SOCIAL_V1_YEARLY ]: {
		product_name: translate( 'Social' ),
		product_slug: PRODUCT_A4A_JETPACK_SOCIAL_V1_YEARLY,
		type: PRODUCT_A4A_JETPACK_SOCIAL_V1_YEARLY,
		term: TERM_ANNUALLY,
		bill_period: PLAN_ANNUAL_PERIOD,
		categories: [],
		getFeatures: () => [
		...
		getProductId: () => 3338,
		getStoreSlug: () => PRODUCT_A4A_JETPACK_SOCIAL_V1_YEARLY,
	},
	[ PRODUCT_A4A_JETPACK_SOCIAL_V1_MONTHLY ]: {
		product_name: translate( 'Social' ),
		product_slug: PRODUCT_A4A_JETPACK_SOCIAL_V1_MONTHLY,
		type: PRODUCT_A4A_JETPACK_SOCIAL_V1_MONTHLY,
		term: TERM_MONTHLY,
		bill_period: PLAN_MONTHLY_PERIOD,
		categories: [],
		getFeatures: () => [
		...
		getProductId: () => 3339,
		getStoreSlug: () => PRODUCT_A4A_JETPACK_SOCIAL_V1_MONTHLY,
	},
	[ PRODUCT_JETPACK_SOCIAL_ADVANCED ]: {
		product_name: translate( 'Social Advanced (Beta)' ),

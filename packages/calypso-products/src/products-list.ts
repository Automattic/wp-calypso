...
> = {
	...
	[ PRODUCT_JETPACK_SEARCH_FREE ]: {
		...
		type: PRODUCT_JETPACK_SEARCH,
		term: TERM_MONTHLY, // Technically doesn't have a term period, can last forever.
		bill_period: PLAN_MONTHLY_PERIOD, // Technically doesn't have a billing period. It's free.
		categories: [ JETPACK_PERFORMANCE_CATEGORY ],
		getFeatures: () => [
			FEATURE_SEARCH_V2,
			FEATURE_FILTERING_V2,
	...
	[ PRODUCT_JETPACK_SOCIAL_BASIC ]: {
		...
		bill_period: PLAN_ANNUAL_PERIOD,
		categories: [],
		getFeatures: () => [ SOCIAL_SHARES_1000 ],
		getProductId: () => 2503,

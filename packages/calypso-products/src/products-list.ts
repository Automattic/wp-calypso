...
export const WOOCOMMERCE_EXTENSIONS_PRODUCTS: Record< WooCommerceProductSlug, Product > = {
	...
	[ PRODUCT_WOOCOMMERCE_AUTHORIZENET ]: {
		product_name: translate( 'Authorize.net, a Visa solution for WooCommerce' ),
		product_slug: PRODUCT_WOOCOMMERCE_AUTHORIZENET,
		type: PRODUCT_WOOCOMMERCE_AUTHORIZENET,
		term: TERM_ANNUALLY,
		bill_period: PLAN_ANNUAL_PERIOD,
		categories: [],
		getFeatures: () => [],
		getProductId: () => 2757,
		getStoreSlug: () => PRODUCT_WOOCOMMERCE_AUTHORIZENET,
	},
	[ PRODUCT_WOOCOMMERCE_MOLLIE ]: {
	...
	[ PRODUCT_WOOCOMMERCE_MASTERCARD ]: {
		product_name: translate( 'Mastercard for WooCommerce' ),
		product_slug: PRODUCT_WOOCOMMERCE_MASTERCARD,
		type: PRODUCT_WOOCOMMERCE_MASTERCARD,
		term: TERM_ANNUALLY,
		bill_period: PLAN_ANNUAL_PERIOD,
		categories: [],
		getFeatures: () => [],
		getProductId: () => 2765,
		getStoreSlug: () => PRODUCT_WOOCOMMERCE_MASTERCARD,
	},
	[ PRODUCT_WOOCOMMERCE_PAYPAL ]: {

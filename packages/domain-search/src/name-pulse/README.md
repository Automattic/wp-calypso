...
3. **Exact match for “name”** — one row per TLD returned by the tlds endpoint, in its order, availability checked in bulk batches; "Show more exact matches" reveals 12 more rows and checks them.

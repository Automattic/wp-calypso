...
class PasswordlessSignupForm extends Component {
	...
	onFormSubmit = event => {
		...
		// 			validate: false,
		// 			// ab_test_variations: this.props.abTextVariations,
		// 		},
		// 		null
		// 	);
	...
	render() {
		...
		return (
			<div className="passwordless__form-wrapper">
				<LoggedOutForm onSubmit={ this.onFormSubmit } noValidate>
					<ValidationFieldset errorMessages={ errorMessages }>
						...
						<FormTextInput
							autoCapitalize={ 'off' }
							className="passwordless__email-input"
							type="email"
							name="email"
...
export default localize( PasswordlessSignupForm );

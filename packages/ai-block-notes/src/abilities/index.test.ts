/**
 * Unit tests for AI Block Notes ability registration and callback.
 *
...
import { ABILITY_NAME, type AiBlockNotesCallback, registerAiBlockNotesAbility } from './index';
...
describe( 'AI Block Notes Ability', () => {
	...
	describe( 'registerAiBlockNotesAbility', () => {
		it( 'should register ability successfully on first call', async () => {
			await registerAiBlockNotesAbility();
	...
	describe( 'Callback - error handling', () => {
		...
		it( 'should catch and track errors during reply operation', async () => {
			...
			expect( consoleErrorSpy ).toHaveBeenCalledWith(
				'AI Block Notes: Ability execution failed',
				testError
			);
			expect( result ).toEqual( {
				success: false,

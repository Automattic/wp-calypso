/**
 * AI Block Notes Agent Configuration
 *
 * Creates agent config specific to the AI Block Notes context.
...
/**
 * Create agent configuration for the AI Block Notes context.
 * @param sessionId Session ID for the agent chat
 * @returns Promise resolving to complete UseAgentChatConfig
 */
export async function createAiBlockNotesAgentConfig(
	sessionId: string
...
export const aiBlockNotesAgentConfig: AgentConfigFactory = {
	createAgentConfig: createAiBlockNotesAgentConfig,
};

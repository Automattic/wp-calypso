...
import { MultiStepPageObjectModel } from '../types';
 ...
 */
export class CGutenbergEditorPage implements MultiStepPageObjectModel {
	private page: Page;
	private frame!: Frame;
	...
	/**
	 * validate expected selectors on this page
	 */
	async validateStartingLayout(): Promise< void > {

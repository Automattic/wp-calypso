...
export const mockMessages: Message[] = [
	...
	createMockMessage(
		'assistant',
		"I'll fetch your site analytics for you. Let me analyze your traffic and engagement data...",
		{
	...
	createMockMessage(
		'assistant',
		'Absolutely! Here are your analytics insights and content optimization recommendations. Your site is performing well with good engagement across multiple pages.'
	),
];
...
export const getRegisteredSuggestionsForContext = (
	...
	const suggestionSets = {
		button: [
			{
				id: 'btn-1',
				label: 'Style this button',
				prompt: 'Can you help me style this button?',
			},
			{
				id: 'btn-2',
				label: 'Add click tracking',
				prompt: 'Add click tracking to this button',
			},
		],
		heading: [
			{
				id: 'head-1',
				label: 'Improve SEO',
				prompt: 'How can I improve SEO for this heading?',
			},
			{
				id: 'head-2',
				label: 'Make it stand out',
				prompt: 'Make this heading more prominent',
			},
		],
		image: [
			{
				...
				prompt: 'How can I optimize this image?',
			},
			{
				id: 'img-2',
				label: 'Add alt text',
				prompt: 'Help me write better alt text for this image',
			},
		],
		pattern: [
			{
				id: 'pat-1',
				label: 'Customize pattern',
				prompt: 'How can I customize this pattern?',
			},
			{
				id: 'pat-2',
				label: 'Similar patterns',
				prompt: 'Show me similar patterns',
			},
		],
	};
	...
	const defaultSuggestions = [
		...
		},
		{
			id: 'default-2',
			label: 'Content help',
			prompt: 'Help me improve my content',
		},
	];
	...
	selectedBlocks: [
		{
			...
			attributes: {
				content:
					"Discover why Mama's Bread is celebrated for its fresh, artisanal bread crafted with passion and tradition.",
			},
		},
	],
	currentPage: {

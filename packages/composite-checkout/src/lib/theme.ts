...
const theme: Theme = {
	colors: {
		...
		primary: swatches.wordpressBlueberry50,
		primaryBorder: swatches.pink80,
		primaryOver: swatches.wordpressBlueberry60,
		highlight: swatches.wordpressBlueberry50,
		highlightBorder: swatches.wordpressBlueberry80,
		highlightOver: swatches.wordpressBlueberry60,
		...
		outline: swatches.wordpressBlueberry30,

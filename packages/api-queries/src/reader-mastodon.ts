...
// ---------------------------------------------------------------------------
// Optimistic post-cache infrastructure (private to this file)
// ---------------------------------------------------------------------------
...
// connection-scoped or replies on connection A leak into B's caches.
...
// Cancel only this connection's in-flight Mastodon queries — replying on

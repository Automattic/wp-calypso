/**
 * Hook for managing persistent WP Orchestrator session IDs
...
const SESSION_STORAGE_KEY = 'agents-manager-orchestrator-session-id';
...
/**
 * Hook for managing WP Orchestrator session state
 *
 * Session lifecycle:

export const STORE_KEY = 'automattic/woocommerce-eligibility';

export const TRANSFER_ELIGIBILITY_RECEIVE = 'PRODUCTS_LIST_RECEIVE';
export const TRANSFER_ELIGIBILITY_REQUEST = 'PRODUCTS_LIST_REQUEST';
export const TRANSFER_ELIGIBILITY_REQUEST_FAILURE = 'PRODUCTS_LIST_REQUEST_FAILURE';
export const LATEST_TRANSFER_RECEIVE = 'LATEST_TRANSFER_RECEIVE';
export const LATEST_TRANSFER_RECEIVE_FAILURE = 'LATEST_TRANSFER_RECEIVE_FAILURE';

...
This package is a standalone solution without strict alignment to Gutenberg Core’s source code.
While some components may be adapted for efficiency, the goal is not to fork or replicate Core but to provide a well-structured and optimized implementation that meets specific admin UI needs.

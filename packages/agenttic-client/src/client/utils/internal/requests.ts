...
export async function executeRequest(
	...
	const { timeoutId, controller: timeoutController } = createTimeoutHandler( timeout, 'request' );
...
export async function* executeStreamingRequest(
	...
	const { timeoutId, controller } = createTimeoutHandler( streamingTimeout, 'streaming request' );

...
<Meta of={ OverviewStories } title="Packages/Components/Validated Form Controls/Overview" />
...
<ArgTypes of={ ValidatedInputControl } include={ [ 'required', 'markWhenOptional', 'onReportCustomValidity' ] } />

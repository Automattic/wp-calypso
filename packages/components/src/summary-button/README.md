...
| strapline   | string                       | -       | A brief, optional line of text used to highlight important information, such as a warning or status. Only rendered in `low` density variant.                          |

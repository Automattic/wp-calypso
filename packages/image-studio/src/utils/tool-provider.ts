 ...
 *
 * Provides the image studio abilities to the AI agent. All Image Studio
 * abilities (canvas updates AND the photo-driven Feature Clip render)
 * are registered via @wordpress/abilities and exposed through the
 * getAbilities/executeAbility surface.
 */

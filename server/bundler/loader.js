...
function getSectionsModule(sections) {
    var dependencies, loadSection = '', sectionLoaders = '';
...
function splitTemplate(path, section) {
    var pathRegex = getPathRegex(path), result;
    ...
    result = [
        ...
        '		if ( window.__chunkErrors && window.__chunkErrors[ ' +

...
export default ( router ) => {
	...
	router(
		[
			`/log-in/:twoFactorAuthType(authenticator|backup|email|sms|push|webauthn|security-key-register)/${ lang }`,
			...
			`/log-in/:isJetpack(jetpack)/:twoFactorAuthType(authenticator|backup|email|sms|push|webauthn|security-key-register)/${ lang }`,
			`/log-in/:isJetpack(jetpack)/:action(lostpassword)/${ lang }`,
			`/log-in/:isGutenboarding(new)/${ lang }`,
			`/log-in/:isGutenboarding(new)/:twoFactorAuthType(authenticator|backup|email|sms|push|webauthn|security-key-register)/${ lang }`,

...
const remoteAuthPath = '/wp-admin/admin.php?page=jetpack&connect_url_redirect=true&calypso_env=' +
    calypsoEnv;
        ...
        return dispatch => {
            ...
            return wpcom
                ...
                .then(data => {
                    ...
                    return wpcom
                        .undocumented()
                        .jetpackAuthorize(client_id, data.code, state, redirect_uri, secret);
                })
                .then(data => {
    ...
    activateManage(blogId, state, secret) {
        return dispatch => {
            ...
            return wpcom
                ...
                .catch(error => {
                    tracksEvent(dispatch, 'calypso_jpc_activate_manage_error', {
                        error_code: error.code,
                        error: JSON.stringify(error),
                    });

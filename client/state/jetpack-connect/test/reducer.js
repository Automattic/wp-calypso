...
describe('reducer', () => {
    ...
    describe('#jetpackConnectAuthorize()', () => {
        ...
        it('should set authorizeSuccess to true when completed authorization successfully', () => {
            ...
            expect(state).to.have.property('activateManageSecret').to.eql(data.activate_manage);
        });
        ...
        it('should set isActivating to true when manage is being activated', () => {
            ...
            expect(state).to.have.property('isActivating').to.be.true;
        });
        ...
        it('should mark manage as activated when request completes', () => {
            ...
            expect(state).to.have.property('isActivating').to.be.false;
            expect(state).to.have.property('manageActivated').to.be.true;
            expect(state).to.have.property('manageActivatedError').to.be.undefined;
            expect(state).to.have.property('activateManageSecret').to.be.false;
        });
        ...
        it('should store the error if an error occurs during manage activation', () => {
            ...
            expect(state).to.have.property('isActivating').to.be.false;
            expect(state).to.have.property('manageActivated').to.be.true;
            expect(state).to.have.property('manageActivatedError').to.eql(error);
            expect(state).to.have.property('activateManageSecret').to.be.false;
        });

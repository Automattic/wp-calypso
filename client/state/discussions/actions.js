 ...
 * @param   {Number} postId   post identifier
 * @param   {String} status   status filter. Defaults to all posts
 * @param   {Array}  comments returned array of comments
 * @returns {Object}          action object
 */
 ...
 * @returns {Object}           action object
 */
export function requestCommentContentUpdate( siteId, commentId, content ) {
	return {
 ...
 * @returns {Object}            action object
 */
export function requestCommentLike( siteId, commentId, source ) {
	return {
...
/***
 * returns an action object used in signalling that the unlike update
 * has been requested.
 *
 * @param   {Number}  siteId    site identifier
 * @param   {Number}  commentId comment identifier
 ...
 * @returns {Object}            action object
 */
export function requestCommentUnLike( siteId, commentId, source ) {
	return {
...
/***
 * returns an action object used in signalling that the like/unlike update
 * request has been successful.
 *
 * @param   {Number}  siteId    site identifier
 * @param   {Number}  commentId comment identifier
 ...
 * @returns {Object}           action object
 */
export function requestCommentStatusUpdate( siteId, commentId, status ) {
	return {

...
export const accountRecoverySettingsFetch = () =>
    dispatch => {
...
export const updateAccountRecoveryPhone = newPhone =>
    dispatch => {
        dispatch({
...
export const deleteAccountRecoveryPhone = () =>
    dispatch => {
        dispatch({
...
export const updateAccountRecoveryEmail = newEmail =>
    dispatch => {
        dispatch({
            type: ACCOUNT_RECOVERY_SETTINGS_UPDATE,
            target: TARGET_EMAIL,
...
export const deleteAccountRecoveryEmail = () =>
    dispatch => {
        dispatch({
            type: ACCOUNT_RECOVERY_SETTINGS_DELETE,
            target: TARGET_EMAIL,
...
export const resendAccountRecoveryEmailValidation = () =>
    dispatch => {
        dispatch({
...
export const resendAccountRecoveryPhoneValidation = () =>
    dispatch => {
        dispatch({
            type: ACCOUNT_RECOVERY_SETTINGS_RESEND_VALIDATION,
            target: TARGET_PHONE,
...
export const validateAccountRecoveryPhone = code =>
    dispatch => {
        dispatch({

 ...
 *
 * @param {string} apiVersion [optional]  speciific API version for request
 * @param {Object} body [optional] JSON-serializable body for POST requests
 ...
 * @param {Array} pathArgs [optional] data to replace placeholders with, in order, e.g. [ 'blarg.wordpress.com' ]
 * @param {Object} query [optional] key/value pairs for query string
 ...
 * @param {Object} options [optional] extra options to send to the middleware, e.g. retry policy or offline policy

...
export getNotificationsAnimationState from './get-notifications-animation-state';
export getNotificationsNewNoteStatus from './get-notifications-new-note-status';
...
export hasCurrentUserUnseenNotifications from './has-current-user-unseen-notifications';

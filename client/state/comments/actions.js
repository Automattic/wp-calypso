...
import { getPostOldestCommentDate, getPostCommentRequests } from './selectors';
...
export function requestPostComments(siteId, postId) {
    return (dispatch, getState) => {
        ...
        if (
            postCommentRequests &&
            [COMMENTS_REQUEST, COMMENTS_REQUEST_SUCCESS].indexOf(
                postCommentRequests.get(requestId)
            ) !== -1
        ) {
            return;
        }

...
describe('selectors', () => {
	...
	describe('#getPostCommentsCountAtDate()', () => {
		...
		test('should return 0 if post comment does not exist', () => {
			const res = getPostCommentsCountAtDate(state, 1, 123, new Date('2015-01-29T10:07:18-08:00'));

			expect(res).toBe(0);
		});

		test('should return the count if the post and date are valid', () => {
			const res = getPostCommentsCountAtDate(state, 1, 1, new Date('2016-01-29T10:07:18-08:00'));

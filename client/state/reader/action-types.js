...
export const READER_LIST__CREATE = 'READER_LIST__CREATE';
export const READER_LIST__CREATE_FAILURE = 'READER_LIST__CREATE_FAILURE';
export const READER_LIST__CREATE_SUCCESS = 'READER_LIST__CREATE_SUCCESS';
export const READER_LIST__DELETE = 'READER_LIST__DELETE';
export const READER_LIST__FOLLOW = 'READER_LIST__FOLLOW';
export const READER_LIST__FOLLOW_RECEIVE = 'READER_LIST__FOLLOW_RECEIVE';
export const READER_LIST__ITEM_ADD_FEED = 'READER_LIST__ITEM_ADD_FEED';
export const READER_LIST__ITEM_ADD_FEED_RECEIVE = 'READER_LIST__ITEM_ADD_FEED_RECEIVE';
export const READER_LIST__ITEM_ADD_TAG = 'READER_LIST__ITEM_ADD_TAG';
export const READER_LIST__ITEM_ADD_TAG_RECEIVE = 'READER_LIST__ITEM_ADD_TAG_RECEIVE';
export const READER_LIST__ITEM_DELETE_FEED = 'READER_LIST__ITEM_DELETE_FEED';
export const READER_LIST__ITEM_DELETE_SITE = 'READER_LIST__ITEM_DELETE_SITE';
export const READER_LIST__ITEM_DELETE_TAG = 'READER_LIST__ITEM_DELETE_TAG';
export const READER_LIST__ITEMS_RECEIVE = 'READER_LIST__ITEMS_RECEIVE';
export const READER_LIST__ITEMS_REQUEST = 'READER_LIST__ITEMS_REQUEST';
export const READER_LIST__RECEIVE_CURRENT_USER_SUBSCRIBED_LISTS =
	'READER_LIST__RECEIVE_CURRENT_USER_SUBSCRIBED_LISTS';
export const READER_LIST__REQUEST_CURRENT_USER_SUBSCRIBED_LISTS =
	'READER_LIST__REQUEST_CURRENT_USER_SUBSCRIBED_LISTS';
export const READER_LIST__REQUEST_TARGET_LIST = 'READER_LIST__REQUEST_TARGET_LIST';
export const READER_LIST__RECEIVE_TARGET_LIST = 'READER_LIST__RECEIVE_TARGET_LIST';
export const READER_LIST__UNFOLLOW = 'READER_LIST__UNFOLLOW';
export const READER_LIST__UNFOLLOW_RECEIVE = 'READER_LIST__UNFOLLOW_RECEIVE';
export const READER_LIST__UPDATE = 'READER_LIST__UPDATE';
export const READER_LIST__UPDATE_FAILURE = 'READER_LIST__UPDATE_FAILURE';
export const READER_LIST__UPDATE_SUCCESS = 'READER_LIST__UPDATE_SUCCESS';
...
export const READER_USER__REQUEST = 'READER_USER__REQUEST';
export const READER_USER__REQUEST_FAILURE = 'READER_USER__REQUEST_FAILURE';
export const READER_USER__REQUEST_SUCCESS = 'READER_USER__REQUEST_SUCCESS';
export const READER_USER__REQUEST_LISTS = 'READER_USER__REQUEST_LISTS';
export const READER_USER__RECEIVE_LISTS = 'READER_USER__RECEIVE_LISTS';

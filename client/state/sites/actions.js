			...
			.then( ( site ) => {
				...
				if ( site && site.capabilities ) {
					...
					if ( hasSiteTransferredToAtomic && hasMismatchingCapabilities ) {
						// Dispatch the site data now so the UI can react to the
						// Atomic transfer (e.g. isJetpack flipping to true).
						// Capabilities will self-correct on subsequent requests
						// once they propagate on the server side.

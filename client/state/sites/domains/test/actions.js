 ...
 */
import { domainsReceiveAction, domainsRequestAction, domainsRequestSuccessAction, domainsRequestFailureAction, fetchSiteDomains } from '../actions';
import { SITE_ID_FIRST as siteId, REST_API_RESPONSE as wpcomResponse, REST_API_ERROR_RESPONSE as wpcomErrorResponse, ACTION_SITE_DOMAIN_RECEIVE, ACTION_SITE_DOMAIN_REQUEST, ACTION_SITE_DOMAIN_REQUEST_SUCCESS, ACTION_SITE_DOMAIN_REQUEST_FAILURE, ERROR_MESSAGE_RESPONSE as errorResponse } from './fixture';

...
export const COMMAND_PALETTE_OVERRIDE_COMMANDS = 'COMMAND_PALETTE_OVERRIDE_COMMANDS';
export const COMMAND_PALETTE_SELECT_COMMAND = 'COMMAND_PALETTE_SELECT_COMMAND';

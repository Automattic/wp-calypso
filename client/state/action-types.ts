...
export const JETPACK_DASHBOARD_SITES_FETCH = 'JETPACK_DASHBOARD_SITES_FETCH';
export const JETPACK_DASHBOARD_SITES_FETCH_SUCCESS = 'JETPACK_DASHBOARD_SITES_FETCH_SUCCESS';
export const JETPACK_DASHBOARD_SITES_FETCH_FAILURE = 'JETPACK_DASHBOARD_SITES_FETCH_FAILURE';

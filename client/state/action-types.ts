...
export const JETPACK_CREDENTIALS_TEST_FAILURE = 'JETPACK_CREDENTIALS_TEST_FAILURE';
export const JETPACK_CREDENTIALS_TEST_SUCCESS = 'JETPACK_CREDENTIALS_TEST_SUCCESS';

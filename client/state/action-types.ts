...
export const ATOMIC_TRANSFER_INITIATE_SUCCESS = 'ATOMIC_TRANSFER_INITIATE_SUCCESS';
export const ATOMIC_TRANSFER_INITIATE_FAILURE = 'ATOMIC_TRANSFER_INITIATE_FAILURE';
export const ATOMIC_TRANSFER_LATEST = 'ATOMIC_TRANSFER_LATEST';
export const ATOMIC_TRANSFER_LATEST_SUCCESS = 'ATOMIC_TRANSFER_LATEST';
export const ATOMIC_TRANSFER_LATEST_FAILURE = 'ATOMIC_TRANSFER_LATEST';
export const ATOMIC_SOFTWARE_INSTALL = 'ATOMIC_SOFTWARE_INSTALL';
export const ATOMIC_SOFTWARE_INSTALL_SUCCESS = 'ATOMIC_SOFTWARE_INSTALL_SUCCESS';
export const ATOMIC_SOFTWARE_INSTALL_FAILURE = 'ATOMIC_SOFTWARE_INSTALL_FAILURE';
export const ATOMIC_SOFTWARE_STATUS = 'ATOMIC_SOFTWARE_STATUS';
export const ATOMIC_SOFTWARE_STATUS_SUCCESS = 'ATOMIC_SOFTWARE_STATUS_SUCCESS';
export const ATOMIC_SOFTWARE_STATUS_FAILURE = 'ATOMIC_SOFTWARE_STATUS_FAILURE';

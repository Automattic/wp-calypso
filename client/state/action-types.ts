...
export const SITE_PROFILER_SET_REPORT = 'SITE_PROFILER_SET_REPORT';
export const SITE_PROFILER_SET_LAST_VISITED_REPORT = 'SITE_PROFILER_SET_LAST_VISITED_REPORT';

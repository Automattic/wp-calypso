...
export const addStoredCard = paygateToken =>
    dispatch => {
        ...
        return new Promise((resolve, reject) => {
            ...
            .catch(error => {
                dispatch({
                    ...
                    error: error.message ||
                        i18n.translate('There was a problem retrieving stored cards.'),
                });
            });
    };

export const deleteStoredCard = card =>
    dispatch => {
        dispatch({
        ...
        return new Promise((resolve, reject) => {
            ...
            .catch(error => {
                dispatch({
                    ...
                    error: error.message ||
                        i18n.translate('There was a problem deleting the stored card.'),
                });
            });
    };

...
export const TAILOR_MARKUP_RECEIVE = 'TAILOR_MARKUP_RECEIVE';
export const TAILOR_CUSTOMIZATIONS_CLEAR = 'TAILOR_CUSTOMIZATIONS_CLEAR';
export const TAILOR_CUSTOMIZATIONS_UPDATE = 'TAILOR_CUSTOMIZATIONS_UPDATE';
export const TAILOR_CUSTOMIZATIONS_UNDO = 'TAILOR_CUSTOMIZATIONS_UNDO';
export const TAILOR_CUSTOMIZATIONS_SAVED = 'TAILOR_CUSTOMIZATIONS_SAVED';
export const TAILOR_CONTROL_ENTER = 'TAILOR_CONTROL_ENTER';
export const TAILOR_CONTROL_LEAVE = 'TAILOR_CONTROL_LEAVE';
export const TAILOR_RESET = 'TAILOR_RESET';

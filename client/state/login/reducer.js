...
export const twoFactorAuth = createReducer( null, {
	...
	[ TWO_FACTOR_AUTHENTICATION_SEND_PUSH_NOTIFICATION_REQUEST_FAILURE ]: ( state, { twoStepNonce } ) =>
		updateTwoStepNonce( state, { twoStepNonce, nonceType: 'push' } ),
	[ TWO_FACTOR_AUTHENTICATION_SEND_PUSH_NOTIFICATION_REQUEST_SUCCESS ]: ( state, { twoStepNonce, pushWebToken } ) =>
		updateTwoStepNonce( state, { twoStepNonce, nonceType: 'push', push_web_token: pushWebToken } ),

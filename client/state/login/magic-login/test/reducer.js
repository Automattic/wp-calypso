 ...
 */
import { CHECK_YOUR_EMAIL_PAGE, INTERSTITIAL_PAGE, LINK_EXPIRED_PAGE, REQUEST_FORM } from '../constants';
import reducer, { isFetchingAuth, isFetchingEmail, currentView, requestAuthError, requestAuthSuccess, requestEmailError, requestEmailSuccess } from '../reducer';
import { DESERIALIZE, MAGIC_LOGIN_HIDE_REQUEST_FORM, MAGIC_LOGIN_HIDE_REQUEST_NOTICE, MAGIC_LOGIN_SHOW_CHECK_YOUR_EMAIL_PAGE, MAGIC_LOGIN_SHOW_INTERSTITIAL_PAGE, MAGIC_LOGIN_SHOW_LINK_EXPIRED, MAGIC_LOGIN_REQUEST_LOGIN_EMAIL_ERROR, MAGIC_LOGIN_REQUEST_LOGIN_EMAIL_FETCH, MAGIC_LOGIN_REQUEST_LOGIN_EMAIL_SUCCESS, MAGIC_LOGIN_REQUEST_AUTH_ERROR, MAGIC_LOGIN_REQUEST_AUTH_FETCH, MAGIC_LOGIN_REQUEST_AUTH_SUCCESS, MAGIC_LOGIN_RESET_REQUEST_FORM, SERIALIZE } from 'state/action-types';

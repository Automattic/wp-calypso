...
export const items = createReducer(
	{},
	{
		...
		[ JETPACK_MODULES_ACTIVATE_SUCCESS ]: createItemsReducer( true ),
		[ JETPACK_MODULES_DEACTIVATE_SUCCESS ]: createItemsReducer( false ),
...
export const requests = createReducer(
	{},
	{
		...
		[ JETPACK_MODULES_ACTIVATE ]: createRequestsReducer( { activating: true } ),
		[ JETPACK_MODULES_ACTIVATE_FAILURE ]: createRequestsReducer( { activating: false } ),
		[ JETPACK_MODULES_ACTIVATE_SUCCESS ]: createRequestsReducer( { activating: false } ),
		...
		[ JETPACK_MODULES_DEACTIVATE ]: createRequestsReducer( { deactivating: true } ),
		[ JETPACK_MODULES_DEACTIVATE_FAILURE ]: createRequestsReducer( { deactivating: false } ),
		[ JETPACK_MODULES_DEACTIVATE_SUCCESS ]: createRequestsReducer( { deactivating: false } ),

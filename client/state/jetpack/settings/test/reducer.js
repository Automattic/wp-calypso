 ...
 */
import { items as itemsReducer, requests as requestsReducer, saveRequests as saveRequestsReducer } from '../reducer';
import { settings as SETTINGS_FIXTURE, requests as REQUESTS_FIXTURE } from './fixture';
import { JETPACK_MODULE_ACTIVATE_SUCCESS, JETPACK_MODULE_DEACTIVATE_SUCCESS, JETPACK_MODULES_RECEIVE, JETPACK_SETTINGS_RECEIVE, JETPACK_SETTINGS_REGENERATE_POST_BY_EMAIL, JETPACK_SETTINGS_REGENERATE_POST_BY_EMAIL_SUCCESS, JETPACK_SETTINGS_REGENERATE_POST_BY_EMAIL_FAILURE, JETPACK_SETTINGS_REQUEST, JETPACK_SETTINGS_REQUEST_FAILURE, JETPACK_SETTINGS_REQUEST_SUCCESS, JETPACK_SETTINGS_UPDATE, JETPACK_SETTINGS_UPDATE_SUCCESS, JETPACK_SETTINGS_UPDATE_FAILURE, SERIALIZE, DESERIALIZE } from 'state/action-types';

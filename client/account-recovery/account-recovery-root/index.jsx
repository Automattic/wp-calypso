...
import LostPasswordForm from 'client/account-recovery/lost-password-form';
import ForgotUsernameForm from 'client/account-recovery/forgot-username-form';
import ResetPasswordForm from 'client/account-recovery/reset-password-form';
import ResetPasswordEmailForm from 'client/account-recovery/reset-password-email-form';
import ResetPasswordSmsForm from 'client/account-recovery/reset-password-sms-form';
import ResetPasswordConfirmForm from 'client/account-recovery/reset-password-confirm-form';
import ResetPasswordSucceeded from 'client/account-recovery/reset-password-succeeded';
import ResetCodeValidation from 'client/account-recovery/reset-code-validation';

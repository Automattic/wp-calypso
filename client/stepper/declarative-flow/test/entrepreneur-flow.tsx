...
import { useIsSiteOwner } from 'calypso/stepper/hooks/use-is-site-owner';
...
jest.mock( 'calypso/stepper/hooks/use-is-site-owner' );
...
jest.mock( 'calypso/stepper/hooks/use-entrepreneur-admin-destination', () => ( {

...
import {
	...
	renderFlow,
	runFlowNavigation,
} from 'calypso/stepper/declarative-flow/test/helpers';
...
jest.mock( 'calypso/stepper/utils/checkout' );
jest.mock( '@automattic/data-stores/src/user/selectors' );
jest.mock( 'calypso/state/current-user/selectors' );
jest.mock( 'calypso/stepper/hooks/use-is-site-admin' );
...
jest.mock( 'calypso/stepper/hooks/use-record-signup-complete', () => ( {

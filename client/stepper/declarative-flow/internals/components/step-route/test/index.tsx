...
import recordStepComplete from 'calypso/stepper/declarative-flow/internals/analytics/record-step-complete';
import recordStepStart from 'calypso/stepper/declarative-flow/internals/analytics/record-step-start';
import { useIntent } from 'calypso/stepper/hooks/use-intent';
import { useSelectedDesign } from 'calypso/stepper/hooks/use-selected-design';
...
jest.mock( 'calypso/stepper/declarative-flow/internals/analytics/record-step-start' );
jest.mock( 'calypso/stepper/declarative-flow/internals/analytics/record-step-complete' );
jest.mock( 'calypso/stepper/hooks/use-intent' );
jest.mock( 'calypso/stepper/hooks/use-selected-design' );

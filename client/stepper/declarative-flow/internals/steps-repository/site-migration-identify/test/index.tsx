...
import { useSiteSlug } from 'calypso/stepper/hooks/use-site-slug';
...
jest.mock( 'calypso/stepper/declarative-flow/internals/state-manager/store', () => ( {
	useFlowState: jest.fn( () => ( {
		get: jest.fn().mockReturnValue( { entryPoint: 'goals' } ),
	} ) ),
} ) );
jest.mock( 'calypso/stepper/hooks/use-site-slug' );
jest.mock(

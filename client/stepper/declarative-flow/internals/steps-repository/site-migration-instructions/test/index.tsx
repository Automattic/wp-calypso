...
import { usePrepareSiteForMigration } from 'calypso/stepper/hooks/use-prepare-site-for-migration';
...
jest.mock( 'calypso/stepper/hooks/use-prepare-site-for-migration' );
jest.mock( 'calypso/stepper/hooks/use-site' );
jest.mock( 'calypso/stepper/hooks/use-query' );

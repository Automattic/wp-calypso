 ...
 */
import { getLicenseActions } from '../actions';
...
describe( 'getLicenseActions eligibility', () => {
	...
	it( 'gates a bundle on the revoke capability alone, like classic', () => {
		...
		expect( setup( { canRevoke: false } )( 'revoke-license', referralBundle ) ).toBe( false );
		expect(
			setup()( 'revoke-license', license( { quantity: 5, revoked_at: '2026-01-03 00:00:00' } ) )
		).toBe( false );
	} );

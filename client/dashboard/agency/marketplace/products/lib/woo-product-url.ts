const WOOCOMMERCE_PRODUCT_SLUG_MAP: Record< string, string > = {
...
export function getWooProductUrl( productSlug: string ): string | null {
	const mappedSlug = WOOCOMMERCE_PRODUCT_SLUG_MAP[ productSlug ];
	return mappedSlug ? `https://woocommerce.com/products/${ mappedSlug }/` : null;
}

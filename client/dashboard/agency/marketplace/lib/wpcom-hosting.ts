...
/**
 * Every live license the agency holds, newest first. The owned WordPress.com
 * sites are counted from it, so the routes that show the cart prefetch it.
 */
export const agencyLicensesQuery = ( agencyId: number ) => ( {
...
const isDevSiteLicense = ( license: JetpackLicense ) => license.meta?.a4a_is_dev_site === '1';

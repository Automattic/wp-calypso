		...
		() => [
			...
			},
			{
				...
				elements: [
					...
					{ value: DomainStatus.IN_PROGRESS, label: __( 'Transfer in progress' ) },
					...
					{ value: DomainStatus.PENDING_TRANSFER, label: __( 'Pending transfer' ) },
					{ value: DomainStatus.TRANSFER_COMPLETED, label: __( 'Transfer completed' ) },
					{ value: DomainStatus.TRANSFER_ERROR, label: __( 'Transfer failed' ) },
					{ value: DomainStatus.TRANSFER_PENDING, label: __( 'Transfer pending' ) },

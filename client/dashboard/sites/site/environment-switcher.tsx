...
const EnvironmentSwitcher = ( { site }: { site: Site } ) => {
	...
	//Stagubg site deletion process runs via async job. We need to keep on polling for the staging site deletion before we start displaying the button to add a staging site again

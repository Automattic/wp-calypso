...
export default function SitePerformanceOverview( { siteSlug }: { siteSlug: string } ) {
	...
	return (
						...
						<HStack>
							<PageSelector
								...
								onChange={ ( pageId ) => {
									...
									navigate( {
										to: `/sites/${ siteSlug }/performance/overview`,
		...
		>
			<PerformanceTabs siteSlug={ siteSlug } activeTab="overview" />
			{ isApmEnabled && (
				<Text variant="muted">
					<Subtitle timestamp={ currentReport?.timestamp } onClick={ handleReportRefetch } />
				</Text>

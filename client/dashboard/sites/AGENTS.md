...
- `client/dashboard/sites/domains/index.tsx` — `PrimaryDomainSelectorNotice` vs the redirect warning; the bulk-update progress notice is action feedback rendered beside the arbiter

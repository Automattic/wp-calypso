...
import type { StoredPaymentMethod } from './payment-method-types';
import type { ComponentType } from 'react';

// FIXME: move all this to data, etc.
...
export function useStoredPaymentMethods( {
	...
	const errorMessage = ( () => {
		...
		if ( data !== undefined && ! isDataValid ) {
			return __( 'There was a problem loading your stored payment methods.' );
		}
		return null;
	} )();

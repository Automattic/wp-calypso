		...
		return (
			<Notice variant="info">
				{ createInterpolateElement(
					...
					__(
						"You'll receive a <refundAmount /> refund when you remove your plan. Your features will be unavailable right away."
					),
					{
						refundAmount: (
							<RefundAmountString purchase={ purchase } cancelBundledDomain={ false } />
						),
					}
				) }
			</Notice>

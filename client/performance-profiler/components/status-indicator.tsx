type Props = { speed: 'fast' | 'moderate' | 'slow' | 'unknown' };

const innerSvg = {
	fast: <rect x="1" y="1" width="10" height="10" rx="5" fill="#00BA37" />,
	moderate: (
		<path
	...
	slow: <rect x="1" y="1" width="10" height="10" rx="2" fill="#D63638" />,
	unknown: <rect x="1.5" y="1.5" width="9" height="9" rx="4.5" stroke="#DCDCDE" />,
};
export const StatusIndicator = ( { speed }: Props = { speed: 'unknown' } ) => {
	return (

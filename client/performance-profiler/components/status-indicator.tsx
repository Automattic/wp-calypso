...
const innerSvg = {
	good: <rect x="1" y="1" width="10" height="10" rx="5" fill="var(--studio-green-60)" />,
	needsImprovement: (
		<path
			...
			fill="var(--studio-orange-60)"
		/>
	),
	bad: <rect x="1" y="1" width="10" height="10" rx="2" fill="var(--studio-red-60)" />,

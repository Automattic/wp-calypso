...
export const JETPACK_MANAGE_DASHBOARD_LINK_NEEDS_ATTENTION = '/dashboard?issue_types=all_issues';
export const JETPACK_MANAGE_DASHBOARD_LINK_FAVORITES = '/dashboard/favorites';

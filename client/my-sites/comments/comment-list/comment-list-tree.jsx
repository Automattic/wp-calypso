...
export class CommentListTree extends Component {
	static propTypes = {
	...
	render() {
		...
		return (
			<div className="comment-list__tree comment_list">
...
export default connect( mapStateToProps, mapDispatchToProps )( localize( CommentListTree ) );

...
const Page = React.createClass({
                        ...
                        components: {
                            link: (
                                <a
                                    ...
                                    href={this.props.site.options.admin_url + 'options-reading.php'}
                                />
                            ),
                        },
                    })}
    ...
    getPageStatusInfo: function() {
        ...
        return (
            <div className="page__popover-more-info">
                {getReadableStatus(this.props.page.status)}
            </div>
        );
    },
    ...
    render: function() {
        ...
        const hasSeparatedItems = viewItem ||
            publishItem ||
            editItem ||
            restoreItem ||
            sendToTrashItem ||
        ...
        const setHomepageMenuSeparator = setAsHomepageItem && hasSeparatedItems
            ? <MenuSeparator />
            : null;
        ...
        return (
            <CompactCard className="page">
                ...
                <a
                    ...
                    title={
                        canEdit
                            ? this.translate('Edit %(title)s', {
                                  textOnly: true,
                                  args: { title: page.title },
                              })
                            : this.translate('View %(title)s', {
                                  textOnly: true,
                                  args: { title: page.title },
                              })
                    }
                ...
                {this.props.isPostsPage
                    ? <div className="page__posts-page">{this.translate('Your latest posts')}</div>
                    : null}
                {this.props.multisite
                    ? <span className="page__site-url">{this.getSiteDomain()}</span>
                    : null}
                {ellipsisGridicon}
                {popoverMenu}

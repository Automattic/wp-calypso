...
const controller = {
	...
	pages: function( context ) {
		...
		context.store.dispatch( setTitle( i18n.translate( 'Site Pages', { textOnly: true } ) ) ); // FIXME: Auto-converted from the Flux setTitle action. Please use <DocumentHead> instead.

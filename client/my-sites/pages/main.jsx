 ...
 */
var React = require('react'), debug = require('debug')('calypso:my-sites:pages:pages');
...
module.exports = React.createClass({
    ...
    render: function() {
        ...
        const searchStrings = {
            published: this.translate('Search Published…', {
                context: 'Search placeholder for pages list',
                textOnly: true,
            }),
            drafts: this.translate('Search Drafts…', {
                context: 'Search placeholder for pages list',
                textOnly: true,
            }),
            scheduled: this.translate('Search Scheduled…', {
                context: 'Search placeholder for pages list',
                textOnly: true,
            }),
            trashed: this.translate('Search Trashed…', {
                context: 'Search placeholder for pages list',
                textOnly: true,
            }),
        };
                ...
                <SectionNav selectedText={filterStrings[status]}>
                    <NavTabs
                        label={this.translate('Status', {
                            context: 'Filter page group label for tabs',
                        })}
                    >

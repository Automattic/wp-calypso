...
const RestorePasswordDialog = ({ isVisible, onRestore, onCancel, siteId, translate, restore }) => {
	...
	return (
		<Dialog isVisible={isVisible} buttons={buttons} onClose={onCancel}>
			...
			<p>{translate('Are you sure you want to restore the default password of your database?')}</p>
		</Dialog>
	);
};

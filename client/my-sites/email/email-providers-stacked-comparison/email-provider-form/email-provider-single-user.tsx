...
import ProviderFormDomainsSelect from './domains-select';
...
export enum EmailProviderFormField {
	FIRST_NAME,
	LAST_NAME,
	PASSWORD,
	EMAIL,
...
const EmailProviderSingleUser: FunctionComponent< Props > = ( {
	autoFocus,
	domains,
	hiddenFields = [],
	onUserRemove,
	...
	return (
		<div className={ classNames( 'gsuite-new-user-list__new-user' ) }>
			<FormFieldset>
				{ ! hiddenFields.some( ( field ) => field === EmailProviderFormField.FIRST_NAME ) && (
					<div className="email-provider-single-user__new-user-name-container">
				...
				{ ! hiddenFields.some( ( field ) => field === EmailProviderFormField.LAST_NAME ) && (
					<div className="email-provider-single-user__new-user-name-container">
			...
			<FormFieldset>
				{ ! hiddenFields.some( ( field ) => field === EmailProviderFormField.EMAIL ) && (
					<div className="email-provider-single-user__new-user-email-container">
						<div className="email-provider-single-user__new-user-email">
				...
				{ ! hiddenFields.some( ( field ) => field === EmailProviderFormField.PASSWORD ) && (
					<div className="email-provider-single-user__new-user-password-container">
				...
				{ showTrashButton && (
					<Button
						className="email-provider-single-user__new-user-remove-user-button"
...
export default EmailProviderSingleUser;

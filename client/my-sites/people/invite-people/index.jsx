...
const InvitePeople = React.createClass({
    ...
    refreshValidation() {
        const errors = InvitesCreateValidationStore.getErrors(
            this.props.site.ID,
            this.state.role
        ) || {},
            success = InvitesCreateValidationStore.getSuccess(
                this.props.site.ID,
                this.state.role
            ) || [],
    ...
    submitForm(event) {
        ...
        this.props.sendInvites(this.props.site.ID, usernamesOrEmails, role, message, formId);
        ...
        analytics.tracks.recordEvent('calypso_invite_people_form_submit', {
            ...
            number_username_invitees: groupedInvitees.username
                ? groupedInvitees.username.length
                : 0,
                    ...
                    <EmailVerificationGate>
                        <form onSubmit={this.submitForm}>
                            ...
                            <FormButton
                                ...
                                onClick={this.onClickSendInvites}
                            >
                                {this.translate('Send Invitation', 'Send Invitations', {
...
export default connect(null, dispatch => bindActionCreators({ sendInvites }, dispatch))(
    InvitePeople
);

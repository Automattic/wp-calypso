...
const Post = React.createClass({
    ...
    getExcerpt() {
        ...
        if (this.props.post.format === 'quote') {
            excerptElement = (
                <PostExcerpt content={this.getTrimmedExcerpt()} className="post__quote" />
            );
        } else {
        ...
        return (
            <Card tagName="article" className={this.getPostClass()}>
                <div className="post__body">
                    ...
                    {this.getContent()}
                    <PostActions
                        {...{ site, post: this.props.post, toggleComments: this.toggleComments }}
                    />
                </div>
                <PostControls
                ...
                {this.state.showShare &&
                    ...
                    <PostShare post={this.props.post} site={site} />}
            </Card>
        );
    },
});

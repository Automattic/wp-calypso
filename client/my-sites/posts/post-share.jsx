        ...
        return this.props.connections.map(
            connection => (
                ...
                >
                    ...
                    <SocialLogo
                        icon={
                            connection.service === 'google_plus'
                                ? 'google-plus'
                                : connection.service
                        }
                    />
                ...
                <div className="posts__post-share-wrapper">
                    <Banner
                        ...
                        title={this.translate(
                            'Unlock the ability to re-share posts to social media'
                        )}
            ...
            <div className="posts__post-share-wrapper">
                {this.props.requesting &&
                    <Notice status="is-warning" showDismiss={false}>
                        {this.translate('Sharing…')}
                    </Notice>}
                {this.props.success &&
                    <Notice status="is-success" onDismissClick={this.dismiss}>
                        {this.translate(`Post shared. Please check your social media accounts.`)}
                    </Notice>}
                {this.props.failure &&
                    <Notice status="is-error" onDismissClick={this.dismiss}>
                        {this.translate(`Something went wrong. Please don't be mad.`)}
                    </Notice>}
                <div className={classes}>
                    ...
                    <div className="posts__post-share-head">
                        ...
                        <div className="posts__post-share-subtitle">
                            {this.translate(
                                'Share your post on all of your connected social media accounts using {{a}}Publicize{{/a}}.',
                                {
                                    components: {
                                ...
                                {this.props.connections
                                    ...
                                    .map(connection => (
                                        <Notice
                                            ...
                                            showDismiss={false}
                                            text={this.translate(
                                                'There is an issue connecting to %s.',
                            ...
                            <div className="posts__post-share-main">
                                ...
                                <div className="posts__post-share-services">
                                    ...
                                    <Button
                                        ...
                                        compact={true}
                                        className="posts__post-share-services-add"
                                    >
                    ...
                    {this.props.hasFetchedConnections &&
                        ...
                        <Notice
                            status="is-warning"
                            showDismiss={false}
                            text={this.translate('Connect an account to get started.')}
                        >
                            <NoticeAction href={'/sharing/' + this.props.siteSlug}>

	...
	render: function() {
		...
		return (
			<div className="posts__post-share-wrapper">
				{ this.props.requesting && <Notice status="is-warning" showDismiss={ false }>{ this.translate( 'Scheduling your posts...' ) }</Notice> }
				{ this.props.success && <Notice status="is-success" onDismissClick={ this.dismiss }>{ this.translate( 'Your posts are being published. Please check your social accounts. ' ) }</Notice> }

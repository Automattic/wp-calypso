...
class SharingButtonsAppearance extends Component {
    ...
    isLikeButtonEnabled() {
        return '' === this.props.values.disabled_likes ||
            false === this.props.values.disabled_likes;
    }

    isReblogButtonEnabled() {
        return '' === this.props.values.disabled_reblogs ||
            false === this.props.values.disabled_reblogs;
    }
            ...
            return (
                <fieldset className="sharing-buttons__fieldset">
                    <legend className="sharing-buttons__fieldset-heading">
                        {this.props.translate('Reblog & Like', {

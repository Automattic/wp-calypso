...
module.exports = React.createClass({
            ...
            function(context) {
                ...
                return (
                    <span
                        key={context}
                        className={
                            'sharing-buttons-preview__panel-instruction-text is-' +
                                context +
                                '-context'
                        }
                    >
    ...
    onButtonsReordered: function(order) {
        ...
        this.getButtonsOfCurrentVisibility().forEach(
            function(button, i) {
    ...
    getButtonElements: function() {
        if (this.state.isReordering) {
            var buttons = this.getButtonsOfCurrentVisibility().map(
                function(button) {
                    return (

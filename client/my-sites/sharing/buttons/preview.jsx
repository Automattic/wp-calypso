 ...
 */
var React = require('react'), some = require('lodash/some'), filter = require('lodash/filter');
    ...
    getButtonsTrayToggleButtonLabel: function(visibility, enabledButtonsExist) {
        if ('visible' === visibility) {
            if (enabledButtonsExist) {
                return this.translate('Edit sharing buttons', {
                    context: 'Sharing: Buttons edit label',
                });
            } else {
                return this.translate('Add sharing buttons', {
                    context: 'Sharing: Buttons edit label',
                });
            }

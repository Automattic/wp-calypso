...
class SharingConnection extends Component {
    ...
    getProfileImage() {
        ...
        return (
            <span
                className={
                    'sharing-connection__account-avatar is-fallback ' +
                        this.props.connection.service
                }
            >
    ...
    getDisconnectButton() {
        const userCanDelete = this.props.userHasCaps ||
        ...
        if (this.props.showDisconnect && userCanDelete) {
            return (
                <a
                    ...
                    className="sharing-connection__account-action disconnect"
                >
    ...
    getConnectionSitewideElement() {
        ...
        if (content.length) {
            return (
                <label className="sharing-connection__account-sitewide-connection">{content}</label>
            );
        }
    }

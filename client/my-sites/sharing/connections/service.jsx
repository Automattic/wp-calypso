        ...
        if (service) {
            if (keyringConnectionId) {
                ...
                if (this.props.siteId && existingConnection) {
                    ...
                    this.props.updateSiteConnection(existingConnection, {
                        external_user_ID: externalUserId,
                    });
                } else {
                    this.props.createSiteConnection(
                        this.props.siteId,
                        keyringConnectionId,
                        externalUserId
                    );
            ...
            this.props.warningNotice(
                this.props.translate(
                    'The connection could not be made because no account was selected.',
                    {
                        ...
                        >
                            {this.props.siteUserConnections.map(connection => (
                                <Connection
                                    ...
                                    service={this.props.service}
                                    showDisconnect={
                                        this.props.siteUserConnections.length > 1 ||

...
export const DeleteSite = React.createClass({
    ...
    renderNotice: function() {
        ...
        return (
            <Notice status="is-warning" showDismiss={false}>
                {this.translate(
                    '{{strong}}%(domain)s{{/strong}} will be unavailable in the future.',
                    {
                        components: {
                            strong: <strong />,
                        },
    ...
    render: function() {
        const site = this.state.site,
            ...
            deleteDisabled = typeof this.state.confirmDomain !== 'string' ||
            ...
            <div className="main main-column" role="main">
                ...
                <ActionPanel>
                    ...
                    <ActionPanelBody>
                        ...
                        <ActionPanelFigure>
                            ...
                            <ul className="delete-site__content-list">
                                <li className="delete-site__content-list-item">
                                    {this.translate('Posts')}
                                </li>
                                <li className="delete-site__content-list-item">
                                    {this.translate('Pages')}
                                </li>
                                <li className="delete-site__content-list-item">
                                    {this.translate('Media')}
                                </li>
                                <li className="delete-site__content-list-item">
                        ...
                        <p>
                            <a
                                className="settings-action-panel__body-text-link"
                                href="/help/contact"
                            >
                    ...
                    <ActionPanelFooter>
                        <Button
                            scary
                            disabled={
                                !this.state.site || !this.props.hasLoadedSitePurchasesFromServer
                            }

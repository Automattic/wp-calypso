...
module.exports = protectForm(
    React.createClass({
        ...
        getModuleStatus: function(site) {
            ...
            site.verifyModulesActive(
                ['monitor'],
                function(error, moduleStatus) {
                    if (!error) {
        ...
        prompt: function() {
            return (
                <div className="site-settings__jetpack-prompt">
                    <img
                        src="/calypso/images/jetpack/illustration-jetpack-monitor.svg"
                        width="128"
                        height="128"
                    />
                    ...
                    <div className="site-settings__jetpack-prompt-text">
                        <p>
                            {this.translate(
                                "Automatically monitor your website and make sure it's online."
                            )}
                        </p>
                        <p>
                            {this.translate(
        ...
        saveSettings: function() {
            ...
            this.props.site.updateMonitorSettings(
                this.state.emailNotifications,
                this.state.wpNoteNotifications,
                function(error) {
                    if (error) {
                        this.handleError();
                        notices.error(
        ...
        settingsMonitorEmailCheckbox: function() {
            return (
                <FormLabel>
                    ...
                    <span>
                        {this.translate(
                            'Send notifications to your {{a}}WordPress.com email address{{/a}}.',
                            {
                                components: {
                                    a: (
                                        <a
                                            href="/me/account"
                                            onClick={this.recordEvent.bind(
                                                this,
        ...
        disableForm: function() {
            return this.state.fetchingSettings ||
                this.state.submittingForm ||
                this.props.site.fetchingModules ||
                this.state.togglingModule;
        },
        ...
        deactivateFormButtons: function() {
            return (
                <div>
                    ...
                    >
                        {this.state.togglingModule
                            ? this.translate('Deactivating…')
                            : this.translate('Deactivate')}
                    </Button>
                    <Button compact primary onClick={this.saveSettings}>
                        {this.state.submittingForm
            ...
            return (
                <div>
                    ...
                    <Card className="jetpack-monitor-settings">
                        {this.state.enabled ? this.settings() : this.prompt()}
                    </Card>
                </div>
            );
        },

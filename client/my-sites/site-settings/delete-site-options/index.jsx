...
module.exports = React.createClass({
    ...
    render() {
        ...
        let changeAddressLinkText = this.translate(
            ...
            <div className="delete-site-options">
                ...
                >
                    <div className="delete-site-options__content">
                        <h2 className="delete-site-options__section-title">
                ...
                >
                    <div className="delete-site-options__content">
                        ...
                        <p className="delete-site-options__section-desc">
                            {this.translate(
                                'Keep your URL and site active, but remove the content.'
                            )}
                        </p>
                    </div>
                </CompactCard>
                            ...
                            {this.translate(
                                    ...
                                    'And this site’s address ({{siteAddress /}}) will be lost.',
                                {
                                    components: {
                                        siteAddress: (
                                            <strong>
                                                {selectedSite.wpcom_url || selectedSite.slug}
                                            </strong>
                                        ),
                                    },
                                }

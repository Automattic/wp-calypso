			...
			<p>
				{ translate(
					"This site's visibility is currently set to {{strong}}Private{{/strong}}.",
					{
						...
						comment: 'The translations for "Private", "Public", and "Hidden" should match the strings on the Settings > General page.',
					}
				) }
			</p>
			<p>
				{ translate(
					...
					{
						components: { strong: <strong /> },
						comment: 'The translations for "Public" and "Hidden" should match the strings on the Settings > General page.',
					}
				) }
			</p>
			<p>

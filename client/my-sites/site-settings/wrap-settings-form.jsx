	...
	const connectComponent = connect(
		(state, { fields }) => {
			...
			if (isJetpack) {
				...
				const fieldsToUpdate = /^error_/.test(fields.lang_id) ? omit(fields, 'lang_id') : fields;
				...
				isRequestingSettings =
					isRequestingSettings || (isRequestingJetpackSettings(state, siteId) && !jetpackSettings);
			}

...
const wrapSettingsForm = getFormSettings =>
    SettingsForm => {
        ...
        const connectComponent = connect(
            state => {
                ...
                const jetpackSettingsUISupported = isJetpack &&
                    siteSupportsJetpackSettingsUi(state, siteId);
                if (jetpackSettingsUISupported) {
                    ...
                    isSaveRequestSuccessful = isSaveRequestSuccessful &&
                        !isJetpackSettingsSaveFailure(state, siteId);

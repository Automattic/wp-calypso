...
class Protect extends Component {
    ...
    isIpAddressWhitelisted() {
        ...
        return includes(whitelist, ipAddress) ||
    ...
    render() {
        ...
        const disabled = isRequestingSettings ||
            isSavingSettings ||
            protectModuleUnavailable ||
            !protectModuleActive;
        const protectToggle = (
            ...
            >
                ...
                <FormFieldset>
                    <div className="protect__module-settings site-settings__child-settings">
                        <div
                            className="protect__info-link-container site-settings__info-link-container"
                        >
                        ...
                        <p>
                            {translate(
                                'Your current IP address: {{strong}}%(IP)s{{/strong}}{{br/}}',
                                {
                                    args: {

...
class SquarespaceService extends Component {
	getDescription = () =>
	...
	render() {
		...
		return (
			<div className="site-importer__site-importer-pane">
				<SocialLogo className="importer__service-icon" icon="squarespace" size={ 48 } />
				<h4>Squarespace</h4>
				<p>It Looks like your site is at squarespace site...</p>

...
class BloggerService extends Component {
	getDescription = () =>
	...
	render() {
		...
		return (
			<div className="site-importer__site-importer-pane">
				<SocialLogo className="importer__service-icon" icon="blogger" size={ 48 } />
				<h4>Blogger</h4>
				<p>It Looks like your site is at blogger.com site...</p>

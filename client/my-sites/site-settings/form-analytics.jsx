...
class GoogleAnalyticsForm extends Component {
    ...
    handleCodeChange = event => {
        ...
        if (!isCodeValid) {
            this.props.errorNotice(this.props.translate('Invalid Google Analytics Tracking ID.'), {
                        ...
                        {translate(
                            'Learn more about using {{a}}Google Analytics with WordPress.com{{/a}}.',
                            {
                                components: {
                                    a: (
                                        <a
                                            href="http://en.support.wordpress.com/google-analytics/"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                        />
                                    ),
...
const connectComponent = connect(mapStateToProps, { errorNotice, removeNotice }, null, {
    pure: false,
});

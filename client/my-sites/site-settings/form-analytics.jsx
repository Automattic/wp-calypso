...
const hasPlanWithAnalytics = overSome(isPremium, isBusiness, isEcommerce, isEnterprise, isVipPlan);
...
export class GoogleAnalyticsForm extends Component {
	...
	isSubmitButtonDisabled() {
		...
		return (
			isRequestingSettings || isSavingSettings || !this.state.isCodeValid || !this.props.enableForm
		);
	}
				...
				{showUpgradeNudge && site && site.plan ? (
					...
					<Card className="analytics-settings site-settings__analytics-settings">
						{siteIsJetpack && (
							<fieldset>
								...
								<JetpackModuleToggle
									...
									label={translate('Track your WordPress site statistics with Google Analytics.')}
						...
						{siteIsJetpack && wooCommerceActive && (
							<FormAnalyticsStores fields={fields} handleToggleChange={this.handleToggleChange} />
						)}
						<p>
							{translate(
...
export default flowRight(connectComponent, wrapSettingsForm(getFormSettings))(GoogleAnalyticsForm);

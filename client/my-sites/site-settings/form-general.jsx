                    ...
                    {translate(
                            ...
                            'or {{redirectLink}}redirect{{/redirectLink}} this site.',
                        {
                            components: {
                                ...
                                mapDomainLink: (
                                    <a
                                        href={'/domains/add/mapping/' + site.slug}
                                        onClick={this.trackUpgradeClick}
                                    />
                                ),
                                redirectLink: (
                                    <a
                                        href={'/domains/add/site-redirect/' + site.slug}
                                        onClick={this.trackUpgradeClick}
                                    />
                                ),
                            },
            ...
            <FormFieldset>
                ...
                <FormSettingExplanation>
                    ...
                    <a href={config.isEnabled('me/account') ? '/me/account' : '/settings/account/'}>
                        {translate(
                            "You can also modify your interface's language in your profile."
                        )}
                    </a>
                </FormSettingExplanation>
            </FormFieldset>
        ...
        return (
            ...
            >
                ...
                <div className="site-settings__date-time-format-info">
                    {dateFormat && localizedDate.format(phpToMomentDatetimeFormat(dateFormat))}
                    {' '}
                    •
                    {' '}
                    {timeFormat && localizedDate.format(phpToMomentDatetimeFormat(timeFormat))}
                    {' '}
                    •
                    {' '}
                        ...
                        <CompactCard className="site-settings__footer-credit-explanation">
                            ...
                            <div>
                                <Button
                                    ...
                                    href={'/customize/identity/' + site.slug}
                                >

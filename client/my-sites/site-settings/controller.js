...
module.exports = {
    ...
    siteSettings(context) {
        ...
        renderPage(context, <SiteSettingsComponent {...{ sites, section, upgradeToBusiness }} />);
    ...
    importSite(context) {
        renderPage(context, <SiteSettingsComponent sites={sites} section="import" />);
    },

    exportSite(context) {
        renderPage(context, <SiteSettingsComponent sites={sites} section="export" />);
    },
    ...
    taxonomies(context) {
        renderPage(context, <Taxonomies taxonomy={context.params.taxonomy} postType="post" />);
    },
    ...
    dateTimeFormat(context) {
        renderPage(context, <DateTimeFormat />);
    },

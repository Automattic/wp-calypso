...
export const MediaLibraryList = React.createClass({
    ...
    getMediaItemHeight: function() {
        return Math.round(this.props.containerWidth * this.props.mediaScale) +
            this.props.rowPadding;
    },
    ...
    renderItem: function(item) {
        ...
        showGalleryHelp = !this.props.single &&
            selectedIndex !== -1 &&
    ...
    renderLoadingPlaceholders: function() {
        ...
        return Array.apply(null, new Array(placeholders)).map(
            function(value, i) {
                return (
                    <ListItem
                        key={'placeholder-' + i}

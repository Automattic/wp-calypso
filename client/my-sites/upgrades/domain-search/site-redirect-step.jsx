            ...
            <div className="site-redirect-step">
                <form className="site-redirect-step__form card" onSubmit={this.handleFormSubmit}>
                    ...
                    <div className="site-redirect-step__domain-description">
                        <p>
                            {this.translate(
                                'Redirect {{strong}}%(domain)s{{/strong}} to this domain',
                                {
        ...
        switch (error.code) {
            case 'invalid_domain':
                return this.translate(
                    'Sorry, %(domain)s does not appear to be a valid domain name.',
                    {
                        args: { domain: domain },
                    }
                );
            ...
            case 'invalid_tld':
                return this.translate(
                    'Sorry, %(domain)s does not end with a valid domain extension.',
                    {
                        args: { domain: domain },
                    }
                );

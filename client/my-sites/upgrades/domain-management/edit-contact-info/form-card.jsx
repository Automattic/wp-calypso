...
class EditContactInfoFormCard extends React.Component {
    ...
    hasEmailChanged() {
        return this.props.contactInformation.email !==
    ...
    render() {
        const { translate } = this.props,
            ...
            canUseDesignatedAgent = includes(
                [OPENHRS, OPENSRS],
                this.props.selectedDomain.registrar
            );
    ...
    getField(Component, props) {
        ...
        return (
            <Component
                ...
                disabled={
                    this.state.formSubmitting || formState.isFieldDisabled(this.state.form, name)
                }

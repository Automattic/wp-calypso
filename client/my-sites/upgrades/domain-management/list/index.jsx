...
export const List = React.createClass({
    ...
    undoSetPrimaryDomain() {
        ...
        const previousDomainIndex = findIndex(this.props.domains.list, {
        ...
        return domains.map((domain, index) => {
            return (
                <ListItem
                    ...
                    busy={
                        this.state.settingPrimaryDomain && index === this.state.primaryDomainIndex
                    }
                    busyMessage={this.translate('Setting Primary Domain…', {
                        context: 'Shows up when the primary' +

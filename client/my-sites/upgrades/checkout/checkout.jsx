...
const Checkout = React.createClass({
    ...
    componentWillReceiveProps: function(nextProps) {
        ...
        if (
            this.props.cart.hasPendingServerUpdates !== false &&
            nextProps.cart.hasPendingServerUpdates === false
        ) {
    ...
    handleCheckoutCompleteRedirect: function() {
                    ...
                    this.translate(
                            ...
                            '{{a}}Learn more{{/a}}',
                        {
                            ...
                            components: {
                                a: (
                                    <a
                                        href={supportPaths.AUTO_RENEWAL}
                                        target="_blank"
                ...
                notices.success(
                    this.translate(
                            ...
                            'We sent your receipt to %(email)s.',
                        {
                            args: {
                                productName: renewalItem.product_name,
                                duration: i18n.moment
                                    .duration(renewalItem.bill_period, 'days')
                                    .humanize(),
        ...
        if (receipt && receipt.receipt_id) {
            ...
            this.props.fetchReceiptCompleted(receiptId, {
                ...
                failedPurchases: this.flattenPurchases(
                    this.props.transaction.step.data.failed_purchases
                ),
            });
        }

        if (cart.create_new_blog && receipt && isEmpty(receipt.failed_purchases)) {
            notices.info(this.translate('Almost done…'));

...
export default React.createClass({
    ...
    needsOnlyGoogleAppsDetails() {
        return cartItems.hasGoogleApps(this.props.cart) &&
    ...
    needsFax() {
        return formState.getFieldValue(this.state.form, 'countryCode') === 'NL' &&
            cartItems.hasNlTld(this.props.cart);
    },
    ...
    renderEmailField() {
        return <Input label={this.translate('Email')} {...this.getFieldProps('email')} />;
    },
    ...
    renderFaxField() {
        return <Input label={this.translate('Fax')} {...this.getFieldProps('fax')} />;
    },
    ...
    renderCityField() {
        return <Input label={this.translate('City')} {...this.getFieldProps('city')} />;
    },

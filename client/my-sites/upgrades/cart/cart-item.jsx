...
const CartItem = React.createClass({
    ...
    getProductInfo() {
        var domain = this.props.cartItem.meta ||
            (this.props.selectedSite && this.props.selectedSite.domain),
            info = null;
    ...
    getProductName: function() {
        ...
        if (!cartItem.volume) {
            ...
            switch (cartItem.product_slug) {
                case 'gapps':
                    return this.translate('%(productName)s (1 User)', {
                        args: {
                            productName: cartItem.product_name,
                        },
                    });
    ...
    removeButton: function() {
        if (canRemoveFromCart(this.props.cart, this.props.cartItem)) {
            return (
                <button
                    className="remove-item noticon noticon-close"

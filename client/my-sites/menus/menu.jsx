 ...
 */
var React = require('react'), debug = require('debug')('calypso:menus:menu'); // eslint-disable-line no-unused-vars
...
var Menu = React.createClass({
    ...
    dragOver: function(x, y, item) {
        var menuData = this.props.siteMenus, moveOp;
    ...
    getMoveOperation: function(x, y, item) {
        var menuData = this.props.siteMenus, parent = menuData.getParent(item.id), previousSibling;
    ...
    doAddItem: function(action, id) {
        var oldState = this.state.addState, newState = {};
    ...
    doMoveItem: function(action, data) {
        var oldState = this.state.moveState, newState = {};
        ...
        if ('setSource' === action) {
            ...
            this.props.siteMenus.moveItem(oldState.sourceId, oldState.targetId, data);
        }

 ...
 */
var React = require('react'), debug = require('debug')('calypso:menus:delete-button'); // eslint-disable-line no-unused-vars
...
var MenuDeleteButton = React.createClass({
    ...
    render: function() {
        ...
        return this.props.selectedMenu.id !== 0

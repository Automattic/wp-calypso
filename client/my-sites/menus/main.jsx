 ...
 */
var React = require('react'), debug = require('debug')('calypso:menus:index'); // eslint-disable-line no-unused-vars
...
var Menus = React.createClass({
    ...
    renderJetpackManageDisabledMessage: function(site) {
        ...
        if (data.menus && data.locations && data.hasDefaultMenu && !this.props.isRequesting) {
...
export default flowRight(connectComponent, protectForm)(Menus);

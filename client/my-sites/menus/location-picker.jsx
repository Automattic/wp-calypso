 ...
 */
var React = require('react'), debug = require('debug')('calypso:menus:location-picker'); // eslint-disable-line no-unused-vars
...
var LocationPicker = React.createClass({
    ...
    render: function() {
        ...
        locations = this.props.locations.map(function(location) {
            return (
                <option key={location.name} value={location.name}>{location.description}</option>
            );
        });

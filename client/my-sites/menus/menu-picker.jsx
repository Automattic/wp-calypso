 ...
 */
var React = require('react'), debug = require('debug')('calypso:menus:menu-picker'); // eslint-disable-line no-unused-vars
...
var MenuPicker = React.createClass({
    ...
    renderEmptyOption: function() {
        if (
            (!this.props.menuData.hasDefaultMenu() && this.props.isPrimaryLocation) ||
            !this.props.isPrimaryLocation
        ) {
            return (
                <option key="default" value="">
                    {this.props.isPrimaryLocation
                        ? this.translate('Default Menu', { textOnly: true })
    ...
    render: function() {
        var menus, title, defaultMenuId = this.props.menuData.getDefaultMenuId();

        menus = this.props.menus.map(
            function(menu) {
        ...
        return (
            <div className="menus__picker is-menu">
                ...
                >
                    ...
                    <option key="add-menu" value="add-menu">
                        + {this.translate('Add new menu', { textOnly: true })}
                    </option>
                </select>
            </div>
        );

...
var MenuItem = React.createClass({
    ...
    isAddItemTarget: function() {
        return this.props.addState.targetId === this.props.item.id && !this.props.addState.position;
    },
    ...
    isCorrupt: function() {
        return this.props.item.type === '' || this.props.item.type_family === '';
    },
    ...
    renderDropButton: function() {
        if (this.props.moveState.moving && this.props.moveState.sourceId !== this.props.item.id) {
            return (
                <span onClick={this.selectMoveItem} className="menu-item-action move">
                    {this.translate('Move here')}
                </span>
            );
        }
    },
    ...
    renderCancelButton: function() {
        if (this.isMoveItemSource() || this.isAddItemTarget()) {
            return (
                <button onClick={this.onClickCancelButton} className="button">
    ...
    renderEditButton: function() {
        if (this.canEdit()) {
            return (
                <span onClick={this.onEditButtonClick} className="menu-item-action edit">
                    {this.translate('Edit')}
                </span>
            );
        }
    ...
    renderAddButton: function() {
        if (this.canEdit()) {
            return (
                <span onClick={this.onAddButtonClick} className="menu-item-action add">
                    {this.translate('Add')}
                </span>
            );
        }
    ...
    renderDeletedItem: function() {
        return (
            <a className={'menus__menu-item is-deleted depth-' + this.props.depth}>
                {this.renderLabel()}
                <div className="action-tray">
                    <button onClick={this.cancelDelete} className="button">
                        {this.translate('Back')}
                    </button>
                    <button onClick={this.confirmDelete} className="button is-primary">
                        {this.translate('Delete Item')}
                    </button>
                </div>
            </a>
        );
...
var EmptyMenu = React.createClass({
    renderLabel: function() {
        ...
        return <span className={'menu-item-name'} />;
    },

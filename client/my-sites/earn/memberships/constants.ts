...
export const COUPON_DURATION_FOREVER = null;
export const COUPON_DURATION_1_MONTH = '1';
export const COUPON_DURATION_3_MONTHS = '3';
export const COUPON_DURATION_6_MONTHS = '6';
export const COUPON_DURATION_1_YEAR = '12';
...
export const COUPON_USAGE_LIMIT_INFINITE = '∞';
export const COUPON_EMAIL_ALLOW_LIST_ALLOW_ALL = '*';

...
const AdsFormSettings = React.createClass({
    ...
    handleRadio: function(event) {
        var name = event.currentTarget.name, value = event.currentTarget.value, updateObj = {};
                ...
                <FormLabel>
                    ...
                    <span>
                        ...
                        <a
                            ...
                            href="https://wordads.co/optimized-ads/"
                        >
...
export default compose(connect(null, { dismissWordAdsSuccess }), localize, protectForm)(
    AdsFormSettings
);

            ...
            <div>
                ...
                <Card className="rads__activate-wrapper">
                    <div className="rads__activate-header">
                        <h2 className="rads__activate-header-title">
                            {this.translate('WordAds Disabled')}
                        </h2>
                    ...
                    {this.props.wordAdsError &&
                        <Notice
                            status="is-error rads__activate-notice"
                            onDismissClick={this.dismissWordAdsError}
                        >
                            {this.props.wordAdsError}
                        </Notice>}
                    {this.props.isUnsafe === 'mature' &&
                        <Notice
                            ...
                            showDismiss={false}
                            text={this.translate(
                                'Your site has been identified as serving mature content. Our advertisers would like to include only family-friendly sites in the program.'
                            )}
                        >
                            <NoticeAction
                    ...
                    {this.props.isUnsafe === 'spam' &&
                        <Notice
                            ...
                            showDismiss={false}
                            text={this.translate(
                                'Your site has been identified as serving automatically created or copied content. We cannot serve WordAds on these kind of sites.'
                            )}
                        />}
                    ...
                    {this.props.isUnsafe === 'other' &&
                        <Notice
                            ...
                            showDismiss={false}
                            text={this.translate(
                                'Your site cannot participate in WordAds program.'
                            )}
                        />}
        ...
        if (this.props.requestingWordAdsApproval || this.props.wordAdsSuccess) {
            notice = (
                <Notice status="is-success" showDismiss={false}>
                    {this.translate(
                        'You have joined the WordAds program. Please review these settings:'
                    )}
                </Notice>
            );
        } else if (
            ...
            dispatchProps,
            {
                requestWordAdsApproval: () =>
                    !stateProps.requestingWordAdsApproval
                        ? dispatchProps.requestWordAdsApproval(parentProps.site.ID)
                        : null,
            },
            parentProps,
            stateProps

...
describe( 'PluginAction', function() {
	...
	describe( 'rendering children', function() {
		it( 'should not render a form toggle when children exist', function() {
			...
			expect( wrapper.find( '.form-toggle' ) ).to.have.length( 0 );
		} );

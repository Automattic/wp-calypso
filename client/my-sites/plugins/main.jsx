...
const PluginsMain = React.createClass({
    ...
    addWporgDataToPlugins(plugins) {
        return plugins.map(plugin => {
            const pluginData = WporgPluginsSelectors.getPlugin(
                this.props.wporgPlugins,
                plugin.slug
            );
            if (!pluginData) {
    ...
    getEmptyContentUpdateData() {
        ...
        if (selectedSite) {
            ...
            emptyContentData.title = this.translate('All plugins are up to date.', {
                textOnly: true,
            });
        }
        ...
        if (selectedSite) {
            ...
            emptyContentData.title = this.translate('No updates are available.', {
                textOnly: true,
            });
    ...
    getEmptyContentData() {
        ...
        switch (this.props.filter) {
            case 'active':
                emptyContentData.title = this.translate('No plugins are active.', {
                    textOnly: true,
                });
                break;
            case 'inactive':
                emptyContentData.title = this.translate('No plugins are inactive.', {
                    textOnly: true,
                });
                break;
            case 'updates':
...
export default connect(
    state => {
        ...
        return {
            ...
            canSelectedJetpackSiteManage: selectedSite &&
                canJetpackSiteManage(state, selectedSite.ID),

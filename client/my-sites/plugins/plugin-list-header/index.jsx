...
export default React.createClass({
    ...
    renderCurrentActionButtons() {
        const isJetpackSelected = this.props.selected.some(plugin => 'jetpack' === plugin.slug),
            needsRemoveButton = this.props.selected.length &&
                this.canUpdatePlugins() &&
                !isJetpackSelected,
            buttons = [],
            rightSideButtons = [],
            leftSideButtons = [],
        ...
        if (!this.props.isBulkManagementActive) {
            ...
            const browserUrl = '/plugins/browse' +
            ...
            rightSideButtons.push(
                <ButtonGroup key="plugin-list-header__buttons-browser">
                    <Button
                        ...
                        ref="addPluginButton"
                        aria-label={this.translate('Browse all plugins', {
                            context: 'button label',
                        })}
                    >
        ...
        return (
            ...
            >
                ...
                {isJetpackSelected
                    ...
                    : <DropdownItem
                          key="plugin__actions_deactivate"
                          disabled={!this.props.haveActiveSelected}
                          onClick={this.props.deactivateSelected}
                      >
                          {this.translate('Deactivate')}
    ...
    render() {
        const sectionClasses = classNames('plugin-list-header', {
            'is-bulk-editing': this.props.isBulkManagementActive,

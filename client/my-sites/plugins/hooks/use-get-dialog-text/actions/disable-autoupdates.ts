...
const headings: ActionHeadings = {
	...
	manyPlugins: ( translate ) => translate( 'Disable auto-updates for plugins' ),
};
...
const messages: ActionMessages = {
	...
	onePluginManySites: ( plugin, sites ) => ( translate ) =>
		translate(
			'You are about to disable auto-updates for the %(plugin)s plugin installed on %(siteCount)d site.',
	...
	manyPluginsOneSite:
		...
		( translate ) =>
			translate(
				'You are about to disable auto-updates for %(pluginCount)d plugin installed on %(site)s.',
	...
	manyPluginsManySites: ( plugins, sites ) => ( translate ) => {
		const pluginsPart = translate(
			'You are about to disable auto-updates for %(pluginCount)d plugin.',

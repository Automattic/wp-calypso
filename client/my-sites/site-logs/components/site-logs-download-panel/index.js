import { Button, FormInputValidation, ProgressBar } from '@automattic/components';
...
export const SiteLogsPanel = ( props ) => {
	const {
	...
	const getContent = () => {
		return (
			<>
				<p className="site-logs-download-panel__info">
					{ translate(
						'Download web server logs to troubleshoot or debug problems with your site.'
					) }
				</p>
				<div className="site-logs-download-panel__type">
					<FormFieldset>
				...
				<div className="site-logs-download-panel__dates">
					<div className="site-logs-download-panel__dates">
						<DateRange
							translate={ translate }
							moment={ moment }
				...
				<div className="site-logs-download-panel__download">
	...
	return (
		<div className="site-logs-download-panel">
			<MaterialIcon icon="settings" size={ 32 } />
			<CardHeading> { translate( 'Site logs' ) }</CardHeading>
			<Button className="site-logs-download-panel__close" transparent borderless>

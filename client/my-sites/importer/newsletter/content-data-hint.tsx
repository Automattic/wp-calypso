...
import { normalizeFromSite } from 'calypso/my-sites/importer/newsletter/utils';

interface ContentDataHintProps {
	selectedSiteUrl: string;
	fromSite: string;
}

export const ContentDataHint = function ( { fromSite, selectedSiteUrl }: ContentDataHintProps ) {
	const { __ } = useI18n();

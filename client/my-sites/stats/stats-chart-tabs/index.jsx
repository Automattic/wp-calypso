...
class StatModuleChartTabs extends Component {
        ...
        switch (this.props.chartTab) {
            ...
            default:
                ...
                tooltipData.push({
                    ...
                    value: this.props.numberFormat(item.data.views / item.data.visitors, {
                        decimals: 2,
                    }),
    ...
    render() {
        ...
        let availableCharts = [];
        const data = this.getLoadedData();
        const activeTabLoading = quickQueryRequesting &&
            fullQueryRequesting &&
            !(data && data.length);
        const classes = [
            'stats-module',
...
const connectComponent = connect(
    (state, { moment, period: periodObject, chartTab, queryDate }) => {
        ...
        return {
            ...
            fullQueryRequesting: isRequestingSiteStatsForQuery(
                state,
                siteId,
                'statsVisits',
                fullQuery

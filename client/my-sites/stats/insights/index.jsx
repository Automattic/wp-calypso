...
var StatsNavigation = require( '../stats-navigation' ),
	...
	Comments = require( '../modules/module-comments' ),
	Followers = require( '../modules/module-followers' ),
	PostTrends = require( 'my-sites/post-trends' ),
	SiteOverview = require( '../overview' ),
	SiteOverviewPlaceholder = require( 'my-sites/stats/modules/module-site-overview-placeholder' ),

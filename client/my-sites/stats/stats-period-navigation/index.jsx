...
import {
	...
	STATS_FEATURE_INTERVAL_DROPDOWN_HOUR,
...
const connectComponent = connect(
	( state, { period } ) => {
		...
		const intervals = {
			[ STATS_PERIOD.HOUR ]: {
				id: STATS_PERIOD.HOUR,
				label: translate( 'Hours' ),
				isGated: shouldGateStats( state, siteId, STATS_FEATURE_INTERVAL_DROPDOWN_HOUR ),
				statType: STATS_FEATURE_INTERVAL_DROPDOWN_HOUR,
			},
			[ STATS_PERIOD.DAY ]: {
				id: STATS_PERIOD.DAY,

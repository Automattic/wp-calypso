                ...
                <Card className={classNames(...classes)}>
                    <div className="followers">
                        <div className="module-content">
                            ...
                            <div
                                className="tab-content wpcom-followers stats-async-metabox-wrapper"
                            >
                            ...
                            <div
                                className="tab-content email-followers stats-async-metabox-wrapper"
                            >
                                <div className="module-content-text module-content-text-stat">
                                    {emailData &&
                                ...
                                {hasEmailFollowers &&
                                    <StatsList
                                        moduleName="EmailFollowers"
                                        data={emailData.subscribers}
                                    />}
                        ...
                        {((wpcomData && wpcomData.subscribers.length !== wpcomData.total_wpcom) ||
                            (emailData &&
                                emailData.subscribers.length !== emailData.total_email)) &&
...
const connectComponent = connect(
    state => {
        ...
        return {
            ...
            hasEmailQueryFailed: hasSiteStatsQueryFailed(
                state,
                siteId,
                'statsFollowers',
                emailQuery
            ...
            hasWpcomQueryFailed: hasSiteStatsQueryFailed(
                state,
                siteId,
                'statsFollowers',
                wpcomQuery

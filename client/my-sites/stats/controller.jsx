...
module.exports = {
    ...
    overview: function(context, next) {
        ...
        const activeFilter = find(filters(), filter => {
            return context.pathname === filter.path ||
    ...
    site: function(context, next) {
        ...
        if (!activeFilter) {
            ...
            if (queryOptions.startDate && i18n.moment(queryOptions.startDate).isValid) {
                ...
                date = rangeOfPeriod(
                    activeFilter.period,
                    momentSiteZone.clone().locale('en')
                ).startOf;
            }
    ...
    summary: function(context, next) {
        ...
        const filters = [
            ...
            {
                path: '/stats/week/' + contextModule + '/' + siteId,
                id: 'stats-week',
                period: 'week',
            },
            {
                path: '/stats/month/' + contextModule + '/' + siteId,
                id: 'stats-month',
                period: 'month',
            },
            {
                path: '/stats/year/' + contextModule + '/' + siteId,
                id: 'stats-year',
                period: 'year',
            },
        ];

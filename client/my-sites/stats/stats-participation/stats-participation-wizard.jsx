...
import { Card, Panel, PanelRow, PanelBody } from '@wordpress/components';
			...
			<Card className="jetpack-upsell-card">
				<div className="stats-participation-wizard__card">
					<div className="left">
						...
						>
							<PanelBody title="What site type is groovydomain.com?" opened={ wizardStep === 0 }>
								<PanelRow>
									<div className="type">
										<h3>Personal</h3>
										<p>
										...
										{ /* <button onClick={() => setSiteType("Personal")}>Personal site</button> */ }
									</div>
									<div className="type">
										<h3>Commercial</h3>
										<p>
										...
										{ /* <button onClick={() => setSiteType("Commercial")}>Commercial site</button> */ }
									</div>
								</PanelRow>
							</PanelBody>
					...
					<div className="right">
						...
						{ subscriptionValue >= 40 && (
							<>
								<div className="celebrate">
									{ /* transition:fade */ }
									<p className="biggest-supporters">
									...
									<svg xmlns="http://www.w3.org/2000/svg" width="456" height="596" fill="none">
										...
										<g filter="url(#b)">
											<path
												fill="#E34C84"
												d="m438.501 465.186-14.29-3.83 6.987-26.077 14.29 3.829z"
											/>
										</g>
										<g filter="url(#c)">
											<path
												fill="#31CC9F"
												d="m131.773 442.674 6.552-3.91 7.136 11.954-6.552 3.911z"
											/>
										</g>
										<g filter="url(#d)">
										...
										<defs>
											...
											>
												...
												<feGaussianBlur
													result="effect1_foregroundBlur_3568_14033"
													stdDeviation="4.401"
												/>
											</filter>
											<filter

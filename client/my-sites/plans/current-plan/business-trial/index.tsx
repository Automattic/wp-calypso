...
const BusinessTrialCurrentPlan = () => {
	...
	const targetPlan = PLAN_BUSINESS_MONTHLY;
	...
	const bannerCallToAction = (
		<Button
			className="business-trial-current-plan__trial-card-cta"
			primary
	...
	return (
		<>
			...
			<div className="business-trial-current-plan__banner-wrapper">
				<BusinessTrialBanner callToAction={ bannerCallToAction } />
			</div>

			<h2 className="business-trial-current-plan__section-title">
				{ translate( 'What’s included in your free trial' ) }
			</h2>
			<div className="business-trial-current-plan__included-wrapper">
				...
				{ ! displayAllIncluded && (
					<Button
						className="business-trial-current-plan__included-view-all"
			...
			<p className="business-trial-current-plan__section-subtitle">
				{ translate(
					'Upgrade your free trial to launch your store and get the next-level features you need to grow.'
				) }
			</p>

			<div className="business-trial-current-plan__more-wrapper">
			...
			<div className="business-trial-current-plan__cta-wrapper">
				<Button
					className="business-trial-current-plan__cta is-primary"
...
export default BusinessTrialCurrentPlan;

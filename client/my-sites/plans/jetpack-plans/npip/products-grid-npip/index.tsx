	...
	return (
		<Experiment name={ SWITCH_PLAN_SIDES_EXPERIMENT }>
			<section className="products-grid-npip__section">
				...
				<ul
					className={ classNames( 'products-grid-npip__plan-grid', {
				...
				<div
					className={ classNames( 'products-grid-npip__more', {
			...
			<section className="products-grid-npip__section products-grid-npip__asterisk-items">
				<h2 className="products-grid-npip__asterisk-item">
			...
			<section className="products-grid-npip__section">
				<h2 className="products-grid-npip__section-title">{ translate( 'More Products' ) }</h2>
				...
				<div className="products-grid-npip__free">

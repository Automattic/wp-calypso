			...
			<div className="stats__metrics">
				...
				<div className="stats__metric">
					<GoogleMyBusinessStatsChart
						...
						description={translate('The Google services that customers use to find your business')}
						statType="views"
				...
				<div className="stats__metric">
					<GoogleMyBusinessStatsChart
						...
						description={translate('The most common actions that customers take on your listing')}
						statType="actions"

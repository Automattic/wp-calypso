...
export default function designPreview(WebPreview) {
    class DesignPreview extends React.Component {
        ...
        componentDidUpdate(prevProps) {
            ...
            if (
                !this.props.previewMarkup || this.props.selectedSiteId !== prevProps.selectedSiteId
            ) {
                this.loadPreview();
            }
    ...
    function mapStateToProps(state) {
        ...
        return {
            ...
            showPreview: currentLayoutFocus === 'preview' ||
                currentLayoutFocus === 'preview-sidebar',
        };
    }

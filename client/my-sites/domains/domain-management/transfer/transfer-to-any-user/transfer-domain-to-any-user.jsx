...
class TransferDomainToAnyUser extends Component {
	static propTypes = {
	...
	render() {
		if ( ! this.isDataReady() ) {
			return (
				<>
					<BodySectionCssClass bodyClass={ [ 'transfer-to-any-user' ] } />
		...
		return (
			<Main wideLayout>
				<BodySectionCssClass bodyClass={ [ 'transfer-to-any-user' ] } />
				{ this.renderHeader() }
				<div className="transfer-to-any-user__container">
					<div className="transfer-to-any-user__main">{ this.renderSection() }</div>
				</div>
			</Main>
		);
	}
	...
	renderDialog() {
		...
		return (
			<Dialog
				className="transfer-to-any-user__confirmation-dialog"
			...
			<>
				...
				<FormFieldset>
					<FormSelect
						...
						className="transfer-to-any-user__select"
				...
				{ hasEmailWithUs && (
					<div className="transfer-to-any-user__notice">
						<Gridicon icon="info-outline" size={ 18 } />
						<p className="transfer-to-any-user__notice-copy">
							{ translate(
...
)( localize( withUsers( TransferDomainToAnyUser ) ) );

		...
		return (
			<div className={classes}>
				...
				<FormFieldset>
					...
					/>
					{!isServiceValid && <FormInputValidation text={translate('Invalid Service')} isError />}
				</FormFieldset>
				...
				<FormFieldset>
					...
					<FormTextInput
						...
						defaultValue="10"
					/>
					{!isAuxValid && <FormInputValidation text={translate('Invalid Priority')} isError />}
				</FormFieldset>
				...
				<FormFieldset>
					...
					<FormTextInput
						...
						defaultValue="10"
					/>
					{!isWeightValid && <FormInputValidation text={translate('Invalid Weight')} isError />}
				</FormFieldset>
				...
				<FormFieldset>
					...
					/>
					{!isPortValid && <FormInputValidation text={translate('Invalid Target Port')} isError />}
				</FormFieldset>
			</div>
		);
	}

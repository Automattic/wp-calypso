...
function PostActionsEllipsisMenuQRCode( { translate, status, url } ) {
	...
	return (
		<>
			<PopoverMenuItem onClick={ generateQRCode } icon={ <Icon icon={ qrIcon } /> }>
				{ translate( 'QR Code' ) }
			</PopoverMenuItem>
			<PostActionsQRCode siteUrl={ url } showQRCode={ showQRCode } />
		</>
	);
}

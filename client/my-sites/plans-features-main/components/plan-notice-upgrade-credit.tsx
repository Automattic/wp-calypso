...
const PlanNoticeUpgradeCredit = ( {
	...
	// For plans-switch, hide the notice banner entirely — credit/refund info
	// is shown in the subtitle instead. Keep QueryUserPurchases so Redux
	// purchase data loads for the subtitle hooks.
	if ( isSwitchPlan ) {

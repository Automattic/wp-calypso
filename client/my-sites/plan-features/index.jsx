...
export class PlanFeatures extends Component {
	...
	render() {
		...
		const tableClasses = classNames('plan-features__table', `has-${planProperties.length}-cols`);
	...
	(state, ownProps) => {
		...
		let planProperties = compact(
			map(plans, (plan) => {
				...
				let planFeatures = getPlanFeaturesObject(planConstantObj.getPlanCompareFeatures(abtest));

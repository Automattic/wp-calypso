...
export async function submitExistingCardPayment( transactionData, submit, isLoggedOutCart ) {
...
export function submitCreditsTransaction( transactionData, submit, isLoggedOutCart ) {

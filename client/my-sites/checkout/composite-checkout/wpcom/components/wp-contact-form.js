...
function ContactFormSummary({ isDomainFieldsVisible }) {
	...
	const fullName = joinNonEmptyValues(' ', contactInfo.firstName.value, contactInfo.lastName.value);
		...
		<GridRow>
			<div>
				...
				<SummaryDetails>
					...
					{showDomainContactSummary && cityAndState && <SummaryLine>{cityAndState}</SummaryLine>}

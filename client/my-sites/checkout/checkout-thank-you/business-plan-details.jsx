...
const BusinessPlanDetails = ( { selectedSite, sitePlans, selectedFeature, purchases } ) => {
	...
	return (
		<div>
			...
			<PurchaseDetail
				icon={ <img src="/calypso/images/illustrations/jetpack-concierge.svg" /> }
			...
			{ ! selectedFeature && (
				<PurchaseDetail
					icon={ <img src="/calypso/images/illustrations/jetpack-themes.svg" /> }
			...
			{ ! selectedFeature &&
				isEnabled( 'manage/plugins/upload' ) && (
					<PurchaseDetail
						icon={ <img src="/calypso/images/illustrations/jetpack-updates.svg" /> }
			...
			<PurchaseDetail
				icon={ <img src="/calypso/images/illustrations/jetpack-google-analytics.svg" /> }

...
const PremiumPlanDetails = ( { selectedSite, sitePlans, selectedFeature, purchases } ) => {
	...
	return (
		<div>
			...
			<PurchaseDetail
				icon={ <img src="/calypso/images/illustrations/ads-removed.svg" /> }
			...
			{ ! selectedFeature && (
				<PurchaseDetail
					icon={ <img src="/calypso/images/illustrations/customizeTheme.svg" /> }
			...
			<PurchaseDetail
				icon={ <img src="/calypso/images/illustrations/jetpack-video-hosting.svg" /> }
			...
			{ isWordadsInstantActivationEligible( selectedSite ) && (
				<PurchaseDetail
					icon={ <img src="/calypso/images/illustrations/jetpack-wordads.svg" /> }

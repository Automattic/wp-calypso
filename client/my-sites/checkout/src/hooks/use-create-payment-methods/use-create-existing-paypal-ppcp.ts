...
import { createExistingPayPalPPCPMethod } from 'calypso/my-sites/checkout/src/payment-methods/existing-paypal-ppcp';
import type { PaymentMethod } from '@automattic/composite-checkout';
import type { StoredPaymentMethod, StoredPaymentMethodPayPal } from '@automattic/wpcom-checkout';

export const existingPayPalPPCPPrefix = 'existingPayPalPPCP-';

export default function useCreateExistingPayPalPPCP( {

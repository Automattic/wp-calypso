...
export const QuickLinks = ({
	...
	const quickLinks = (
		<div className="quick-links__boxes">
			...
			/>
			{hasCustomDomain ? (
				<ActionBox onClick={addEmailAction} label={translate('Add email')} materialIcon="email" />
			) : (
				<ActionBox onClick={addDomainAction} label={translate('Add a domain')} gridicon="domains" />
			)}
			<ActionBox

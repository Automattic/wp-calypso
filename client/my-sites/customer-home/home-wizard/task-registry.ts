...
export const TASK_REGISTRY: TaskTemplate[] = [
	...
	},
	{
		...
		subtitle: 'Open a conversation on your posts.',
		category: 'feature-setup',
		features: [ 'comments' ],
		// /settings/discussion bounces to wp-admin via redirectIfDuplicatedView;
		// /comments/all is the Calypso-native comments management surface.
		url: ( s ) => `/comments/all/${ s }`,
		cta: 'Manage comments',
	},
	{
		id: 'connect-analytics',
		title: 'Connect site analytics',
		subtitle: 'Stats are what tell you the work is paying off.',
		category: 'feature-setup',
		features: [ 'analytics' ],
		url: ( s ) => `/stats/day/${ s }`,
		cta: 'Open Stats',
	},
	{
		...
		subtitle: 'Drafts, ideas, and rewrites — built into the editor.',
		category: 'feature-setup',
	...
	{
		id: 'discover-akismet',
		title: 'Block spam with Akismet',
		subtitle: 'Comments without the cleanup work.',
		category: 'discover',
		features: [ 'comments' ],
		url: ( s ) => `/plugins/akismet/${ s }`,
		cta: 'Install',
	},

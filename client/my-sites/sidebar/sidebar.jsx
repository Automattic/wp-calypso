...
export class MySitesSidebar extends Component {
    ...
    plan() {
        ...
        if (site && (isPersonal(site.plan) || isPremium(site.plan) || isBusiness(site.plan))) {
    ...
    sharing() {
        var site = this.getSelectedSite(), sharingLink = '/sharing' + this.siteSuffix();

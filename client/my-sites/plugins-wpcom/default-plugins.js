...
export const defaultStandardPlugins = [
	{
		...
		icon: 'stats-alt',
		category: i18n.translate( 'Traffic Growth' ),
	...
	},
	{
		...
		icon: 'lock',
		category: i18n.translate( 'Performance' ),
	...
	},
	{
		...
		icon: 'image-multiple',
		category: i18n.translate( 'Appearance' ),
	...
	},
	{
		...
		icon: 'lock',
		category: i18n.translate( 'Security' ),
...
export const defaultPremiumPlugins = [
	{
		...
		icon: 'block',
		category: i18n.translate( 'Premium' ),
...
export const defaultBusinessPlugins = [
	...
	},
	{
		...
		icon: 'stats',
		category: i18n.translate( 'Business' ),

    ...
    render() {
        ...
        return (
            <div className="plugins-wpcom__jetpack-plugins-panel">
                    ...
                    {isATEnabledForCurrentSite() &&
                        <ButtonGroup key="plugin-list-header__buttons-browser">
                            <Button
                                ...
                                ref="addPluginButton"
                                aria-label={translate('Browse all plugins', {
                ...
                <CompactCard
                    className="plugins-wpcom__jetpack-main-plugin plugins-wpcom__jetpack-plugin-item"
                >
                    ...
                    <div className="plugins-wpcom__plugin-actions">
                        <Button
                            className="plugins-wpcom__plugin-is-active is-active-plugin"
                            compact
                            borderless
                        >

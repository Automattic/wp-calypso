...
class SharingServiceTip extends Component {
	...
	facebook() {
		return this.props.translate(
			'You can also add a {{likeBoxLink}}Like Box{{/likeBoxLink}}, a {{shareButtonLink}}share button{{/shareButtonLink}}, or {{embedLink}}embed{{/embedLink}} your page or profile on your site.',
			{
				components: {
					likeBoxLink: (
						<a href="https://wordpress.com/support/facebook-integration/#facebook-like-box" />
					),
					shareButtonLink: <a href="https://wordpress.com/support/sharing/" />,
					embedLink: (
						<a href="https://wordpress.com/support/facebook-integration/facebook-embeds/" />
					),
				},
	...
	twitter() {
		return this.props.translate(
			...
			{
				components: {
					widgetLink: <a href="https://wordpress.com/support/widgets/twitter-timeline-widget/" />,
				},
				context: 'Sharing: Tip in settings',
			}
		);
	...
	instagram() {
		return this.props.translate(
			...
			{
				components: {
					widgetLink: <a href="https://wordpress.com/support/instagram/instagram-widget/" />,
				},
				context: 'Sharing: Tip in settings',
			}
		);

...
export default React.createClass({
    ...
    updatesAvailable() {
        if (
            ...
            this.props.site.updates.wordpress &&
            this.props.site.updates.wp_update_version
        ) {
            return (
                <span>
                    {this.translate(
        ...
        if (
            this.props.site.updates.plugins === this.props.site.updates.total &&
    ...
    unsupportedJetpackVersion() {
        return (
            <span>
                {this.translate('Jetpack %(version)s is required', {
    ...
    errorAccessing() {
        ...
        if (this.props.site) {
            accessFailedMessage = (
                <span>
                    {this.translate('This site cannot be accessed.')}
                    {' '}
                    <DisconnectJetpackButton
                        site={this.props.site}
                        text={this.translate('Disconnect Site')}
                        redirect="/sites"
                    />
                </span>
            );

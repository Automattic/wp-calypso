        ...
        return (
            <div>
                <SectionHeader label={translate('Caching')}>
                    <Button compact={true} primary={true} type="submit">
                ...
                <Card>
                    ...
                    <div>
                        <Button compact={true} style={{ marginRight: '8px' }} type="submit">
                            {translate('Delete Cache')}
                        </Button>
                        {site.jetpack &&
                            site.is_multisite &&
                            <Button compact={true} type="submit">

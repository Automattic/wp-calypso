...
describe('#requestZoneFeed()', () => {
	...
	test('should return `removeNotice`', () => {
		expect(requestZoneFeed(dummyAction)).toContainEqual(removeNotice('zoninator-request-feed'));
	});
});
...
describe('#announceSuccess()', () => {
	...
	test('should return `updateFeed`', () => {
		expect(announceSuccess(dummyAction)).toContainEqual(updateFeed(123, 456, dummyAction.posts));
	});
});

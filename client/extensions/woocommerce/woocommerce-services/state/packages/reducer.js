 ...
 */
import { WOOCOMMERCE_SERVICES_PACKAGES_ADD_PACKAGE, WOOCOMMERCE_SERVICES_PACKAGES_REMOVE_PACKAGE, WOOCOMMERCE_SERVICES_PACKAGES_EDIT_PACKAGE, WOOCOMMERCE_SERVICES_PACKAGES_DISMISS_MODAL, WOOCOMMERCE_SERVICES_PACKAGES_SET_IS_SAVING, WOOCOMMERCE_SERVICES_PACKAGES_SET_MODAL_ERRORS, WOOCOMMERCE_SERVICES_PACKAGES_UPDATE_PACKAGES_FIELD, WOOCOMMERCE_SERVICES_PACKAGES_SAVE_PACKAGE, WOOCOMMERCE_SERVICES_PACKAGES_TOGGLE_OUTER_DIMENSIONS, WOOCOMMERCE_SERVICES_PACKAGES_TOGGLE_ALL_PREDEFINED, WOOCOMMERCE_SERVICES_PACKAGES_TOGGLE_PREDEFINED, WOOCOMMERCE_SERVICES_PACKAGES_REMOVE_PREDEFINED, WOOCOMMERCE_SERVICES_PACKAGES_SAVE_PREDEFINED, WOOCOMMERCE_SERVICES_PACKAGES_SET_ADD_MODE, WOOCOMMERCE_SERVICES_PACKAGES_SET_IS_FETCHING, WOOCOMMERCE_SERVICES_PACKAGES_INIT_PACKAGES_FORM } from '../action-types';
...
reducers[ WOOCOMMERCE_SERVICES_PACKAGES_TOGGLE_ALL_PREDEFINED ] = ( state, { serviceId, groupId, checked } ) => {
...
reducers[ WOOCOMMERCE_SERVICES_PACKAGES_TOGGLE_PREDEFINED ] = ( state, { serviceId, packageId } ) => {
	const newPredefined = {	...state.currentlyEditingPredefinedPackages };
...
reducers[ WOOCOMMERCE_SERVICES_PACKAGES_REMOVE_PREDEFINED ] = ( state, { serviceId, packageId } ) => {

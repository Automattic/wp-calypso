	...
	return (
		<div>
			...
			<FormFieldset>
				...
				{renderDimensionsInput('inner_dimensions', inner_dimensions, dimensionUnit, updateField)}
			...
			{isOuterDimensionsVisible ? (
				<FormFieldset>
					...
					{renderDimensionsInput('outer_dimensions', outer_dimensions, dimensionUnit, updateField)}

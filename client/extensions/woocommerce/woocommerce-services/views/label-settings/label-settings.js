...
class ShippingLabels extends Component {
	...
	renderEmailReceiptsSection = () => {
		...
		return (
			<FormFieldSet>
				<FormLabel className="label-settings__cards-label">{translate('Email receipts')}</FormLabel>
				<FormLabel>
					<FormCheckbox
		...
		return (
			<div>
				<FormFieldSet>
					...
					<FormLabel className="label-settings__cards-label">{translate('Paper size')}</FormLabel>
					<FormSelect onChange={onPaperSizeChange} value={paperSize} disabled={!canEditSettings}>

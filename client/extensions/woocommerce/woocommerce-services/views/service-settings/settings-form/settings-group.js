...
const SettingsGroup = (props) => {
	...
	const renderSettingsItem = (item) => {
		...
		return <SettingsItem {...props} key={itemKey} layout={item} errors={errors[itemKey] || {}} />;
	};
	...
	switch (group.type) {
		case 'fieldset':
			return <SettingsGroupCard heading={group.title}>{renderSettingsItems()}</SettingsGroupCard>;

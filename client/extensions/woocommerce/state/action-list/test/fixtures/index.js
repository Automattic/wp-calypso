...
export const stepA = { description: 'Do Step A', onStep: ( dispatch, actionList ) => {
...
export const stepB = { description: 'Do Step B', onStep: ( dispatch, actionList ) => {
...
export const stepE = { description: 'Do Error Step', onStep: ( dispatch, actionList ) => {

 ...
 */
export const isCustomerSearchLoaded = (state, searchTerm, siteId = getSelectedSiteId(state)) => {
	const inFlight = get(
		state,
 ...
 */
export const isCustomerSearchLoading = (state, searchTerm, siteId = getSelectedSiteId(state)) => {
	const inFlight = get(
		state,
		`extensions.woocommerce.sites[${siteId}].customers.isSearching[${searchTerm}]`
	);
 ...
 */
export const getCustomerSearchResults = (state, searchTerm, siteId = getSelectedSiteId(state)) => {

	...
	getFilteredCategories() {
		...
		const filteredCategories =
			...
			productCategories.filter(
				(category) =>
					categoryContainsString(category, searchFilter) || isCategorySelected(value, category.id)
			);
	...
	getFilteredProducts() {
		...
		return (
			...
			products.filter((product) => {
				return productContainsString(product, searchFilter) || isProductSelected(value, product.id);
			})
		);
	}

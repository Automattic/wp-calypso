...
class PaymentMethodStripeConnectedDialog extends Component {
	...
	notifyConnectionCompleted = () => {
		...
		return (
			<Notice onDismissClick={this.onDismissNotice} showDismiss status="is-success" text={text} />
		);
	};
		...
		return (
			<div>
				...
				<FormFieldset className="stripe__method-edit-field-container">
					...
					/>
					<span>
						{translate('By using Apple Pay you agree to Stripe and ' + "Apple's terms of service")}
					</span>
					<FormSettingExplanation>

...
import { ConfirmationModal } from 'calypso/hosting/server-settings/staging-site-card/confirmation-modal';
import { StagingSite } from 'calypso/hosting/server-settings/staging-site-card/use-staging-site';

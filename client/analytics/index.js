...
var analytics = {
	...
	timing: {
		record: function( eventType, duration, triggerName ) {
			analytics.ga.recordTiming( mostRecentUrlPath, eventType, duration, triggerName );
			analytics.statsd.recordTiming( mostRecentUrlPath, eventType, duration, triggerName );
		}
	},

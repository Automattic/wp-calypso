...
import { useRecommendedFeedsMutation } from '..';
...
describe( 'useRecommendedFeedsMutation', () => {
	...
	describe( 'Basic functionality', () => {
		it( 'should return correct initial state', () => {
			const { result } = renderHook( () => useRecommendedFeedsMutation( mockFeedId ) );
	...
	describe( 'Redux integration', () => {
		it( 'should react to selector function changes', () => {
			const { result, rerender } = renderHook( () => useRecommendedFeedsMutation( mockFeedId ) );

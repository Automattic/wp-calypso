...
const computeRows = ( columns, images ) => {
...
export default ( { children, className, columns, images } ) => {
	// eslint-disable-next-line
	const rows = computeRows( columns, images );

	return <div className={ `${ className }__tiled-gallery` }>{ children }</div>;
	/*
	{

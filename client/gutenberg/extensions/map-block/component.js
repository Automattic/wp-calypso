...
export class Map extends Component {
	...
	render() {
				...
				{ activeMarker &&
					admin && (
						<Fragment>
							...
							/>
							<TextareaControl
								className="wp-block-a8c-maps__marker-caption"
							...
							/>
							<Button onClick={ deleteActiveMarker } className="wp-block-a8c-maps__delete-btn">
		...
		return (
			<Fragment>
				<div className="wp-block-a8c-maps__gm-container" ref={ this.mapRef }>
					{ mapMarkers }
				</div>
				{ infoWindow }
				{ children }

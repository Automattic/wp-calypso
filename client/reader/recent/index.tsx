			...
			>
				...
				<div className="recent-feed__list-column-content">
					{ isEmpty ? (
						<>
							<p>
								<strong>Welcome!</strong> Follow your favorite sites and their latest posts will
								appear here. Read, like, and comment in a distraction-free environment. Get started
								by selecting your interests below:
							</p>
							<ReaderOnboarding />
						</>
					) : (

...
import { commentAuthorAvatar, help, comment, backup, page, video, rss } from '@wordpress/icons';
	...
	return (
		<Menu>
			...
			<Menu.Popover style={ { minWidth: '250px' } }>
				...
				<Menu.Separator />
				<Menu.Group>
					<Menu.Item disabled={ isLoggingOut } hideOnClick={ false } onClick={ logoutHandler }>
						<Menu.ItemLabel>
							<HStack justify="left">
...
function SecondaryMenu() {
	...
	const user = useSelector( getCurrentUser ) as User | null;
	...
	return (
		<HStack spacing={ isDesktop ? 2 : 0 } justify="flex-end">
			...
			{ user && <UserProfile user={ user } onLogout={ () => {} } onClick={ () => {} } /> }
		</HStack>
	);
}

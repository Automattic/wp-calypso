								...
								>
									...
									>
										<svg
											...
											viewBox="0 0 24 24"
										>
											<path d="M12.2 8c.5.3.6 1 .3 1.4L10 13.3c-.3.5-1 .7-1.4.3-.6-.3-.8-1-.4-1.5l2.5-3.9c.4-.4 1-.5 1.5-.2zM12.7 12.9h7.1c1 0 1.8.8 1.8 1.8V19c0 1.2-.5 2.2-1.5 2.9l-2.9 2v-3.1h-4.4c-1 0-1.8-.8-1.8-1.8v-4.4c-.1-.9.7-1.7 1.7-1.7z" />
											<path d="M10.5 3.3C5.4 3.3 2 7.1 2 11v.4c0 3.8 3.1 7.4 8 7.6v-2.3c-3.4-.2-5.2-2.7-5.2-5.4V11c0-2.8 2-5.3 5.8-5.3s5.8 2.5 5.8 5.3v.3c0 .3 0 .6-.1.8H19V11c0-4-3.4-7.7-8.5-7.7z" />
										</svg>

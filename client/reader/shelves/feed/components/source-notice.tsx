...
/**
 * "One or more sources couldn't be loaded" banner for an aggregated shelf feed.
 ...
 */
export function ShelfFeedSourceNotice( { failedCount, onRetry }: Props ) {
	...
	return (
		<div className="shelf-feed__source-notice" role="status">
			<span>
				{ translate(
			...
			{ onRetry && (
				<button type="button" className="shelf-feed__source-notice-retry" onClick={ onRetry }>
					{ translate( 'Retry' ) }
				</button>
			) }
		</div>

...
import { ShelfIconPicker } from '../icon-picker';

describe( 'ShelfIconPicker', () => {
	it( 'renders a tile for every icon and checks the selected one', () => {
		renderWithProvider( <ShelfIconPicker value="category" onChange={ jest.fn() } /> );
	...
	it( 'reports the chosen icon', async () => {
		...
		renderWithProvider( <ShelfIconPicker value="category" onChange={ onChange } /> );

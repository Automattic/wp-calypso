	...
	return (
		...
		>
			<HStack
				...
				alignment="center"
				justify="flex-start"
				className="shelf-sources__row-main"
			>
				...
				<VStack spacing={ 0 } className="shelf-sources__row-content">
					<div className="shelf-sources__row-name">{ name }</div>
					<div className="shelf-sources__row-url">{ url }</div>
				</VStack>
			</HStack>
			<Button

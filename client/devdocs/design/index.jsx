...
import WordPressComLogo from 'calypso/components/wordpress-com-logo/docs/example';
import WPCloudLogo from 'calypso/components/wp-cloud-logo/docs/example';
		...
		return (
			<Main className={ className }>
				...
				<Collection component={ component } filter={ filter }>
					...
					<WordPressComLogo readmeFilePath="wordpress-com-logo" />
					<WPCloudLogo readmeFilePath="wp-cloud-logo" />

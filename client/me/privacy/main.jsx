...
const Privacy = createReactClass({
	...
	updateTracksOptOut(isSendingTracksEvents) {
		this.props.userSettings.updateSetting(TRACKS_OPT_OUT_USER_SETTINGS_KEY, !isSendingTracksEvents);
	},
			...
			<Main className="privacy">
				...
				<Card className="privacy__settings">
					<form onChange={markChanged} onSubmit={this.submitForm}>
						...
						<FormButton isSubmitting={this.state.submittingForm} disabled={isSubmitButtonDisabled}>

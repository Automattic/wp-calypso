...
const Account = React.createClass({
    ...
    mixins: [formBase, LinkedStateMixin, observe('userSettings', 'username'), eventRecorder],
            ...
            return (
                <FormFieldset>
                    ...
                    <FormLabel>
                        ...
                        <span>
                            {translate(
                                'Enable the in-page translator where available. {{a}}Learn more{{/a}}',
                                {
                                    components: {
                                        a: (
                                            <a
                                                ...
                                                onClick={this.recordClickEvent(
                                                    'Community Translator Learn More Link'
                                                )}
                                            />
                                        ),
                                    },
        ...
        userSettings.cancelPendingEmailChange((error, response) => {
            if (error) {
                ...
                this.props.successNotice(
                    translate('The email change has been successfully canceled.')
                );
            }
        });
    },
        ...
        return (
            <div className="account__username-form" key="usernameForm">
                ...
                <FormButtonsBar>
                    <FormButton
                        disabled={
                            userSettings.getSetting('user_login') !== this.state.userLoginConfirm ||
                    ...
                    <form onChange={markChanged} onSubmit={this.submitForm}>
                        <FormFieldset>
                            ...
                            <FormTextInput
                                ...
                                disabled={
                                    this.getDisabledState() ||
                                        !userSettings.getSetting('user_login_can_be_changed')
                                }
                                id="username"
                                name="username"

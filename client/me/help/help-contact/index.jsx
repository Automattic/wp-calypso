...
const HelpContact = React.createClass({
    componentWillReceiveProps(nextProps) {
        if (
            nextProps.olarkTimedOut &&
            this.olarkTimedOut !== nextProps.olarkTimedOut &&
            !this.shouldUseHappychat()
        ) {
    ...
    trackChatDisplayError: function(olarkEvent) {
        ...
        olarkApi('api.visitor.getDetails', details => {
            ...
            analytics.tracks.recordEvent(
                'calypso_help_contact_chatbox_mistaken_display_got_details',
                data
            );
        });
    },
    ...
    shouldUseDirectly: function() {
        ...
        return config.isEnabled('help/directly') && isEn && !this.props.isDirectlyFailed;
    },
    ...
    shouldShowTicketRequestErrorNotice: function(variationSlug) {
        ...
        return SUPPORT_HAPPYCHAT !== variationSlug &&
    ...
    hasDataToDetermineVariation: function() {
        ...
        const ticketReadyOrError = ticketSupportConfigurationReady ||
            null != ticketSupportRequestError;
    ...
    shouldShowPreloadForm: function() {
        ...
        const waitingOnDirectly = this.getSupportVariation() === SUPPORT_DIRECTLY &&
            !this.props.isDirectlyReady;
    ...
    render: function() {
        return (
            <Main className="help-contact">
                ...
                <Card
                    className={
                        this.canShowChatbox() ? 'help-contact__chat-form' : 'help-contact__form'
                    }
                >
                    {this.getView()}
                </Card>

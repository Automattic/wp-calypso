	...
	render() {
		...
		return (
			<form onSubmit={ this.onSubmit }>
				<Notice
					className="security-accountrecovery__validation-notice"
					status="is-warning"
				...
				<FormLabel className="security-accountrecovery__recovery-phone-validation-label">
				...
				<FormTelInput
					...
					value={ candidateCode }
				/>
				<FormButtonsBar className="security-accountrecovery__recovery-phone-validation-buttons">
					<FormButton
						isPrimary={ true }

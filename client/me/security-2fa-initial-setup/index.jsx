			...
			<div>
				...
				<p>
					<FormLabel>
						...
						<span className="security-2fa-initial-setup__description">
							{ this.props.translate(
								'Use an application on your phone to get two-factor authentication codes when you login.'
							) }
						</span>
					</FormLabel>
				</p>
				<p>
					<FormLabel className="security-2fa-initial-setup__label">
						...
						<span className="security-2fa-initial-setup__description">
							{ this.props.translate(
								'WordPress.com will send you a SMS with a two-factor authentication codes when you log in.'
							) }
						</span>
					</FormLabel>
				</p>

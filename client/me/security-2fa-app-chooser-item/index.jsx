 ...
 */
var React = require('react'), debug = require('debug')('calypso:me:security:2fa-app-chooser-item');
...
module.exports = React.createClass({
    ...
    possiblyRenderDownloadQRCode: function(appURL) {
        var imgURL = 'https://chart.googleapis.com/chart?cht=qr&chs=300x300&chld=H|0&chl=' +
                                    ...
                                    codeRevealAnchor: (
                                        <a
                                            ...
                                            onClick={function(event) {
                                                analytics.ga.recordEvent(
                                                    'Me',
                                                    'Clicked On 2fa Scan This Code Link'
                                                );

...
const CancelPurchaseButton = React.createClass({
    ...
    recordEvent(name, properties = {}) {
        ...
        const refund = true;
        this.props.recordTracksEvent(name, Object.assign({ refund, product_slug }, properties));
    },
    ...
    isSurveyIncomplete() {
        return this.state.survey.questionOneRadio === null ||
            this.state.survey.questionTwoRadio === null ||
            (this.state.survey.questionOneRadio === 'anotherReasonOne' &&
                this.state.survey.questionOneText === '') ||
            (this.state.survey.questionTwoRadio === 'anotherReasonTwo' &&
                this.state.survey.questionTwoText === '');
    },
    ...
    renderCancelConfirmationDialog() {
        ...
        if (!config.isEnabled('upgrades/removal-survey')) {
            ...
            buttonsArr = inStepOne
                ? [buttons.close, buttons.next]
                : [buttons.prev, buttons.close, buttons.cancel];
        }
        ...
        return (
            ...
            >
                <FormSectionHeading>
                    {this.translate('Cancel %(purchaseName)s', { args: { purchaseName } })}
                </FormSectionHeading>
                <CancelPurchaseForm
    ...
    submitCancelAndRefundPurchase() {
        ...
        cancelAndRefundPurchase(
            ...
            { product_id: this.props.purchase.productId },
            this.handleSubmit
        );
    },

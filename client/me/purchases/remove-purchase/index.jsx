...
const SUPPORT_CONTEXT = 'precancellation';
	...
	renderDomainDialog() {
		...
		return (
			<Dialog
				...
				{ chatEnabled && <QueryOlarkConfig supportContext={ SUPPORT_CONTEXT } /> }
			</Dialog>
		);
	},
...
export default connect(
	( state ) => ( {
		showChatLink: isOperatorsAvailable( state ) && isEligibleForChat( state, SUPPORT_CONTEXT ),
	} ),
	{ removePurchase }
)( RemovePurchase );

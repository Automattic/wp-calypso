...
describe('PlanBillingPeriod', () => {
	describe('a monthly plan', () => {
		it('should display the current period', () => {
			...
			expect(wrapper.find('FormSettingExplanation').shallow().text()).toContain('Billed monthly');
		});
	...
	describe('an annual plan', () => {
		...
		it('should display the current period', () => {
			...
			expect(wrapper.find('FormSettingExplanation').shallow().text()).toEqual('Billed yearly');
		});
		...
		describe('when credit card is expiring', () => {
			it('should display a warning to the user', () => {
				...
				const wrapper = shallow(<PlanBillingPeriod {...annualPlanProps} purchase={purchase} />);

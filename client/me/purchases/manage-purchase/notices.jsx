...
class PurchaseNotice extends Component {
	...
	renderRenewNoticeAction(onClick) {
		...
		if (
			...
			return <NoticeAction href={editCardDetailsPath}>{translate('Add Credit Card')}</NoticeAction>;
		}
	...
	renderConciergeConsumedNotice() {
		...
		return (
			<Notice showDismiss={false} status="is-info" text={translate('This session has been used.')}>
...
export default connect(null, { recordTracksEvent })(localize(withLocalizedMoment(PurchaseNotice)));

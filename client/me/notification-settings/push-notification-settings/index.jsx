...
const PushNotificationSettings = React.createClass({
    ...
    getBlockedInstruction: function() {
        ...
        return (
            ...
            >
                <div
                    className="notification-settings-push-notification-settings__instruction-content"
                >
                    <div>
                        <div
                            className="notification-settings-push-notification-settings__instruction-title"
                        >
                            {this.translate('Enable Browser Notifications')}
                        </div>
                        <div
                            className="notification-settings-push-notification-settings__instruction-step"
                        >
                            <div
                                className="notification-settings-push-notification-settings__instruction-image"
                            >
                                <SvgAddressBar />
                            </div>
    ...
    render: function() {
                                            ...
                                            components: {
                                                instructionsButton: (
                                                    <Button
                                                        className={'is-link'}
                                                        onClick={
                                                            this.props.toggleUnblockInstructions
                                                        }
                                                    />
                                                ),
                                            },
        ...
        return (
            <Card className="notification-settings-push-notification-settings__settings">
                ...
                <p
                    className="notification-settings-push-notification-settings__settings-description"
                >
                    {this.translate(

                    ...
                    <Card className="me-notification-settings">
                        ...
                        >
                                            ...
                                            readerLink: (
                                                <a
                                                    ...
                                                    onClick={this.recordClickEvent(
                                                        'Edit Subscriptions in Reader Link'
                                                    )}
                                                />
                                            ),
                                        },
                            ...
                            <FormFieldset>
                                ...
                                <FormLabel>
                                    <FormCheckbox
                                        checkedLink={this.valueLink(
                                            'subscription_delivery_jabber_default'
                                        )}
                                        disabled={this.getDisabledState()}
                                        id="subscription_delivery_jabber_default"
                                        name="subscription_delivery_jabber_default"
                                        onClick={this.recordCheckboxEvent(
                                            'Notification Delivery by Jabber'
                                        )}
                                    />
                                    <span>
                                        {this.translate(
                                            'Default delivery via Jabber instant message'
                                        )}
                                    </span>
                                </FormLabel>
                            </FormFieldset>

...
export default React.createClass({
    ...
    getStreamSettings() {
        ...
        if (
            this.props.devices &&
            this.props.devices.initialized &&
            this.props.devices.get().length > 0
        ) {
            stream = parseInt(
                this.props.devices.get()[this.state.selectedDeviceIndex].device_id,
                10
            );
                    ...
                    if (this.props.devices) {
                        return (
                            <DeviceSelector
                                ...
                                onChange={event =>
                                    this.setState({
                                        selectedDeviceIndex: parseInt(event.target.value, 10),
                                    })}
                            />
                        );
                    }

                                ...
                                countrySelectProps={{
                                    onFocus: function() {
                                        analytics.ga.recordEvent(
                                            'Me',
                                            'Focused On 2fa SMS Country Select'
                                        );
                                    },
                                }}
                                phoneInputProps={{
                                    onFocus: function() {
                                        analytics.ga.recordEvent(
                                            'Me',
                                            'Focused On 2fa SMS Phone Number'
                                        );
                                    },
                                }}
                        ...
                        <FormButtonsBar className="security-2fa-sms-settings__buttons">
                            ...
                            <FormButton
                                ...
                                onClick={function(event) {
                                    analytics.ga.recordEvent(
                                        'Me',
                                        'Clicked On Step 1 2fa Cancel Button'
                                    );

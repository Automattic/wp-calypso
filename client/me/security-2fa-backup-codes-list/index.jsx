...
module.exports = React.createClass({
    ...
    getBackupCodeHTML: function(codes) {
        ...
        html += '<p style="margin-top:0"><strong>' +
            this.translate('Backup verification codes') +
            '</strong></p>';
        ...
        return (
            <div>
                        ...
                        function(backupCode, index) {
                            ...
                            return (
                                <li
                                    key={index}
                                    className={
                                        this.props.backupCodes.length ? null : 'is-placeholder'
                                    }
                                >
                                    <span>
                                        {spacedCode}
                ...
                <p className="security-2fa-backup-codes-list__warning">
                    <span className="noticon noticon-warning" />
                    {this.translate(
                    ...
                    <FormButton
                        ...
                        onClick={function(event) {
                            analytics.ga.recordEvent(
                                'Me',
                                'Clicked On 2fa Backup Codes Next Step Button'
                            );

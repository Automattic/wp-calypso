...
class Signup extends React.Component {
	...
	componentDidUpdate(prevProps) {
		if (this.props.flowName !== prevProps.flowName || this.props.stepName !== prevProps.stepName) {
			recordSignupStep(this.props.flowName, this.props.stepName);
		}
...
export default connect(
	(state, ownProps) => {
		...
		const shouldStepShowSitePreview = get(steps[ownProps.stepName], 'props.showSiteMockups', false);
		return {

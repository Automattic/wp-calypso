...
const Signup = React.createClass({
    ...
    componentWillMount() {
        ...
        this.signupFlowController = new SignupFlowController({
            ...
            onComplete: function(dependencies, destination) {
                ...
                if (
                    timeSinceLoading && timeSinceLoading < MINIMUM_TIME_LOADING_SCREEN_IS_DISPLAYED
                ) {
                    return delay(
    ...
    goToFirstInvalidStep() {
        ...
        if (firstInvalidStep) {
            ...
            page(
                utils.getStepUrl(this.props.flowName, firstInvalidStep.stepName, this.props.locale)
            );
        }
    },

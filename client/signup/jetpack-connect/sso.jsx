...
const JetpackSSOForm = React.createClass({
    ...
    getSharedDetailValue(key, value) {
        if ('two_step_enabled' === key && value !== '') {
            value = true === value ? this.translate('Enabled') : this.translate('Disabled');
        }
        ...
        return (
            <Main>
                <EmptyContent
                    ...
                    title={this.translate('Oops, this URL should not be accessed directly')}
                    line={this.translate(
                        ...
                        <Card>
                            ...
                            <div className="jetpack-connect__sso-user-profile">
                                ...
                                <h3 className="jetpack-connect__sso-log-in-as">
                                    {this.translate('Log in as {{strong}}%s{{/strong}}', {
                                        args: user.display_name,
                                        components: {
                                            strong: (
                                                <strong
                                                    className="jetpack-connect__sso-display-name"
                                                />
                                            ),
                                        },
                                    })}

...
class Plans extends Component {
    ...
    isFlowTypePaid() {
        return this.props.flowType === 'pro' ||
    ...
    autoselectPlan() {
        if (!this.props.showFirst) {
            ...
            if (
                this.props.flowType === 'pro' || this.props.selectedPlan === PLAN_JETPACK_BUSINESS
            ) {
            ...
            if (
                this.props.flowType === 'premium' ||
                this.props.selectedPlan === PLAN_JETPACK_PREMIUM
            ) {
            ...
            if (
                this.props.selectedPlan === 'free' || this.props.selectedPlan === PLAN_JETPACK_FREE
            ) {
        ...
        return (
            <div>
                ...
                <PlansGrid
                    ...
                    onSelect={
                        this.props.showFirst || this.props.isLanding
...
export default connect(
    state => {
        ...
        const selectedPlan = getSiteSelectedPlan(state, selectedSiteSlug) ||
            getGlobalSelectedPlan(state);

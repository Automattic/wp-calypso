...
export function generateSteps( {
	...
	return {
		...
		'plans-site-selected': {
			...
			dependencies: [ 'siteSlug' ],
			providesDependencies: [ 'cartItem', 'themeSlugWithRepo', 'addOnItem' ],
			optionalDependencies: [ 'themeSlugWithRepo', 'addOnItem' ],
			props: {
				hideFreePlan: true,
		...
		plans: {
			...
			apiRequestFunction: addPlanToCart,
			dependencies: [ 'siteSlug' ],
			optionalDependencies: [ 'emailItem', 'themeSlugWithRepo', 'addOnItem' ],
			providesDependencies: [ 'cartItem', 'themeSlugWithRepo', 'addOnItem' ],
		...
		'mailbox-plan': {
			...
			providesDependencies: [ 'themeSlugWithRepo', 'cartItem', 'addOnItem' ],
			optionalDependencies: [ 'themeSlugWithRepo', 'addOnItem' ],
			props: {
		...
		'plans-ecommerce-monthly': {
			...
			dependencies: [ 'siteSlug' ],
			providesDependencies: [ 'cartItem', 'themeSlugWithRepo', 'addOnItem' ],
			optionalDependencies: [ 'addOnItem' ],
			defaultDependencies: {

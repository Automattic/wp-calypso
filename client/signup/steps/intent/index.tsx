...
const EXCLUDE_STEPS: { [ key in IntentFlag ]: string[] } = {
	write: [ 'design-setup-site', 'site-info-collection' ],
	build: [ 'site-options', 'site-info-collection' ],
	'do-it-for-me': [ 'site-options' ],
};

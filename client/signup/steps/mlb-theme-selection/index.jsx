...
module.exports = React.createClass( {
	...
	renderThemes: function() {
		return (
			<div>
				<div>
					<label htmlFor="team_field">{ this.translate( 'Your team' ) }</label>
					<select onChange={ this.handleTeamSelect } name="team_field">
				...
				<div>
					...
					<p>
						...
						&nbsp;<a href="http://mlb.mlb.com/mlb/official_info/about_mlb_com/terms_of_use.jsp" target="_blank">Terms of Use</a>.
					</p>
				</div>
			</div>
		);

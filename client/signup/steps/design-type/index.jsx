...
export default React.createClass( {
	...
	getChoices() {
		...
		if ( 'design-store' === this.props.stepName ) {
	...
	isSpacerGif() {
		return ( ! this.isEvenChoices() ) ? ( <div className="design-type__choice is-spacergif" /> ) : null;
	},

	isEvenChoices() {
		return ( 0 === this.getChoices().length % 2 );
	},
	...
	renderChoices() {
		return (
			<div className={ classNames( 'design-type__list', { 'design-type__list__even': this.isEvenChoices() } ) }>

	...
	renderStepContent = () => {
		...
		return (
			<Card className="clone-start__card">
				<svg class="clone-site" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512.7 180.4">
					<g class="clone-site__origin">
						<path fill="#FFFFFF" d="M299.4,178.9V15.2c0-6.8,5.5-12.4,12.4-12.4h183.3c6.8,0,12.4,5.5,12.4,12.4V179H299.4V178.9z"/>
						<path fill="#00A6DB" d="M299.4,35.2V14.7c0-8.1,5.5-14.7,12.4-14.7h183.3c6.8,0,12.4,6.6,12.4,14.7v20.5H299.4z"/>
						<path fill="#74DCFC" d="M322,80.8h65.8v66c0,5.7-4.7,10.4-10.4,10.4H322V80.8z"/>
						<path fill="#00BE28" d="M387.8,146.8v-6.2c-3.3-7.7-9.1-12-16.7-14.1c-13.8-3.9-36.4,4.3-49.1-24.1v54.8h55.4 C383.1,157.2,387.8,152.5,387.8,146.8z"/>
					...
					<g class="clone-site__destination">

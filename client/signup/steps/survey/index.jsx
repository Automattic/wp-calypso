...
const SurveyStep = React.createClass({
    ...
    render() {
        ...
        const blogSubHeaderText = this.translate(
        ...
        return (
            <StepWrapper
                ...
                stepContent={
                    this.props.stepSectionName === 'other'
                        ? this.renderOther()
    ...
    submitStep(label, value, otherWriteIn = '') {
        analytics.tracks.recordEvent('calypso_survey_site_type', {
            type: this.props.surveySiteType,
        });

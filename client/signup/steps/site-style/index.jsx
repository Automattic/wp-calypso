...
export class SiteStyleStep extends Component {
	...
	renderProfessionalSVG() {
		return (
			<svg width="130" height="32" xmlns="http://www.w3.org/2000/svg">
				<g fill="none" fill-rule="evenodd">
					<path stroke="#000" stroke-width="3" d="M1.5 1.5h127v29H1.5z" />
					<path
			...
			<svg width="80" height="32" xmlns="http://www.w3.org/2000/svg">
				<g transform="translate(1 8)" fill="none" fill-rule="evenodd">
					<path
						...
						fill="#242424"
					/>
					<rect stroke="#232A2E" stroke-width="2" y="4" width="8" height="8" rx="2" />
					<rect stroke="#232A2E" stroke-width="2" x="70" y="4" width="8" height="8" rx="2" />
				</g>
			</svg>
		);
	}
		...
		return this.props.styleOptions.map( ( siteStyleProperties, index ) => {
			...
			return (
				...
				>
					...
					{ siteStyleProperties.label == 'Professional' ? this.renderProfessionalSVG() : null }
					{ siteStyleProperties.label == 'Sophisticated' ? this.renderSophisticatedSVG() : null }
					{ siteStyleProperties.label == 'Calm' ? this.renderCalmSVG() : null }
					{ siteStyleProperties.label == 'Modern' ? this.renderModernSVG() : null }
				</FormLabel>
			);
		} );
	}

	...
	renderStepContent() {
		...
		return (
			<Card className="clone-ready__card">
				...
				>
					<g className="clone-ready__destination">
						<path
							fill="#FFFFFF"
					...
					<g className="clone-ready__dots">
						<circle fill="#bedae6" cx="238.8" cy="94.1" r="5.2" />
						<circle fill="#bedae6" cx="261.9" cy="94.1" r="5.2" />
						<circle fill="#bedae6" cx="284.5" cy="94.1" r="5.2" />
					</g>
					<g className="clone-ready__origin">
						<path
							fill="#FFFFFF"

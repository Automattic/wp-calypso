			...
			<div>
				...
				<div className="signup-processing__content">
					...
					{ this.props.loginHandler
						?	<p className="signup-process-screen__title">We're all set.</p> :
							<p className="signup-process-screen__title"><strong>Awesome!</strong> Give us one minute and we&rsquo;ll move right along.</p>
					}

					{ this.props.loginHandler
						?	<Button primary className="email-confirmation__button" onClick={ this.props.loginHandler }>{ this.translate( "Get Started" ) }</Button> :

...
export const warning: ReactElement = (
	<SVG width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
		<ellipse cx="10" cy="7" rx="5" ry="5" stroke={ colors[ 'Yellow 40' ] } strokeWidth="1.3" />
		<line
			x1="6.99994"
			y1="14.9816"
			x2="12.9999"
			y2="14.9816"
			stroke={ colors[ 'Yellow 40' ] }
			strokeWidth="1.3"
		/>
		<line x1="8" y1="17.35" x2="12" y2="17.35" stroke={ colors[ 'Yellow 40' ] } strokeWidth="1.3" />
	</SVG>
);

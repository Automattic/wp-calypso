...
describe('EditorPublishButton', () => {
	describe('#isEnabled()', () => {
		...
		test('should return false if form is publishing', () => {
			const tree = shallow(<EditorPublishButton translate={identity} isPublishing />).instance();

			expect(tree.isEnabled()).to.be.false;
		});

		test('should return false if saving is blocked', () => {
			const tree = shallow(<EditorPublishButton translate={identity} isSaveBlocked />).instance();

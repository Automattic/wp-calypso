...
describe('EditorCategoriesTagsAccordion', function() {
    ...
    describe('categories+tags subtitle', function() {
        ...
        it('should display category count if more than one', function() {
            ...
            expect(
                accordion.contains(<span className="accordion__subtitle">2 categories</span>)
            ).to.be.true;
        });
        ...
        it('should display one tag name', function() {
            ...
            expect(
                accordion.contains(<span className="accordion__subtitle">#swawesome</span>)
            ).to.be.true;
        });
        ...
        it('should display two tag names', function() {
            ...
            expect(
                accordion.contains(
                    <span className="accordion__subtitle">#swawesome, #another one</span>
                )
            ).to.be.true;
        });
        ...
        it('should display tag count if more than two', function() {
            ...
            expect(
                accordion.contains(<span className="accordion__subtitle">3 tags</span>)
            ).to.be.true;
        });
            ...
            expect(
                accordion.contains(
                    <span className="accordion__subtitle">
                        3 categories, #swawesome, #another one
                    </span>
                )
            ).to.be.true;
        });
        ...
        it('should display category names and tag counts together', function() {
            ...
            expect(
                accordion.contains(<span className="accordion__subtitle">cat, 3 tags</span>)
            ).to.be.true;
        });
        ...
        it('should display category and tag counts together', function() {
            ...
            expect(
                accordion.contains(
                    <span className="accordion__subtitle">3 categories, 4 tags</span>
                )
            ).to.be.true;
        });
        ...
        it('should display tags with ampersands correctly', function() {
            ...
            expect(
                accordion.contains(<span className="accordion__subtitle">#a & b</span>)
            ).to.be.true;
        });
        ...
        it('should display categories with ampersands correctly', function() {
            ...
            expect(
                accordion.contains(<span className="accordion__subtitle">cats & dogs</span>)
            ).to.be.true;
        });
    });
});

...
describe('EditorCategoriesTagsAccordion', () => {
	...
	describe('categories+tags subtitle', () => {
		...
		test('should display category count if more than one', () => {
			...
			expect(accordion.contains(<span className="accordion__subtitle">2 categories</span>)).to.be
				.true;
		});
		...
		test('should display category and tag counts together', () => {
			...
			expect(accordion.contains(<span className="accordion__subtitle">3 categories, 4 tags</span>))
				.to.be.true;
		});

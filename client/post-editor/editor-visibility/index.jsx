...
export default React.createClass({
    ...
    onSetToPrivate() {
        ...
        if (this.props.type === 'page') {
            message = this.translate(
                'Private pages are only visible to administrators and editors of this site. Would you like to privately publish this page now?'
            );
        } else {
            message = this.translate(
                'Private posts are only visible to administrators and editors of this site. Would you like to privately publish this post now?'
            );
        }
    ...
    renderPasswordInput() {
        ...
        errorMessage = this.translate('Password is empty.', {
        ...
        return (
            <div>
                <FormTextInput
                    ...
                    placeholder={this.translate('Create password', {
                        ...
                        <div className="editor-visibility__dialog">
                            <FormFieldset className="editor-fieldset">
                                ...
                                <FormLabel>
                                    ...
                                    <span>
                                        {this.props.isPrivateSite
                                            ? this.translate('Visible for members of the site', {
                                ...
                                <FormLabel>
                                    ...
                                    />
                                    <span>
                                        {this.translate('Password Protected', {

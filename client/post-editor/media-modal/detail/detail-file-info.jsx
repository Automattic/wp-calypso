		...
		switch ( attribute ) {
			...
			case 'dimensions':
				value = createFragment( {
					width: (
						<abbr title={ this.props.translate( 'Width in pixels' ) }>{ this.props.item.width }</abbr>
					),
					separator: ' ✕ ',
					height: (
						<abbr title={ this.props.translate( 'Height in pixels' ) }>{ this.props.item.height }</abbr>
					),
				} );
				break;

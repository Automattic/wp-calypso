	...
	class extends React.Component {
		...
		renderDimensions = () => {
			...
			return (
				<tr>
					<th>
						{ this.props.translate( 'Dimensions' ) }
					</th>
					<td>
			...
			return (
				<table className={ classes }>
					<tbody>
						<tr>
							<th>
								{ this.props.translate( 'File Name' ) }
							</th>
						...
						<tr>
							<th>
								{ this.props.translate( 'File Type' ) }
							</th>
							<td>
						...
						<tr>
							<th>
								{ this.props.translate( 'Upload Date' ) }
							</th>
							<td>

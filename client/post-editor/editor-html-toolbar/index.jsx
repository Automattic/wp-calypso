...
export class EditorHtmlToolbar extends Component {
    ...
    setCursorPosition(previousSelectionEnd, insertedContentLength) {
        this.props.content.selectionEnd = (this.props.content.selectionStart = previousSelectionEnd +
            insertedContentLength);
    }
    ...
    onFilesDrop = () => {
        ...
        const isSingleImage = 1 === selectedItems.length &&
            'image' === MediaUtils.getMimePrefix(selectedItems[0]);
                        ...
                        <div className="editor-html-toolbar__buttons" ref={this.bindButtonsRef}>
                            ...
                            {map(buttons, ({ disabled, label, onClick }, tag) => (
                                <Button
                                    borderless
                                    className={
                                        `editor-html-toolbar__button-${tag} ${this.isTagOpen(tag) ? 'is-tag-open' : ''}`
                                    }
                                    compact
                                    disabled={disabled}
                                    key={tag}

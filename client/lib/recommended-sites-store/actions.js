...
import {
    ACTION_RECEIVE_SITE_RECOMMENDATIONS,
    ACTION_RECEIVE_SITE_RECOMMENDATIONS_ERROR,
} from './constants';
...
export function fetchMore() {
    ...
    wpcom.undocumented().fetchSiteRecommendations(
        args,
        requestTracker(ACTION_RECEIVE_SITE_RECOMMENDATIONS, function(error, data) {
            if (error) {

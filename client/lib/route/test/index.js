	...
	describe('getSiteFragment', function () {
		...
		describe('for editor paths', function () {
			...
			test('should return the site when editing a an existing custom post type', function () {
				expect(route.getSiteFragment('/edit/jetpack-portfolio/example.wordpress.com/218')).to.equal(
					'example.wordpress.com'
				);
				expect(route.getSiteFragment('/edit/jetpack-portfolio/2916284/218')).to.equal(2916284);
			});
			test('should return the site when editing a new custom post type', function () {
				...
				expect(route.getSiteFragment('/edit/jetpack-portfolio/example.wordpress.com/new')).to.equal(
					'example.wordpress.com'
				);
				expect(route.getSiteFragment('/edit/jetpack-portfolio/2916284/new')).to.equal(2916284);
			});
			test('should not return a non-safe numeric site', () => {
				expect(route.getSiteFragment('/edit/jetpack-portfolio/1000000000000000000000/new')).to.be
					.false;
			});
		});
	...
	describe('addSiteFragment', function () {
		describe('for editor paths', function () {
			...
			test('should add a site when editing a new custom post type', function () {
				expect(route.addSiteFragment('/edit/jetpack-portfolio', 'example.wordpress.com')).to.equal(
			...
			test('should replace the site when editing a new post', function () {
				...
				expect(route.addSiteFragment('/post/106782956/new', 2916284)).to.equal('/post/2916284/new');
			});
			test('should replace the site when editing a new page', function () {
				...
				expect(route.addSiteFragment('/page/106782956/new', 2916284)).to.equal('/page/2916284/new');
			});
			test('should replace the site when editing a new custom post type', function () {
				...
				expect(route.addSiteFragment('/edit/jetpack-portfolio/106782956/new', 2916284)).to.equal(
					'/edit/jetpack-portfolio/2916284/new'
				);
			});
			...
			test('should replace the site when editing an existing post', function () {
				...
				expect(route.addSiteFragment('/post/106782956/231', 2916284)).to.equal('/post/2916284/231');
			});
			test('should replace the site when editing an existing page', function () {
				...
				expect(route.addSiteFragment('/page/106782956/29', 2916284)).to.equal('/page/2916284/29');
			});
		...
		describe('for listing paths', function () {
			...
			test('should append the site when viewing posts with a filter', function () {
				...
				expect(route.addSiteFragment('/posts/drafts', 2916284)).to.equal('/posts/drafts/2916284');
			});
			...
			test('should append the site when viewing pages with a filter', function () {
				...
				expect(route.addSiteFragment('/pages/drafts', 2916284)).to.equal('/pages/drafts/2916284');
			});
		});
		describe('for stats paths', function () {

...
describe('store', function() {
    ...
    it('should revert the delivery frequency of an existing subscription when there is an API error', function() {
        ...
        expect(
            PostEmailSubscriptionStore.getSubscription(blogId).get('delivery_frequency')
        ).to.equal(24);
    });
    ...
    it('should pick up email subscriptions from feed subscription data', function() {
        ...
        expect(PostEmailSubscriptionStore.getSubscription(123987).get('delivery_frequency')).to.eq(
            'daily'
        );
    });

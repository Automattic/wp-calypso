...
function getCombination(translateArg) {
    return (translateArg.numberOfSites > 1 ? 'n sites' : '1 site') +
        ' ' +
...
module.exports = {
    ...
    showNotification() {
        ...
        if (logNotices.completed.length > 0 && logNotices.errors.length > 0) {
            ...
            notices.success(
                this.getMessage(logNotices.completed, this.successMessage, 'completed'),
                {
        ...
        switch (action) {
            case 'INSTALL_PLUGIN':
                ...
                switch (combination) {
                    case '1 site 1 plugin':
                        return i18n.translate(
                            'Successfully installed and activated %(plugin)s on %(site)s.',
                            {
                                args: translateArg,
                            }
                        );
            ...
            case 'REMOVE_PLUGIN':
                switch (combination) {
                    ...
                    case 'n sites 1 plugin':
                        return i18n.translate(
                            'Successfully removed %(plugin)s on %(numberOfSites)d sites.',
                            {
                                args: translateArg,
                            }
                        );
            ...
            case 'UPDATE_PLUGIN':
                switch (combination) {
                    ...
                    case 'n sites 1 plugin':
                        return i18n.translate(
                            'Successfully updated %(plugin)s on %(numberOfSites)d sites.',
                            {
                                args: translateArg,
                            }
                        );
            ...
            case 'ENABLE_AUTOUPDATE_PLUGIN':
                switch (combination) {
                    case '1 site 1 plugin':
                        return i18n.translate(
                            'Successfully enabled autoupdates for %(plugin)s on %(site)s.',
                            {
                                args: translateArg,
                            }
                        );
        ...
        switch (action) {
            case 'INSTALL_PLUGIN':
                switch (combination) {
                    ...
                    case '1 site n plugins':
                        return i18n.translate(
                            'Installing %(numberOfPlugins)d plugins on %(site)s.',
                            {
                                context: 'In progress message',
                                args: translateArg,
                            }
            ...
            case 'REMOVE_PLUGIN':
                switch (combination) {
                    case '1 site 1 plugin':
                        return i18n.translate('Removing %(plugin)s on %(site)s.', {
                            args: translateArg,
                        });
                    case '1 site n plugins':
            ...
            case 'ACTIVATE_PLUGIN':
                switch (combination) {
                    ...
                    case '1 site n plugins':
                        return i18n.translate(
                            'Activating %(numberOfPlugins)d plugins on %(site)s.',
                            {
                                context: 'In progress message',
                                args: translateArg,
                            }
            ...
            case 'DEACTIVATE_PLUGIN':
                switch (combination) {
                    ...
                    case '1 site n plugins':
                        return i18n.translate(
                            'Deactivating %(numberOfPlugins)d plugins on %(site)s.',
                            {
                                context: 'In progress message',
                                args: translateArg,
                            }
                    ...
                    case 'n sites 1 plugin':
                        return i18n.translate(
                            'Deactivating %(plugin)s on %(numberOfSites)d sites.',
                            {
                                context: 'In progress message',
                                args: translateArg,
                            }
        ...
        switch (action) {
            case 'INSTALL_PLUGIN':
                switch (sampleLog.error.error) {
                    ...
                    default:
                        ...
                        return i18n.translate(
                            'An error occurred while installing %(plugin)s on %(site)s.',
                            {
                                args: translateArg,
                            }
                        );
            ...
            case 'ACTIVATE_PLUGIN':
                switch (sampleLog.error.error) {
                    ...
                    default:
                        return i18n.translate(
                            'An error occurred while activating %(plugin)s on %(site)s.',
                            {
                                args: translateArg,
                            }
                        );
    ...
    getErrorHref(log) {
        ...
        let remoteManagementUrl = log.site.options.admin_url +
            'admin.php?page=jetpack&configure=json-api';
        if (versionCompare(log.site.options.jetpack_version, 3.4) >= 0) {
            remoteManagementUrl = log.site.options.admin_url +
                'admin.php?page=jetpack&configure=manage';
        }

...
test('should allow whitelisted tags', () => expect(clean('<div>👍</div>')).toBe('<div>👍</div>'));

test('should strip out non-whitelisted tags', () => expect(clean('<marquee></marquee>')).toBe(''));
...
test('should not break when no attributes present', () => expect(clean('<p></p>')).toBe('<p></p>'));

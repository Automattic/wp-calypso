...
export const userCan = function( capability, site ) {
	return site && site.capabilities && site.capabilities[ capability ];
};

export const timezone = function( site ) {
	return site && site.options ? site.options.timezone : null;
};

export const gmtOffset = function( site ) {
	return site && site.options ? site.options.gmt_offset : null;
};

export const getSiteFileModDisableReason = function( site, action = 'modifyFiles' ) {
...
export const canUpdateFiles = function( site ) {
	if ( ! site ) {
		return false;
	}
...
export const canAutoupdateFiles = function( site ) {
...
export const isMainNetworkSite = function( site ) {
	if ( ! site ) {
		return false;
	}
...
export const hasCustomDomain = function( site ) {
...
export const isModuleActive = function( site, moduleId ) {

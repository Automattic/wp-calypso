 ...
 */
var debug = require('debug')('calypso:site:jetpack'), i18n = require('i18n-calypso');
...
JetpackSite.prototype.updateComputedAttributes = function() {
    ...
    this.hasMinimumJetpackVersion = versionCompare(
        this.options.jetpack_version,
...
JetpackSite.prototype.handleError = function(error, action, plugin, module) {
    var moduleTranslationArgs = {}, buttonRemoteManagement, remoteManagementUrl;
...
JetpackSite.prototype.updateWordPress = function(onError, onSuccess) {
    this.updating = true;
    wpcom.undocumented().updateWordPressCore(
        this.ID,
        function(error, data) {
...
JetpackSite.prototype.callHome = function() {
    ...
    wpcom.undocumented().testConnectionJetpack(
        this.ID,
        function(error, data) {
            if (error) {
...
JetpackSite.prototype.fetchMonitorSettings = function(callback) {
    ...
    if (!this.fetchingMonitorSettings) {
        ...
        wpcom.undocumented().fetchMonitorSettings(
            this.ID,
            function(error, data) {
                this.set({
...
JetpackSite.prototype.updateMonitorSettings = function(
    emailNotifications,
    wpNoteNotifications,
    callback
) {
    wpcom.undocumented().updateMonitorSettings(
        this.ID,
        emailNotifications,
        wpNoteNotifications,
        function(error, data) {
...
JetpackSite.prototype.toggleSshScan = function(query, callback) {
    wpcom.undocumented().site(this.ID).sshScanToggle(
        query,
        function(error, data) {
            this.emit('change');
...
JetpackSite.prototype.fetchSshCredentials = function(callback) {
    wpcom.undocumented().site(this.ID).sshCredentialsMine(
        {},
        function(error, data) {
            this.emit('change');
...
JetpackSite.prototype.updateSshCredentials = function(query, callback) {
    wpcom.undocumented().site(this.ID).sshCredentialsNew(
        query,
        function(error, data) {
            this.emit('change');
...
JetpackSite.prototype.getOption = function(query, callback) {
    wpcom.undocumented().site(this.ID).getOption(
        query,
        function(error, data) {
            this.emit('change');
...
JetpackSite.prototype.setOption = function(query, callback) {
    ...
    wpcom.undocumented().site(this.ID).setOption(
        query,
        function(error, data) {
            this.emit('change');
...
JetpackSite.prototype.fetchJetpackKeys = function(callback) {
    wpcom.undocumented().fetchJetpackKeys(
        this.ID,
        function(error, data) {
            if (error) {

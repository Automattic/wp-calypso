...
export const getNewSiteParams = ( {
	...
	const siteGoals = signupDependencies?.segmentationSurveyAnswers?.[ 'what-are-your-goals' ];
	const onboardingSegment = signupDependencies?.onboardingSegment;
	const guidedFlowProps = {};
	if ( flowToCheck === 'guided' ) {
		guidedFlowProps.set_dev_account = setDevAccount;
		guidedFlowProps.site_goals = siteGoals;
		guidedFlowProps.onboarding_segment = onboardingSegment;
	}

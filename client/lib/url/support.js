...
export const MAP_EXISTING_DOMAIN_UPDATE_A_RECORDS = `${ root }/domains/connect-existing-domain/#connect-with-a-records`;
...
export const MAP_DOMAIN_CHANGE_NAME_SERVERS = `${ root }/domains/connect-existing-domain/#change-your-domains-name-servers`;

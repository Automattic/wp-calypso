...
// Mock config before importing isExternal to simulate the wpcalypso environment.
jest.mock( '@automattic/calypso-config', () => {
	const configMock = ( key ) => {
		const values = { env_id: 'wpcalypso', hostname: 'wpcalypso.wordpress.com' };
		return values[ key ];
	};
...
describe( 'isExternal on Calypso Live environment (wpcalypso)', () => {

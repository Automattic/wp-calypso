...
describe( 'omitUrlParams()', () => {
	...
	describe( 'when a scheme-relative URL is supplied', () => {
		describe( 'when no omitting params are supplied', () => {
			test( 'should return the URL without modification', () => {
				const url = '//example.com/path?query=banana&query2=pineapple&query3=avocado';
				const actual = omitUrlParams( url );
				const expected = '//example.com/path?query=banana&query2=pineapple&query3=avocado';
				expect( actual ).toBe( expected );
			} );
		} );
		...
		describe( 'when a single omitting param is supplied as a string', () => {
			test( 'should return the URL with that param removed', () => {
				...
				const param = 'query2';
				const actual = omitUrlParams( url, param );
				const expected = '//example.com/path?query=banana&query3=avocado';
				expect( actual ).toBe( expected );
			} );
		} );
	...
	describe( 'when a path-absolute URL is supplied', () => {
		describe( 'when no omitting params are supplied', () => {
			test( 'should return the URL without modification', () => {
				const url = '/path?query=banana&query2=pineapple&query3=avocado';
				const actual = omitUrlParams( url );
				const expected = '/path?query=banana&query2=pineapple&query3=avocado';
				expect( actual ).toBe( expected );
			} );
		} );
		...
		describe( 'when a single omitting param is supplied as a string', () => {
			test( 'should return the URL with that param removed', () => {
				...
				const param = 'query2';
				const actual = omitUrlParams( url, param );
				const expected = '/path?query=banana&query3=avocado';
				expect( actual ).toBe( expected );
			} );
		} );
	...
	describe( 'when a path-relative URL with nothing but params is supplied', () => {
		describe( 'when no omitting params are supplied', () => {
			test( 'should return the URL without modification', () => {
				const url = '?query=banana&query2=pineapple&query3=avocado';
				const actual = omitUrlParams( url );
				const expected = '?query=banana&query2=pineapple&query3=avocado';
				expect( actual ).toBe( expected );
			} );
		} );
		...
		describe( 'when a single omitting param is supplied as a string', () => {
			test( 'should return the URL with that param removed', () => {
				...
				const param = 'query2';
				const actual = omitUrlParams( url, param );
				const expected = '?query=banana&query3=avocado';
				expect( actual ).toBe( expected );
			} );
		} );

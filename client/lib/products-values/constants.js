...
export const JETPACK_BACKUP_PRODUCT_DAILY_TAG_LINE = translate(
	'Your data is being securely backed up every day with a 30-day archive.'
);
export const JETPACK_BACKUP_PRODUCT_REALTIME_TAG_LINE = translate(
	'Your data is being securely backed up as you edit.'
);

export const JETPACK_BACKUP_PRODUCT_TAG_LINES = {
	[ PRODUCT_JETPACK_BACKUP_DAILY ]: JETPACK_BACKUP_PRODUCT_DAILY_TAG_LINE,
	[ PRODUCT_JETPACK_BACKUP_DAILY_MONTHLY ]: JETPACK_BACKUP_PRODUCT_DAILY_TAG_LINE,
	[ PRODUCT_JETPACK_BACKUP_REALTIME ]: JETPACK_BACKUP_PRODUCT_REALTIME_TAG_LINE,
	[ PRODUCT_JETPACK_BACKUP_REALTIME_MONTHLY ]: JETPACK_BACKUP_PRODUCT_REALTIME_TAG_LINE,
};

export const JETPACK_PRODUCT_TAG_LINES = {
	...JETPACK_BACKUP_PRODUCT_TAG_LINES,
};

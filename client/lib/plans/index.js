...
export const chooseDefaultCustomerType = ( { currentCustomerType, selectedPlan, sitePlan } ) => {
	...
	if ( selectedPlan ) {
		...
		const isPlanInBusinessGroup = businessPlanSlugs.indexOf( sitePlan.product_slug ) !== -1;

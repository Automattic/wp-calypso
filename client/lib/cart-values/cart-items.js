 ...
 * @param  {Object} domainObject - an object generated by the domainItem function
 * @return {boolean} true if the domainItem supports privacy
 */
export function supportsPrivacyPurchase( domainObject ) {
	return get( domainObject, 'supports_domain_privacy_purchase', false );
}
...
export function domainRegistration( properties ) {
	return assign( domainItem( properties.productSlug, properties.domain, properties.source ), {
		...
		supports_domain_privacy_purchase: properties.supportsPrivacy || false,

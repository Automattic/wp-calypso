...
describe('isDomainBeingUsedForPlan()', () => {
	...
	[
		...
		test(`should return true for ${product_slug} plan and .com domain`, () => {
			expect(isDomainBeingUsedForPlan(buildCartWithDomain(product_slug), 'domain.com')).toBe(true);
		});
	});
	...
	[
		...
		test(`should return true for ${product_slug} plan and .blog domain`, () => {
			expect(
				isDomainBeingUsedForPlan(buildCartWithDomain(product_slug, 'domain.blog'), 'domain.blog')
			).toBe(true);
		});
	});
	...
	[PLAN_BLOGGER, PLAN_BLOGGER_2_YEARS].forEach((product_slug) => {
		test(`should return false for ${product_slug} plan and .com domain`, () => {
			expect(isDomainBeingUsedForPlan(buildCartWithDomain(product_slug), 'domain.com')).toBe(false);
		});
	});
...
describe('isNextDomainFree()', () => {
	...
	test('should return true when cart.next_domain_is_free, next_domain_condition is empty and no domain is passed', () => {
		expect(isNextDomainFree({ next_domain_is_free: true, next_domain_condition: '' })).toBe(true);
	});
	...
	test('should return true when cart.next_domain_is_free is true, but condition is "blog" and requested domain is .blog', () => {
		expect(
			isNextDomainFree({ next_domain_is_free: true, next_domain_condition: 'blog' }, 'domain.blog')
		).toBe(true);
	});
...
describe('hasToUpgradeToPayForADomain()', () => {
	...
	test('should return true if blogger plan is in the cart, and adding a non .blog domain', () => {
		expect(
			hasToUpgradeToPayForADomain({}, { products: [{ product_slug: PLAN_BLOGGER }] }, 'domain.com')
		).toBe(true);
	});
...
describe('getRenewalItemFromProduct()', () => {
	...
	describe('isSiteRedirect', () => {
		test('should return the corresponding renewal item', () => {
			expect(
				getRenewalItemFromProduct(buildPurchase({ product_slug: 'offsite_redirect' }), properties)
			).toEqual({
				extra: {
					includedDomain: 'included.com',
					purchaseDomain: 'purchased.com',
	...
	describe('isUnlimitedSpace', () => {
		test('should return the corresponding renewal item', () => {
			expect(
				getRenewalItemFromProduct(buildPurchase({ product_slug: 'unlimited_space' }), properties)
			).toEqual({
				extra: {
					includedDomain: 'included.com',
					purchaseDomain: 'purchased.com',
	...
	describe('isUnlimitedThemes', () => {
		test('should return the corresponding renewal item', () => {
			expect(
				getRenewalItemFromProduct(buildPurchase({ product_slug: 'unlimited_themes' }), properties)
			).toEqual({
				extra: {
					includedDomain: 'included.com',
					purchaseDomain: 'purchased.com',
	...
	describe('isSpaceUpgrade', () => {
		test('should return the corresponding renewal item', () => {
			expect(
				getRenewalItemFromProduct(buildPurchase({ product_slug: '1gb_space_upgrade' }), properties)
			).toEqual({
				extra: {
					includedDomain: 'included.com',
					purchaseDomain: 'purchased.com',

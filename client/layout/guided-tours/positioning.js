...
export const query = selector => [].slice.call(global.window.document.querySelectorAll(selector));
...
export function getStepPosition(
    { placement = 'center', targetSlug, shouldScrollTo = false, scrollContainer = null }
) {
    const target = targetForSlug(targetSlug);

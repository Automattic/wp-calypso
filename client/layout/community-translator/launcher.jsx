	...
	toggleSelectedDeliverableTarget = () => {
		this.setState(
			...
			() => {
				...
				document.body.classList.toggle('has-deliverable-highlighted', hasSelectedDeliverableTarget);
	...
	renderConfirmationModal() {
		...
		return (
			...
			>
				...
				<p>
					{translate('You have now enabled the translator. Right click the text to translate it.')}
				</p>
				<p>

...
class FeedHeader extends Component {
	...
	markAsSeen = () => {
		this.props.requestMarkAllAsSeen( { section: this.props.streamKey, isStream: true } );
	};

	markAsUnseen = () => {
		this.props.requestMarkAllAsUnseen( { section: this.props.streamKey, isStream: true } );
	};
					...
					<div className="reader-feed-header__follow">
						...
						<div className="reader-feed-header__follow-and-settings">
							...
							{ config.isEnabled( 'reader/seen-posts' ) && streamKey && hasUnseen && (
								<button onClick={ this.markAsSeen } ref={ this.spanRef }>
									<Gridicon icon="not-visible" size={ 18 } ref={ this.iconRef } />
							...
							{ config.isEnabled( 'reader/seen-posts' ) && streamKey && ! hasUnseen && (
								<button onClick={ this.markAsUnseen } ref={ this.spanRef }>
									<Gridicon icon="visible" size={ 18 } ref={ this.iconRef } />

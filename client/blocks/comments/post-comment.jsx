...
class PostComment extends React.Component {
    ...
    renderRepliesList() {
        const commentChildrenIds = this.props.commentsTree
            .getIn([this.props.commentId, 'children'])
            .toJS();
    ...
    render() {
        ...
        const haveReplyWithError = commentsTree
            .getIn([this.props.commentId, 'children'])
            .some(
                childId =>
                    commentsTree.getIn([childId, 'data', 'placeholderState']) ===
                    PLACEHOLDER_STATE.ERROR
            );

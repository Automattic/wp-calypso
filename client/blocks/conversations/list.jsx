...
export class ConversationCommentList extends React.Component {
	...
	getParentId = (commentsTree, childId) => get(commentsTree, [childId, 'data', 'parent', 'ID']);
	...
	getCommentsToShow = () => {
		...
		const parentIds = compact(map(startingCommentIds, (id) => this.getParentId(commentsTree, id)));

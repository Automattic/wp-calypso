		...
		describe('not sticky', () => {
			...
			describe('future', () => {
				describe('showAll', () => {
					test('should render the primary components', () => {
						const PostStatusComponent = (
							<PostStatus post={{ sticky: false, status: 'future' }} showAll translate={identity} />
						);
						const wrapper = shallow(PostStatusComponent);
			...
			describe('trash', () => {
				describe('showAll', () => {
					test('should render the primary components', () => {
						const PostStatusComponent = (
							<PostStatus post={{ sticky: false, status: 'trash' }} showAll translate={identity} />
						);
						const wrapper = shallow(PostStatusComponent);
			...
			describe('draft', () => {
				describe('showAll', () => {
					test('should render the primary components', () => {
						const PostStatusComponent = (
							<PostStatus post={{ sticky: false, status: 'draft' }} showAll translate={identity} />
						);
						const wrapper = shallow(PostStatusComponent);

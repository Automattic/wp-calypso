...
const SignupFormSocialFirst = ( {
	...
	const isPasswordlessJetpackConnection = useSelector( isPasswordlessJetpackConnectionFlow );
	const isWoo = isWooOAuth2Client( oauth2Client ) || isPasswordlessJetpackConnection;

...
export function SmallPostCard({ post, site, onPostClick = noop, onSiteClick = noop }) {
    ...
    const thumbnailUrl = post.canonical_image &&
        resizeImageUrl(safeImageUrl(post.canonical_image.uri), { resize: '96,72' });
        ...
        <Card className={classes}>
            <div className="reader-related-card__site-info-title">
                <h1 className="reader-related-card__title">
                    <a
                        className="reader-related-card__anchor"
                        href={`/read/blogs/${post.site_ID}/posts/${post.ID}`}

...
const contextLinksForSection = {
	...
	'settings-discussion': [
		...
		{
			link: localizeUrl('https://wordpress.com/support/enable-disable-comments-for-future-posts/'),
			post_id: 5997,
...
const videosForSection = {
	...
	'post-editor': [
		...
		},
		{
			...
			description: translate('Find out how to add a payment button to your WordPress.com website.'),
		},
	],
	account: [
		{
	...
	customizer: [
		...
		},
		{
			...
			description: translate('Find out how to add a custom background to your WordPress.com site.'),
		},
		{
			type: RESULT_VIDEO,

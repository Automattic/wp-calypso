...
const SimpleForm = ( { initialValues, onSubmit, referer }: Props ) => {
	...
	return (
		<Form
			...
			description={ preventWidows(
				translate(
					...
					{
						components: {
							span: <span className="signup-form-v2__a4a-span" />,
						},
					}
				)
			) }
		>
			...
			<div className="signup-form-v2__name-fields">
				<FormField
			...
			{ ! isUserSiteOwner ? (
				<>
					...
					<div className="signup-form-v2__address-fields">
						<FormField
					...
					<FormPhoneInput
						...
						className="signup-form-v2__phone-input"
						phoneInputProps={ {
					...
					<div className="signup-form-v2__tos">
						<p>
							{ translate(
								"By clicking 'Continue', you agree to the{{break}}{{/break}}{{link}}Terms of the Automattic for Agencies Platform Agreement ↗{{/link}}",
								{
									components: {
										...
										link: (
											<button
												type="button"
												className="signup-form-v2__tos-link"

...
export function useFormSelectors() {
	...
	const availableBusinessTypes: Record< string, string > = {
		...
		content_blog_media: translate( 'Content / blog / media' ),
		nonprofit_community: translate( 'Non-profit / community' ),
		other: translate( 'Other' ),
	};

	const availableCompanySizes: Record< string, string > = {
		'1_5': translate( '1–5: Small teams needing hands-on help and simple processes' ),
		'6_50': translate( '6–50: Small businesses wanting cost-efficient support and execution' ),
		'51_250': translate( '51–250: Mid-size orgs with multiple stakeholders and reporting needs' ),
		'251_1000': translate(
	...
	const availableHostingEnvironments: Record< string, string > = {
		...
		managed_wordpress: translate( 'Managed WordPress hosts (WP Engine, Kinsta, etc.)' ),
	};
	...
	const availableMigrationPlatforms: Record< string, string > = {
		...
		webflow: 'Webflow',
		other: translate( 'Other website builders / e-commerce platforms / custom platforms' ),
	};
	...
	const availableStoreComplexities: Record< string, string > = {
		...
		subscriptions: translate( 'Subscriptions or memberships' ),
	...
	const availableProjectTypes: Record< string, string > = {
		...
		maintenance: translate( 'Fix problems / maintenance / ongoing support' ),
		performance: translate( 'Performance / speed optimization' ),
	...
	const availableTimingPreferences: Record< string, string > = {
		...
		next_month: translate( 'Prefer to start within the next month' ),
		'1_3_months': translate( 'Prefer to book 1–3 months in advance' ),
	...
	const availableDecisionProcesses: Record< string, string > = {
		...
		procurement: translate( 'Formal procurement / enterprise purchasing' ),
	};

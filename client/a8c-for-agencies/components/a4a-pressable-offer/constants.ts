...
export const PRESSABLE_Q3_2026_OFFER_END_DATE = '2026-09-30';
export const PRESSABLE_Q3_2026_OFFER_DEADLINE = new Date(
	`${ PRESSABLE_Q3_2026_OFFER_END_DATE }T23:59:59.999Z`
);

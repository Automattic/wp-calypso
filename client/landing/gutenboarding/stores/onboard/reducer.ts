...
const selectedSite: Reducer<number | undefined, OnboardAction> = (state = undefined, action) => {
...
const selectedFonts: Reducer<FontPair | undefined, OnboardAction> = (state = undefined, action) => {

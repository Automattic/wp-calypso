					...
					},
					{
						...
						description: (
							<p>
								{ isEnglishLocale ||
								hasTranslation(
									"Review your payment and contact details. If you're transferring a domain from Google, we'll pay for an additional year of registration if your domain is registered before July 1, 2023."
								)
									? __(
											"Review your payment and contact details. If you're transferring a domain from Google, we'll pay for an additional year of registration if your domain is registered before July 1, 2023."
									  )

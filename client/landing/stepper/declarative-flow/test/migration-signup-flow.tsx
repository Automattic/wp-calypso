	...
	describe( 'useAssertConditions', () => {
		it( 'redirects the user to the login page when they are not logged in', () => {
			...
			expect( window.location.assign ).toHaveBeenCalledWith(
				`/start/account/user-social?variationName=migration-signup&redirect_to=%2Fsetup%2Fmigration-signup&toStepper=true&vid=vid321&aff=aff123&ref=logged-out-homepage`
			);
		} );
		...
		it( 'redirects the user to the login page with the correct locale when they are not logged in', () => {
			...
			expect( window.location.assign ).toHaveBeenCalledWith(
				`/start/account/user-social/fr?variationName=migration-signup&redirect_to=%2Fsetup%2Fmigration-signup%3Flocale%3Dfr&toStepper=true&vid=vid321&aff=aff123&ref=logged-out-homepage`
			);
		} );
	} );

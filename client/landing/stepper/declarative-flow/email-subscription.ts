...
import { EMAIL_SUBSCRIPTION_FLOW } from '@automattic/onboarding';
// import { EMAIL_SUBSCRIPTION_FLOW, addProductsToCart } from '@automattic/onboarding';
...
const HundredYearPlanFlow: Flow = {
	name: EMAIL_SUBSCRIPTION_FLOW,
	get title() {
		return translate( 'Email Subscription' );
	},
	isSignupFlow: true,
	useSteps() {

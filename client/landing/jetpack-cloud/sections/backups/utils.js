...
export const getMetaDiffForDailyBackup = (logs, date) => {
	...
	const thisMeta = metaStringToObject(thisBackup.complete[0].activityDescription[2].children[0]);

	const lastMeta = metaStringToObject(lastBackup.complete[0].activityDescription[2].children[0]);

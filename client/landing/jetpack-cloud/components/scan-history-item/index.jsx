		...
		return (
			<>
				<div className="scan-history-item__subheader">
					...
					<span
						className={classnames('scan-history-item__date', this.entryActionClassNames(entry))}
					>
				...
				<Badge
					className={classnames('scan-history-item__badge', this.entryActionClassNames(entry))}
				>

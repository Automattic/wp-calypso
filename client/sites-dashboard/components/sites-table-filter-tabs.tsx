...
import type { SiteExcerptData } from 'calypso/state/ui/selectors/site-data'; // eslint-disable-line no-restricted-imports

interface SitesTableFilterTabsProps {
	allSites: SiteExcerptData[];
	children( filteredSites: SiteExcerptData[] ): JSX.Element;
	className?: string;
	launchStatus?: string;
}

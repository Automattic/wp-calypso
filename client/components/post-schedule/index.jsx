...
class PostSchedule extends Component {
	...
	getDateToUserLocation(date) {
		return convertDateToUserLocation(date || new Date(), this.props.timezone, this.props.gmtOffset);
	}
	...
	updateDate = (date) => {
		const convertedDate = convertDateToGivenOffset(date, this.props.timezone, this.props.gmtOffset);

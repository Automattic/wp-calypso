...
function NavigationLink({ direction, text, href, onClick }) {
	...
	const linkText = text || (direction === 'back' ? translate('Back') : translate('Skip for now'));

	return (
		<Button compact borderless className="wizard__navigation-link" href={href} onClick={onClick}>

...
export default class InfiniteList extends React.Component {
  ...
  onScroll = () => {
    ...
    if (
      !this.scrollRAFHandle &&
      this.getCurrentScrollTop() !== this.lastScrollTop
    ) {
  ...
  render() {
    ...
    if (
      lastRenderedIndex === -1 ||
      lastRenderedIndex > this.props.items.length - 1
    ) {
      debug(
    ...
    if (this.props.fetchingNextPage) {
      itemsToRender = itemsToRender.concat(
        this.props.renderLoadingPlaceholders()
      );
    }

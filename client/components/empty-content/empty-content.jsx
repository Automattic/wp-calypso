...
module.exports = React.createClass({
    ...
    propTypes: {
        ...
        line: React.PropTypes.oneOfType([React.PropTypes.string, React.PropTypes.array]),
        action: React.PropTypes.oneOfType([React.PropTypes.string, React.PropTypes.element]),

...
function WordPressLogo( { className = 'wordpress-logo', size = 72, ...props } ) {
	const classnames = classNames( 'wordpress-logo', className );
	return (
		<svg className={ classnames } height={ size } width={ size } viewBox="0 0 72 72">
			<path

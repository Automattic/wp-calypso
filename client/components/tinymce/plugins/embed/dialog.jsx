...
export class EmbedDialog extends React.Component {
  ...
  componentWillMount() {
     ...
     */
    this.debouncedFetchEmbedPreviewMarkup = debounce(
      this.fetchEmbedPreviewMarkup,
      500
    );
      ...
      if (headers && headers.status === 0) {
        error = {
          ...
          message: this.props.translate(
            "Connection issue. Please reload the page and try again"
          )
        };
    ...
    switch (errorObj.error) {
      case "invalid_embed_url":
        return this.props.translate(
          "The Embed URL parameter must be a valid URL."
        );
      default:
  ...
  render() {
    ...
    const cachedMarkup = isURLInCache

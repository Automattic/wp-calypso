  ...
  render() {
    ...
    return (
      <div className="editor-contact-form-modal-settings">
        <SectionHeader
          label={this.props.translate("Contact Form Notification Settings")}
        />
        <Card>
          <p>
          ...
          <FormFieldset>
            <FormLabel>
              {this.props.translate("Enter your email address")}
            </FormLabel>
            <FormTextInput
              value={this.props.to}
          ...
          <FormFieldset>
            <FormLabel>
              {this.props.translate("What should the subject line be?")}
            </FormLabel>
            <FormTextInput

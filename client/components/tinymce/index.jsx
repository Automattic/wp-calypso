...
export default class extends React.Component {
  ...
  componentDidMount() {
    ...
    const setup = function(editor) {
      ...
      editor.on("SetTextAreaContent", event =>
        this.setTextAreaContent(event.content)
      );
      editor.once(
        "PostRender",
    ...
    tinymce.init({
      ...
      autoresize_min_height: Math.max(
      ...
      body_class:
        "content post-type-post post-status-draft post-format-standard locale-en-us",

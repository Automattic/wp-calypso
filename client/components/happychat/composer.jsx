 ...
 */
import { updateChatMessage, sendChatMessage } from 'state/happychat/actions';
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                <button className="happychat__submit" onClick={sendMessage}>

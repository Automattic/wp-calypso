 ...
 */
import { first, any, when } from './functional';
...
import { isHappychatMinimizing } from 'state/ui/happychat/selectors';
import { isConnected, isConnecting, timeline, composer } from './helpers';
 ...
 */
const title = first(when(isConnected, connectedTitle), when(isConnecting, connectingTitle), ({
    onOpenChat,
}) => {

/**
 * A high-order component that prevents scrolling events triggered by the mousewheel from moving scrollable containers
...
const withScrollbleed = ( WrappedComponent ) => {
	class Scrollbleed extends React.Component {
		static displayName = `withScrollbleed(${
		...
		render() {
			return (
				<WrappedComponent
					...
					setScrollbleedTarget={ this.setScrollbleedTarget }
				/>
			);
		}
	}
...
export default withScrollbleed;

...
export class WebPreviewContent extends Component {
  ...
  setDeviceViewport = (device = "computer") => {
    ...
    this.props.recordTracksEvent("calypso_web_preview_select_viewport_device", {
      device
    });
    ...
    return (
      <div className={className} ref={this.setWrapperElement}>
        <Toolbar
          ...
          showDeviceSwitcher={
            this.props.showDeviceSwitcher && isWithinBreakpoint(">660px")
          }
        ...
        <div className="web-preview__placeholder">
          ...
          <div
            ...
            style={{
              display: "seo" === this.state.device ? "none" : "inherit"
            }}
          >
            <iframe

...
export default class FollowersData extends Component {
  ...
  componentDidMount() {
    ...
    this._poller = pollers.add(
      FollowersStore,
      FollowersActions.fetchFollowers.bind(
        FollowersActions,
  ...
  isFetching = () => {
    ...
    const followersPaginationData = FollowersStore.getPaginationData(
      fetchOptions
    );
    debug(
  ...
  refreshFollowers = fetchOptions => {
    ...
    this.setState({
      ...
      totalFollowers: FollowersStore.getPaginationData(fetchOptions)
        .totalFollowers,
      currentPage: FollowersStore.getPaginationData(fetchOptions)

...
export default class EmailFollowersData extends Component {
  ...
  fetchIfEmpty = fetchOptions => {
    ...
    const defer = function() {
      const paginationData = EmailFollowersStore.getPaginationData(
        fetchOptions
      );
  ...
  isFetching = () => {
    ...
    const followersPaginationData = EmailFollowersStore.getPaginationData(
      fetchOptions
    );
    debug(
      "Followers pagination data: " + JSON.stringify(followersPaginationData)
    );
  ...
  refreshFollowers = fetchOptions => {
    ...
    this.setState({
      ...
      totalFollowers: EmailFollowersStore.getPaginationData(fetchOptions)
        .totalFollowers,
      currentPage: EmailFollowersStore.getPaginationData(fetchOptions)

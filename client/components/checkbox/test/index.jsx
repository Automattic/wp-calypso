...
describe( 'Checkbox', function() {
	describe( 'Rendering ', function() {
		...
		it( 'should render Gridicon when checked', function() {
			const checkbox = shallow( <Checkbox checked={ true } /> );
		...
		it( 'should render custom classes properly', function() {
			const checkbox = shallow( <Checkbox className="foo" checked={ true } /> );
		...
		it( 'should render disabled if true', function() {
			const checkbox = shallow( <Checkbox disabled={ true } checked={ true } /> );
	...
	describe( 'Events', function() {
		it('should pass change events', function() {
			...
			const checkbox = shallow( <Checkbox checked={ false } onChange={ onChange } /> );

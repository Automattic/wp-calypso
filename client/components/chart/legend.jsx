            ...
            <li className="chart__legend-option">
                ...
                >
                    <input
                        ...
                        onChange={function() {}}
                    />
                    <span className={this.props.className} />{this.props.label}
                </label>
            </li>
        );
    },
...
const Legend = React.createClass({
    ...
    render: function() {
        const legendColors = ['chart__legend-color is-dark-blue'], activeTab = this.props.activeTab;

        const legendItems = this.props.availableCharts.map(
            function(legendItem, index) {

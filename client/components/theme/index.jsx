...
export class Theme extends Component {
  ...
  render() {
    ...
    const themeClass = classNames("theme", {
      "is-active": active,
      "is-actionable": !!(
        this.props.screenshotClickUrl || this.props.onScreenshotClick
      )
    });
    ...
    const screenshotID =
      this.props.index === 0 ? "theme__firstscreenshot" : null;
    ...
    const upsellPopupEventProperties = {
      cta_name: "theme-upsell-popup",
      theme: theme.id
    };
        ...
        >
          ...
          <div className="theme__upsell-popover">
            <h2 className="theme__upsell-heading">
              {translate(
                "Use this theme at no extra cost on our Premium or Business Plan"
              )}
            </h2>
            <Button

...
describe("Theme", () => {
  ...
  beforeEach(() => {
    props = {
      ...
      buttonContents: {
        dummyAction: { label: "Dummy action", action: sinon.spy() }
      }, // TODO: test if called when clicked
      translate: identity
    };
  });
  ...
  describe("rendering", () => {
    describe("with default display buttonContents", () => {
      ...
      test('should render a <div> with a className of "theme"', () => {
        ...
        assert(
          themeNode.getElementsByTagName("h2")[0].textContent ===
            "Twenty Seventeen"
        );
      });
      ...
      test("should call onScreenshotClick() on click on screenshot", () => {
        ...
        assert(
          props.onScreenshotClick.calledOnce,
      ...
      test("should render a More button", () => {
        ...
        assert(
          more[0].getElementsByTagName("button").length === 1,
  ...
  describe("when the theme has a price", () => {
    ...
    test("should show a price", () => {
      assert(
        themeNode.getElementsByClassName("theme__badge-price")[0]
          .textContent === "$50"
      );
    });
  });

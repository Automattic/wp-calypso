 ...
 */
export const insertContent = ( textarea, before, content, after, onInsert ) => {
 ...
 * @param {Function} onInsert A function to call after the insertion.
 */
export const insertHtmlTagOpen = ( textarea, tag, onInsert = noop ) => {
 ...
 * @param {Function} onInsert A function to call after the insertion.
 */
export const insertHtmlTagClose = ( textarea, tag, onInsert = noop ) => {
	const { before, after } = splitSelectedContent( textarea );
 ...
 * @param {Function} onInsert A function to call after the insertion.
 */
export const insertHtmlTagOpenClose = ( textarea, tag, onInsert = noop ) => {
 ...
 * @param {Function} onInsert A function to call after the insertion.
 */
export const insertHtmlTagSelfClosed = ( textarea, tag, onInsert = noop ) => {
	const { before, inner, after } = splitSelectedContent( textarea );
 ...
 * @param {Function} onInsert A function to call after the insertion.
 */
export const insertHtmlTagWithText = ( textarea, tag, onInsert = noop ) => {
	const { before, after } = splitSelectedContent( textarea );
	insertContent(
		textarea,
		before,
 ...
 * @param {Function} onInsert A function to call after the insertion.
 */
export const insertCustomContent = ( textarea, content, options = {}, onInsert = noop ) => {
	const { before, inner, after } = splitSelectedContent( textarea );
 ...
 */
export const insertHtmlTag = ( textarea, tag, isTagOpen, onInsert = noop ) => {

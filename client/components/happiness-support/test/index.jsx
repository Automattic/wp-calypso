...
describe('HappinessSupport', () => {
	...
	test('should render a translated support button', () => {
		expect(wrapper.find('Button.happiness-support__support-button>span').props().children).to.equal(
	...
	test('should render a <HappychatConnection /> when showLiveChat prop is true', () => {
		wrapper = shallow(
			<HappinessSupport translate={translate} recordTracksEvent={noop} showLiveChatButton={true} />
		);

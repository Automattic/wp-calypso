...
const recordMapDomainButtonClick = section =>
	composeAnalytics(
		...
		recordTracksEvent( 'domain_search_results_mapping_button_click', { section } )
	);

const recordTransferDomainButtonClick = ( section, source ) =>
	composeAnalytics(
		recordGoogleEvent( 'Domain Search', 'Clicked "Use a Domain I own" Button' ),
		recordTracksEvent( 'domain_search_results_transfer_button_click', { section, source } )
	);
...
const recordSearchFormSubmit = ( searchBoxValue, section, timeDiffFromLastSearch, count, vendor ) =>
	composeAnalytics(
		...
		recordTracksEvent( 'domain_search', {
...
const recordSearchFormView = section =>
	composeAnalytics(
		...
		recordTracksEvent( 'domain_search_pageview', { section } )
	);
...
const recordSearchResultsReceive = (
	...
	composeAnalytics(
		...
		recordTracksEvent( 'domain_search_results_suggestions_receive', {
...
const recordDomainAvailabilityReceive = (
	...
	composeAnalytics(
		...
		recordTracksEvent( 'domain_search_results_availability_receive', {
			search_query: searchQuery,

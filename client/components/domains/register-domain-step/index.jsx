...
class RegisterDomainStep extends React.Component {
	...
	componentDidMount() {
		if (this.state.lastQuery && !this.state.searchResults && !this.state.subdomainSearchResults) {
	...
	getActiveFiltersForAPI() {
		...
		return mapKeys(
			pickBy(filters, (value) => isNumberString(value) || value === true || Array.isArray(value)),
	...
	showNextPage = () => {
		...
		this.props.recordShowMoreResults(this.state.lastQuery, pageNumber, this.props.analyticsSection);

...
const RegisterDomainStep = React.createClass({
    ...
    componentWillMount: function() {
        ...
        if (this.props.initialState) {
            ...
            if (
                state.lastSurveyVertical && state.lastSurveyVertical !== this.props.surveyVertical
            ) {
                ...
                callback => {
                    ...
                    domains
                        ...
                        .then(domainSuggestions => {
                            this.props.onDomainsAvailabilityChange(true);
                            const timeDiff = Date.now() - timestamp,
                                analyticsResults = domainSuggestions.map(
    ...
    initialSuggestions: function() {
        ...
        if (this.isLoadingSuggestions()) {
            ...
            domainRegistrationSuggestions = suggestions.map(
                function(suggestion) {
                    return (
    ...
    allSearchResults: function() {
        const { lastDomainSearched, lastDomainStatus } = this.state,
            ...
            availableDomain = lastDomainStatus === domainAvailability.AVAILABLE &&

...
const ciraAgreementUrl =
  "https://services.cira.ca/agree/agreement/agreementVersion2.0.jsp";
const defaultValues = {
  lang: "EN",
  legalType: "CCT",
...
export class RegistrantExtraInfoCaForm extends React.PureComponent {
  ...
  render() {
    ...
    const formIsValid =
      ciraAgreementAccepted && this.organizationFieldIsValid();
    const validatingSubmitButton = formIsValid
      ? children
      : disableSubmitButton(children);
      ...
      <form className="registrant-extra-info__form">
        ...
        <FormFieldset>
          <FormLabel htmlFor="legal-type">
            {translate(
              "Choose the option that best describes your Canadian presence:"
            )}
          </FormLabel>
          <FormSelect
            id="legal-type"
        ...
        <FormFieldset>
          ...
          <FormLabel>
            ...
            <span>
              {translate(
                "I have read and agree to the {{a}}CIRA Registrant Agreement{{/a}}",
                {
                  components: {
                    a: (
                      <a

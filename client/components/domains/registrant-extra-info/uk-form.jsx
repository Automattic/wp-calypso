  ...
  renderTradingNameField() {
    ...
    return (
      <div>
        <FormFieldset>
          <FormLabel
            className="registrant-extra-info__trading-name"
  ...
  render() {
    ...
    return (
      <form className="registrant-extra-info__form">
        ...
        {this.isTradingNameRequired(registrantType) &&
          this.renderTradingNameField()}

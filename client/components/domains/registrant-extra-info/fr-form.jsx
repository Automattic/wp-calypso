...
class RegistrantExtraInfoFrForm extends React.PureComponent {
  ...
  componentWillMount() {
    ...
    defaultRegistrantType = this.props.contactDetails.organization
      ? "organization"
      : "individual";
  ...
  renderOrganizationFields() {
    ...
    const trademarkNumberStrings = {
      maxLength: this.props.translate(
        "Too long. An EU Trademark number has 9 digits."
      ),
      oneOf: this.props.translate(
    ...
    const trademarkNumberValidationMessage = map(
      ...
      error => renderValidationError(trademarkNumberStrings[error])
    );
        ...
        <FormFieldset>
          ...
          <FormTextInput
            ...
            placeholder={translate("ex. 123 456 789 or 123 456 789 01234", {
              comment:
                'ex is short for "example". The numbers are examples of the EU VAT format'
            })}
            autoCapitalize="off"
            autoComplete="off"
            autoCorrect="off"
        ...
        <FormFieldset>
          ...
          <FormTextInput
            ...
            placeholder={translate("ex. 012345678", {
              comment:
                "ex is short for example. The number is the EU trademark number format."
            })}

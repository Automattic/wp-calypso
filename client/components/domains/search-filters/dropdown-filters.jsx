...
export class DropdownFilters extends Component {
  ...
  renderPopover() {
    ...
    const isDashesFilterEnabled = config.isEnabled(
      "domains/kracken-ui/dashes-filter"
    );
    const isExactMatchFilterEnabled = config.isEnabled(
      "domains/kracken-ui/exact-match-filter"
    );
    const isLengthFilterEnabled = config.isEnabled(
      ...
      >
        {isLengthFilterEnabled && (
          ...
          >
            <FormLabel
              ...
              htmlFor="search-filters-max-characters"
            >
        ...
        <FormFieldset className="search-filters__checkboxes-fieldset">
          ...
          {isDashesFilterEnabled && (
            <FormLabel
              className="search-filters__label"
              htmlFor="search-filters-include-dashes"
            >
              <FormInputCheckbox
                className="search-filters__checkbox"
        ...
        >
          <div className="search-filters__buttons">
            <Button onClick={this.handleFiltersReset}>
              {translate("Reset")}
            </Button>

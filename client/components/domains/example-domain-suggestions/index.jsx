		...
		return (
			<div className="example-domain-suggestions">
				<p className="example-domain-suggestions__explanation">
					{ this.translate( 'A domain name is what people type into their browser to visit your site.' ) }
				</p>
				<p className="example-domain-suggestions__mapping-information">
					<a onClick={ this.handleClickMappingLink } href={ this.props.mapDomainUrl }>

...
import { getAvailabilityNoticeForTransfers } from 'lib/domains/registration/availability-messages';
			...
			( error, result ) => {
				...
				switch ( status ) {
					...
					default:
						...
						const { message, severity } = getAvailabilityNoticeForTransfers(
							domain,
							status,
							site,
							rootDomain,
							mappableStatus,
							this.goToMapDomainStep
						);

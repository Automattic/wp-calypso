...
class TrademarkClaim extends React.Component {
	...
	renderGoodsAndServices = (claim) => {
		...
		return (
			goodsAndServices &&
			this.renderItem('goods-and-services', 'Goods and Services', this.renderList(goodsAndServices))
		);
	};
	...
	renderRegistrant = (claim) => {
		...
		return (
			holder && this.renderItem('holder', 'Trademark Registrant', this.renderContactInfo(holder))
		);
	};

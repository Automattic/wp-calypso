								...
								components: {
									moreInfoTooltip: (
										<InfoPopover className="cancel-purchase-form__atomic-revert-more-info">
											{ translate(
												'We automatically moved your site to a separate platform on %(atomicTransferDate)s in order to support the usage of plugins, custom themes, and hosting features. These features will no longer be supported if you deactivate your plan, so we’ll move your site back to its original platform. All the posts, pages and media added while on this platform will be preserved (with the exception of the content generated by plugins or custom themes).',
												{ args: { atomicTransferDate } }
											) }
										</InfoPopover>
									),

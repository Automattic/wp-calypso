			...
			return (
				<div className="cancel-purchase-form__atomic-revert">
					<FormattedHeader
						...
						subHeaderText={ translate(
							'After deactivating your plan, we will toggle your site to private and return it to the point when you installed your first plugin, custom theme, or activated hosting features on {{strong}}%(atomicTransferDate)s{{/strong}}. ' +
								'Your posts, pages, and media will be preserved. {{moreInfoTooltip/}}',
							{
								...
								components: {
									moreInfoTooltip: (
										<InfoPopover className="cancel-purchase-form__atomic-revert-more-info">
											{ translate(
												'We automatically moved your site to a separate platform on %(atomicTransferDate)s, to support the usage of plugins, custom themes, and hosting features. ' +
													...
													'All the posts, pages, and media added before and after %(atomicTransferDate)s, will be preserved (except for the content generated by plugins or custom themes).',
												{ args: { atomicTransferDate } }
											) }
										</InfoPopover>
									),

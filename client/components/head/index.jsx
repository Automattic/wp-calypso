...
const Head = ( { children, stylesheetUrl, title = 'WordPress.com' } ) => (
	<head>
		...
		<link rel="shortcut icon" type="image/vnd.microsoft.icon" href={ config( 'faviconUrl' ) } sizes="16x16 32x32" />
		<link rel="shortcut icon" type="image/x-icon" href={ config( 'faviconUrl' ) } sizes="16x16 32x32" />
		<link rel="icon" type="image/x-icon" href={ config( 'faviconUrl' ) } sizes="16x16 32x32" />

...
CardHeadingExample.displayName = 'CardHeading';

export default CardHeadingExample;

export const CardHeadingPlayground =
	'<Card><CardHeading tagName="h1" size={ 24 }>This is a default CardHeading</CardHeading></Card>';

...
module.exports = {
	needsOffset: name => needsOffset( name, iconsThatNeedOffset ),
	needsOffsetX: name => needsOffset( name, iconsThatNeedOffsetX ),
	needsOffsetY: name => needsOffset( name, iconsThatNeedOffsetY ),
};

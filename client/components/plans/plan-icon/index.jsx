...
export default class PlanIcon extends Component {
	...
	getPersonalIcon() {
		const className = this.getIconClassNames( 'plan-icon__personal' );
	...
	getPremiumIcon() {
		const className = this.getIconClassNames( 'plan-icon__premium' );
	...
	getBusinessIcon() {
		const className = this.getIconClassNames( 'plan-icon__business' );
	...
	getDefaultIcon() {
		const className = this.getIconClassNames( 'plan-icon__free' );

	...
	render: function() {
		...
		switch ( icon ) {
			...
			case 'gridicons-computer':
				...
				break;
			case 'gridicons-conversation':
				svg = <svg className={ iconClass } height={ this.props.size } width={ this.props.size } onClick={ this.props.onClick } xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g transform="translate(0 2)"><path d="M12,0 C10.4470588,0 9,0.447058824 9,2 L9,5 L11,5 C12,5 15,6 15,8 L15,9.88235283 L18,9.88235283 L18,14 L22,9.88235283 C22.5294118,9.35294106 23,8.74823529 23,8 L23,3 C23,1.44705882 21.5529412,0 20,0 L12,0 Z"></path><path d="M11,6 C12.5529412,6 14.1176472,7.44705883 14.1176472,9 L14.1176472,12.9501176 C14.1176472,14.5030588 12.5529412,16 11,16 L6,16 L6,20 L1,15 C0.470588235,14.4705882 0,13.6983529 0,12.9501176 L0,9 C0,7.44705883 1.44705882,6 3,6 L11,6 Z"></path></g></svg>
				break;

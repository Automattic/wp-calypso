...
import FixAllThreatsDialog from 'components/jetpack-cloud/fix-all-threats-dialog';
...
import { FixableThreat, Threat, ThreatAction } from 'components/jetpack-cloud/threat-item/types';

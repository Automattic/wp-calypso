    ...
    return (
      <Card>
        <Focusable onClick={noop}>
          <p>
            This keyboard-accessible component can contain other elements as
            children, including <code>p</code>s, <code>div</code>s, or other
            components.
          </p>
        </Focusable>
        <p>
          An example of real use is in the Language Picker, which can be
          considered a "complex button."
        </p>

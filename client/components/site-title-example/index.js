		...
		<div className="site-title-example">
			...
			<div className="site-title-example__image">
				<svg width="269" height="135" viewBox="0 0 269 135" xmlns="http://www.w3.org/2000/svg">
					<title>Group</title>
					<g fill="none" fillRule="evenodd"><path fill="#E9EFF3" d="M0 24h269v111H0z" />
						...
						<text fontFamily="SFUIText-Medium, SF UI Text" fontSize="15" fontWeight="400" fill="#556875" transform="translate(-345 -213)">

...
class FormFields extends React.PureComponent {
  ...
  render() {
    return (
      <div>
        <p>
          The form fields components act as wrapper components to aid in
          componentizing CSS. Here is an example of all of the form fields
          components and their expected markup.
        </p>

        <p>
          The following form fields components are wrapped in Card components to
          demonstrate the FormSectionHeading component.
        </p>
        ...
        <Card>
          ...
          <FormFieldset>
            <FormLabel htmlFor="text_with_affixes">
            ...
            />
            <FormSettingExplanation>
              Action becomes avaliable when filled. Can be triggered by clicking
        ...
        <Card>
          ...
          <FormFieldset>
            <FormLabel htmlFor="currency_input_valid">
              Form Currency Input
            </FormLabel>
            <FormCurrencyInput
              name="currency_input"
          ...
          <FormFieldset>
            <FormLabel htmlFor="currency_input_error">
              Form Currency Input
            </FormLabel>
            <FormCurrencyInput
              name="currency_input"

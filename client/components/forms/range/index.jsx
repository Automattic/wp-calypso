...
export default class extends React.Component {
  ...
  getMinContentElement = () => {
    if (this.props.minContent) {
      return (
        <span className="range__content is-min">{this.props.minContent}</span>
      );
    }
  };
  ...
  getMaxContentElement = () => {
    if (this.props.maxContent) {
      return (
        <span className="range__content is-max">{this.props.maxContent}</span>
      );
    }
  };
    ...
    if (this.props.showValueLabel) {
      ...
      return (
        <span
          ...
          style={{ left: (left || 0) + "%", marginLeft: offset }}
        >
          <output

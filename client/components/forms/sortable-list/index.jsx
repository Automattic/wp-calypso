...
class SortableList extends React.Component {
  ...
  getCursorElementIndex = event => {
    let cursorCompare = this.compareCursorVerticalToElement(
        this.refs.list,
        event
      ),
      adjustedActiveIndex = this.getAdjustedElementIndex(
        this.state.activeIndex
      ),
      shadowRect = this.refs[
        "wrap-shadow-" + this.state.activeIndex
    ...
    index = findIndex(this.props.children, (child, i) => {
      ...
      if ("horizontal" === this.props.direction) {
        if (
          ...
          -1 === cursorCompare &&
          this.refs["wrap-" + i].getBoundingClientRect().bottom <=
            shadowRect.bottom
        ) {
    ...
    return (
      <div className="sortable-list__navigation">
        <button
          ...
          disabled={
            null === this.state.activeIndex || this.state.activeIndex === 0
          }
        >

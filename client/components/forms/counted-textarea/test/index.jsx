...
describe('index', () => {
	...
	test('should not pass acceptableLength prop to the child textarea', () => {
		...
		renderer.render(
			<CountedTextarea value={value} className="custom-class" acceptableLength={acceptableLength} />
		);
		const result = renderer.getRenderOutput();
	...
	test('should render additional panel content when set', () => {
		...
		renderer.render(
			<CountedTextarea value={value} acceptableLength={acceptableLength} showRemainingCharacters>

...
const SeoPreviewNudge = ({ translate, domain, plan = {}, businessPlan = {} }) => {
    ...
    const businessPlanPrice = formatCurrency(
        businessPlan.raw_price / 12,
        businessPlan.currency_code
    );
    const featuresToShow = businessPlanFeatures.filter(
        feature => !planHasFeature(plan.product_slug, feature)
    );
        ...
        <div className="preview-upgrade-nudge">
            ...
            <div className="preview-upgrade-nudge__features">
                ...
                <div className="preview-upgrade-nudge__features-details">
                    <p className="preview-upgrade-nudge__features-title">
                        {translate(
                            "By upgrading to a Business Plan you'll enable SEO Tools on your site."
                        )}
                    </p>
            ...
            <FeatureComparison className="preview-upgrade-nudge__feature-comparison">
                ...
                <PlanCompareCard
                    ...
                    line={translate('%(price)s per month, billed yearly', {
                        args: { price: businessPlanPrice },
                    })}

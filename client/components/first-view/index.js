...
import { disableView, enableView, hideView } from 'state/first-view/actions';
...
const FirstView = React.createClass( {
	...
	hide() {
		if( this.state.isEnabled ) {
			this.props.enableView( { view: this.props.sectionName } );
		} else {
			this.props.disableView( { view: this.props.sectionName } );
		}
		this.props.hideView( { view: this.props.sectionName } );
	},

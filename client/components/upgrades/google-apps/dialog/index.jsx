    ...
    render() {
        ...
        return (
            <form className="google-apps-dialog card" onSubmit={this.handleFormSubmit}>
                {this.header()}
                <GoogleAppsProductDetails price={price} />
        ...
        return (
            <header className="google-apps-dialog__header">
                <h2 className="google-apps-dialog__title">
                    {this.translate('Add Professional Email to %(domain)s', {
                        args: { domain: this.props.domain },
                    })}
                </h2>
                <h5 className="google-apps-dialog__no-setup-required">
                    {this.translate(
                        'No setup or software required, easy to manage from your dashboard'
                    )}
                </h5>
            </header>
        );

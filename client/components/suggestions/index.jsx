...
import { has, noop, pick, pickBy, negate, isEmpty, take } from 'lodash';
...
const Suggestions = React.createClass({
    ...
    narrowDown(input) {
        ...
        for (const key in terms) {
            ...
            filtered[key] = take(terms[key].filter(term => term.indexOf(filterTerm) !== -1), limit);
        }
        ...
        for (const key in suggestions) {
            ...
            rendered.push(
                suggestions[key].map((value, i) => {
                    ...
                    const className = classNames('suggestions__value', {

...
const ThankYouCard = (
    { heading, description, buttonUrl, buttonText, price, name, icon, action }
) => {
    const renderAction = () => {
        if (action) {
            return action;
        ...
        <div className="thank-you-card">
            <div className="thank-you-card__header">
                ...
                <div className="thank-you-card__header-detail">
                    <div
                        className={classnames('thank-you-card__name', { 'is-placeholder': !name })}
                    >
                        {name}
                    </div>
                    <div
                        className={classnames('thank-you-card__price', {

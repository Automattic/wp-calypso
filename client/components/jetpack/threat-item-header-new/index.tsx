...
const ThreatItemHeader: React.FC< Props > = ( { threat } ) => {
	return (
		<>
			...
			<div className="threat-item-header-new__card-container">
				<div className="threat-item-header-new__card-top">{ getThreatMessage( threat ) }</div>
				<span
					className={ classnames(
						'threat-item-header-new__card-bottom',
			...
			{ threat.fixable && (
				...
				<Gridicon className="threat-item-header-new__autofix_badge" icon="checkmark" size={ 18 } />
			) }
		</>
	);
};

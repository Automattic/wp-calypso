...
class NavTabs extends Component {
  ...
  render() {
    const tabs = React.Children.map(this.props.children, function(
      child,
      index
    ) {
  ...
  getTabWidths = () => {
    ...
    React.Children.forEach(
      ...
      function(child, index) {
        ...
        const tabWidth = ReactDom.findDOMNode(this.refs["tab-" + index])
          .offsetWidth;
        totalWidth += tabWidth;
      }.bind(this)
    );
  ...
  getDropdown = () => {
    const dropdownOptions = React.Children.map(this.props.children, function(
      child,
      index
    ) {
      if (!child) {

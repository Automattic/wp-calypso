...
For more detailed instructions, see [Installing Calypso](/devdocs/docs/install.md).
...
* [All Coding Guidelines](/devdocs/docs/coding-guidelines.md)
	- [JavaScript](/devdocs/docs/coding-guidelines/javascript.md)
	- [CSS/SASS](/devdocs/docs/coding-guidelines/css.md)
	- [HTML](/devdocs/docs/coding-guidelines/html.md)
	- [React Components](/devdocs/docs/components.md)
...
1. Create a new branch, using [the branch naming scheme](/devdocs/docs/git-workflow.md#branch-naming-scheme), _e.g._ `add/video-preview` or `fix/1337-language-too-geeky`.
...
3. Start developing and pushing out commits to your new branch.
  ...
  - Follow the [merge checklist](/devdocs/docs/merge-checklist.md) before pushing. This ensures that your code follows the style guidelines and doesn’t accidentally introduce any errors or regressions.
  - Note that you can automate some of these tasks by setting up [githooks](/devdocs/docs/coding-guidelines/javascript.md#setting-up-githooks) and they will run whenever you `git commit`.
...
5. When you feel that you are ready for a formal review or for merging into `master` make sure you check this list and our [merge checklist](/devdocs/docs/merge-checklist.md).
